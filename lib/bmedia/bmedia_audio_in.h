...
#ifndef BMEDIA_AUDIO_IN_H
#define BMEDIA_AUDIO_IN_H
...
XOILA_DEFINE_GROUP( bmedia_audio_in, x_inst )
...
stamp :capture_thread_s =
{
    ...
    {
        o.capture_loop_error = o.audio.capture_loop( o.capture_feed, o );
        o.mutex.lock();
        o.is_running = false;
        o.mutex.unlock();
        return NULL;
