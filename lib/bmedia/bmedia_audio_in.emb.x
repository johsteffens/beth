...
func er_t error( sc_t context, s2_t errnum )
{
    ...
    = bcore_error_push_fa( TYPEOF_general_error, "audio_in: #<sc_t>: #<sc_t>\n", context, snd_msg );
}
...
func (:s) stream_record_to_sequence
{
    ...
    while( frames_left > 0 )
    {
        ...
        m bcodec_audio_buffer_s* buffer = sequence.push_empty_buffer().set_size( frames * o.channels, o.channels );
...
func (:s) capture_loop
{
    ...
    bcodec_audio_buffer_s^ buf.set_size( o.actual_frames_per_period * o.channels, o.channels );
