...
static inline void bmath_arr_vf3_s_copy_t( bmath_arr_vf3_s* o, tp_t type, vc_t src ) { bmath_arr_vf3_s_copy_typed( o, type, src ); }
static inline void bmath_arr_vf3_s_copy_a( bmath_arr_vf3_s* o, vc_t src ) { if( src ) bmath_arr_vf3_s_copy_t( o, *(aware_t*)src, src ); else bmath_arr_vf3_s_clear( o ); }
