...
#ifndef BMATH_SMF3_MUL_H
#define BMATH_SMF3_MUL_H
...
void bmath_smf3_s_mul(     const bmath_smf3_s* o, const bmath_smf3_s* m, bmath_smf3_s* r ); // o * m -> r
void bmath_smf3_s_mul_htp( const bmath_smf3_s* o, const bmath_smf3_s* m, bmath_smf3_s* r ); // o * m^T -> r
void bmath_smf3_s_htp_mul( const bmath_smf3_s* o, const bmath_smf3_s* m, bmath_smf3_s* r ); // o^T * m -> r

//----------------------------------------------------------------------------------------------------------------------

#endif  // BMATH_SMF3_MUL_H
