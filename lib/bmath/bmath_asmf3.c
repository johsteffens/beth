...
{
    bmath_asmf3_s_set_size_splicing( o, rows, cols );
    bmath_asmf3_s_set_size_data( o, rows * cols );
...
void bmath_asmf3_s_fit_size_data( bmath_asmf3_s* o )
{
    ...
    bmath_asmf3_s_set_size_data( o, max_idx + 1 );
}
...
void bmath_asmf3_s_set_random( bmath_asmf3_s* o, bl_t hsm, bl_t pdf, uz_t rd, f3_t density, f3_t min, f3_t max, u2_t* p_rval )
{
    ...
    bmath_asmf3_s_cpy_dfl_from_mf3( o, m1 );
    BCORE_LIFE_DOWN();
}
...
bl_t bmath_asmf3_s_is_near_equ( const bmath_asmf3_s* o, const bmath_asmf3_s* op, f3_t max_dev )
{
...
bl_t bmath_asmf3_s_is_near_zro( const bmath_asmf3_s* o, f3_t max_dev )
{
    for( sz_t row = 0; row <= o->rows; row++ )
    {
        for( sz_t col = 0; col <= o->cols; col++ )
