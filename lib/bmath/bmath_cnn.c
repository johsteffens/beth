...
vd_t bmath_cnn_signal_handler( const bcore_signal_s* o )
{
    switch( bcore_signal_s_handle_type( o, typeof( "bmath_cnn" ) ) )
    {
        case TYPEOF_init1:
        {
            ...
            BCORE_REGISTER_FFUNC( bmath_fp_sadaptiv_get_in_size,   bmath_cnn_s_get_in_size );
            BCORE_REGISTER_FFUNC( bmath_fp_sadaptiv_set_in_size,   bmath_cnn_s_set_in_size );
            BCORE_REGISTER_FFUNC( bmath_fp_sadaptiv_get_out_size,  bmath_cnn_s_get_out_size );
            BCORE_REGISTER_FFUNC( bmath_fp_sadaptiv_set_out_size,  bmath_cnn_s_set_out_size );
            BCORE_REGISTER_FFUNC( bmath_fp_sadaptiv_get_step,      bmath_cnn_s_get_step );
            BCORE_REGISTER_FFUNC( bmath_fp_sadaptiv_set_step,      bmath_cnn_s_set_step );
            BCORE_REGISTER_FFUNC( bmath_fp_sadaptiv_get_decay,     bmath_cnn_s_get_decay );
            BCORE_REGISTER_FFUNC( bmath_fp_sadaptiv_set_decay,     bmath_cnn_s_set_decay );
            BCORE_REGISTER_FFUNC( bmath_fp_sadaptiv_setup,         bmath_cnn_s_setup );
            BCORE_REGISTER_FFUNC( bmath_fp_sadaptiv_set_untrained, bmath_cnn_s_set_untrained );
            BCORE_REGISTER_FFUNC( bmath_fp_sadaptiv_arc_to_sink,   bmath_cnn_s_arc_to_sink );
            BCORE_REGISTER_FFUNC( bmath_fp_sadaptiv_query,         bmath_cnn_s_query );
            BCORE_REGISTER_FFUNC( bmath_fp_sadaptiv_adapt,         bmath_cnn_s_adapt );
