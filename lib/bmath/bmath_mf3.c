...
vd_t bmath_mf3_signal_handler( const bcore_signal_s* o )
{
    switch( bcore_signal_s_handle_type( o, typeof( "bmath_mf3" ) ) )
    {
        case TYPEOF_init1:
        {
            ...
            BCORE_REGISTER_FEATURE( bmath_fp_mf3_s_htp );
            ...
            BCORE_REGISTER_FFUNC( bcore_fp_copy_typed,     bmath_mf3_s_copy_typed );
            ...
            BCORE_REGISTER_FUNC( bmath_mf3_s_omp_mul );
            BCORE_REGISTER_FUNC( bmath_mf3_s_omp_htp_mul );
            BCORE_REGISTER_FUNC( bmath_mf3_s_omp_mul_htp );
            BCORE_REGISTER_FUNC( bmath_mf3_s_omp_htp_mul_htp );
