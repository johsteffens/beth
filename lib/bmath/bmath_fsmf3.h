...
#ifndef BMATH_FSMF3_H
#define BMATH_FSMF3_H

/**********************************************************************************************************************/

/** Fully Indexing Spliced Matrix. (FSM)
 *  We define FSM as 2D matrix where each matrix element associates (via index) an element in another data structure,
...
#ifdef TYPEOF_bmath_fsmf3

PLANT_GROUP( bmath_fsmf3, bcore_inst )
#ifdef PLANT_SECTION // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    stamp bmath_fsmf3 = aware bcore_inst
    {
...
void bmath_fsmf3_s_set_size_splicing( bmath_fsmf3_s* o, sz_t rows, sz_t cols );

/// sets size of data (zeros all values)
void bmath_fsmf3_s_set_size_data( bmath_fsmf3_s* o, sz_t size );

/// sets size (non-overlapping, all owning, all initialized)
void bmath_fsmf3_s_set_size( bmath_fsmf3_s* o, sz_t rows, sz_t cols );

/// allocates and initializes data to given splicing
void bmath_fsmf3_s_fit_size_data( bmath_fsmf3_s* o );
 ...
 */
void bmath_fsmf3_s_set_random( bmath_fsmf3_s* o, bl_t hsm, bl_t pdf, uz_t rd, f3_t density, f3_t min, f3_t max, u2_t* p_rval );

/// zeros all values
void bmath_fsmf3_s_zro( bmath_fsmf3_s* o );

/// copies and deflates data from mf3
void bmath_fsmf3_s_cpy_dfl_from_mf3( bmath_fsmf3_s* o, const bmath_mf3_s* src );

/// copies and inflates data to mf3
void bmath_fsmf3_s_cpy_ifl_to_mf3( const bmath_fsmf3_s* o, bmath_mf3_s* dst );

/**********************************************************************************************************************/
// convolution

/// sets splicing for 1D convolution with dense kernel; does not allocate or change data
void bmath_fsmf3_s_set_splicing_for_convolution_1d( bmath_fsmf3_s* o, sz_t size_in, sz_t size_kernel, sz_t step );

/// sets splicing for 2D convolution with dense kernel; does not allocate or change data
void bmath_fsmf3_s_set_splicing_for_convolution_2d( bmath_fsmf3_s* o, sz_t rows_in, sz_t cols_in, sz_t rows_kernel, sz_t cols_kernel, sz_t row_step, sz_t col_step );
 ...
 */
bl_t bmath_fsmf3_s_is_near_equ( const bmath_fsmf3_s* o, const bmath_fsmf3_s* op, f3_t max_dev ); // equality
bl_t bmath_fsmf3_s_is_near_zro( const bmath_fsmf3_s* o, f3_t max_dev ); // zero

static inline bl_t bmath_fsmf3_s_is_equ( const bmath_fsmf3_s* o, const bmath_fsmf3_s* op ) { return bmath_fsmf3_s_is_near_equ( o, op, 0 ); }
static inline bl_t bmath_fsmf3_s_is_zro( const bmath_fsmf3_s* o ) { return bmath_fsmf3_s_is_near_zro( o, 0 ); }
 ...
 */
f3_t bmath_fsmf3_s_fdev_equ( const bmath_fsmf3_s* o, const bmath_fsmf3_s* op );
f3_t bmath_fsmf3_s_fdev_zro( const bmath_fsmf3_s* o );

// ---------------------------------------------------------------------------------------------------------------------
// debugging

// For easy inspection
void bmath_fsmf3_s_to_sink( const bmath_fsmf3_s* o, bcore_sink* sink );
static inline void bmath_fsmf3_s_to_string( const bmath_fsmf3_s* o, st_s* string ) { bmath_fsmf3_s_to_sink( o, ( bcore_sink* )string ); }
static inline void bmath_fsmf3_s_to_stdout( const bmath_fsmf3_s* o               ) { bmath_fsmf3_s_to_sink( o, BCORE_STDOUT ); }

#endif // TYPEOF_bmath_fsmf3

/**********************************************************************************************************************/

vd_t bmath_fsmf3_signal_handler( const bcore_signal_s* o );
