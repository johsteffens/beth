...
vd_t bmath_xsmf3_signal_handler( const bcore_signal_s* o )
{
    switch( bcore_signal_s_handle_type( o, typeof( "bmath_xsmf3" ) ) )
    {
        case TYPEOF_init1:
        {
            BCORE_REGISTER_FUNC( bmath_xsmf3_s_mul );
            BCORE_REGISTER_FUNC( bmath_xsmf3_s_mul_htp );
            BCORE_REGISTER_FUNC( bmath_xsmf3_s_htp_mul );
            BCORE_REGISTER_FUNC( bmath_xsmf3_s_htp_mul_htp );
        }
        break;
