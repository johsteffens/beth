...
stamp :result_s = aware bcore_inst
{
    ...
    func string to_string( c@* o, m st_s* string );
...
name bmath_fp_mf2_s_svd2;
name bmath_fp_mf2_s_svd_htp;
name bmath_fp_mf2_s_svd2_htp;
...
name bmath_fp_mf3_s_svd2;
name bmath_fp_mf3_s_svd_htp;
name bmath_fp_mf3_s_svd2_htp;
