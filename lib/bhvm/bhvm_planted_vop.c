...
vd_t bhvm_planted_vop_signal_handler( const bcore_signal_s* o )
{
    switch( bcore_signal_s_handle_type( o, typeof( "bhvm_planted_vop" ) ) )
    {
        case TYPEOF_init1:
        {
            ...
            BCORE_REGISTER_FFUNC( bhvm_vop_get_index, bhvm_vop_ar0_determine_s_get_index );
            ...
            BCORE_REGISTER_FFUNC( bhvm_vop_get_index, bhvm_vop_ar0_vacate_s_get_index );
            ...
            BCORE_REGISTER_FFUNC( bhvm_vop_get_index, bhvm_vop_ar0_randomize_s_get_index );
            ...
            BCORE_REGISTER_FFUNC( bhvm_vop_get_index, bhvm_vop_ar1_abs_s_get_index );
            ...
            BCORE_REGISTER_FFUNC( bhvm_vop_get_index, bhvm_vop_ar1_l1_s_get_index );
            ...
            BCORE_REGISTER_FFUNC( bhvm_vop_get_index, bhvm_vop_ar2_branch_vvvv_dp_b_s_get_index );
            ...
            BCORE_REGISTER_FFUNC( bhvm_vop_get_index, bhvm_vop_ar2_branch_vvvv_dp_c_s_get_index );
            ...
            BCORE_REGISTER_FFUNC( bhvm_vop_get_index, bhvm_vop_ar3_branch_vvvv_s_get_index );
            ...
            BCORE_REGISTER_FFUNC( bhvm_vop_get_index, bhvm_vop_ar3_branch_svvv_s_get_index );
