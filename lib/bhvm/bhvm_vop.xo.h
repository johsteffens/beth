...
#ifndef __bhvm_vop_xo_H
#define __bhvm_vop_xo_H

#include "bcore_control.h"

//To force a rebuild of this target by xoico, reset the hash key value below to 0.
#define HKEYOF_bhvm_vop_xo 0xE06AB1CB1D327D17ull

#define TYPEOF_bhvm_vop_xo 0xFD8EDECBDF91A52Cull
...
#define TYPEOF_bhvm_vop_spect_s 0xBDA27317B7F3B1CCull
...
#define BETH_EXPAND_ITEM_bhvm_vop_arr_s \
  ...
  { \
      aware_t _; \
      BCORE_ARRAY_DYN_LINK_STATIC_S( bhvm_vop, ); \
  }; \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ci_s \
  ...
  static inline void bhvm_vop_ci_s_push_ci( bhvm_vop_ci_s* o, u0_t c, sz_t i ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_arr_ci_s \
  ...
  { \
      aware_t _; \
      BCORE_ARRAY_DYN_SOLID_STATIC_S( bhvm_vop_ci_s, ); \
  }; \
...
#define BETH_EXPAND_GROUP_bhvm_vop \
  ...
  static inline void bhvm_vop_a_run( const bhvm_vop* o, bhvm_holor_s** ah ){ const bhvm_vop_spect_s* p = bhvm_vop_spect_s_get_aware( o ); assert( p->run ); p->run( o, ah );} \
  static inline bl_t bhvm_vop_a_defines_run( const bhvm_vop* o ){ return  bhvm_vop_spect_s_get_aware( o )->run != NULL;} \
  static inline void bhvm_vop_p_run( const bhvm_vop_spect_s* p, const bhvm_vop* o, bhvm_holor_s** ah ){ assert( p->run ); p->run( o, ah );} \
  static inline bl_t bhvm_vop_p_defines_run( const bhvm_vop_spect_s* p ){ return  p->run != NULL;} \
  static inline sz_t bhvm_vop_a_arity( const bhvm_vop* o ){ const bhvm_vop_spect_s* p = bhvm_vop_spect_s_get_aware( o ); assert( p->arity ); return p->arity( o );} \
  static inline bl_t bhvm_vop_a_defines_arity( const bhvm_vop* o ){ return  bhvm_vop_spect_s_get_aware( o )->arity != NULL;} \
  static inline sc_t bhvm_vop_a_sig( const bhvm_vop* o ){ const bhvm_vop_spect_s* p = bhvm_vop_spect_s_get_aware( o ); assert( p->sig ); return p->sig( o );} \
  static inline bl_t bhvm_vop_a_defines_sig( const bhvm_vop* o ){ return  bhvm_vop_spect_s_get_aware( o )->sig != NULL;} \
  static inline sz_t* bhvm_vop_a_get_index_arr( bhvm_vop* o ){ const bhvm_vop_spect_s* p = bhvm_vop_spect_s_get_aware( o ); assert( p->get_index_arr ); return p->get_index_arr( o );} \
  static inline bl_t bhvm_vop_a_defines_get_index_arr( const bhvm_vop* o ){ return  bhvm_vop_spect_s_get_aware( o )->get_index_arr != NULL;} \
  static inline sz_t bhvm_vop_a_get_index( const bhvm_vop* o, sz_t index ){ const bhvm_vop_spect_s* p = bhvm_vop_spect_s_get_aware( o ); assert( p->get_index ); return p->get_index( o, index );} \
  ...
  static inline bhvm_vop* bhvm_vop_a_set_index( bhvm_vop* o, sz_t index, sz_t idx_val ){ const bhvm_vop_spect_s* p = bhvm_vop_spect_s_get_aware( o ); assert( p->set_index ); return p->set_index( o, index, idx_val );} \
  ...
  static inline bhvm_vop* bhvm_vop_a_set_index_arr( bhvm_vop* o, sz_t* idx_arr, sz_t size ){ const bhvm_vop_spect_s* p = bhvm_vop_spect_s_get_aware( o ); assert( p->set_index_arr ); return p->set_index_arr( o, idx_arr, size );} \
  ...
  static inline void bhvm_vop_a_set_arg( bhvm_vop* o, bhvm_vop_ci_s* ci ){ const bhvm_vop_spect_s* p = bhvm_vop_spect_s_get_aware( o ); assert( p->set_arg ); p->set_arg( o, ci );} \
  ...
  static inline bhvm_vop* bhvm_vop_a_set_args( bhvm_vop* o, const bhvm_vop_arr_ci_s* arr ){ const bhvm_vop_spect_s* p = bhvm_vop_spect_s_get_aware( o ); assert( p->set_args ); return p->set_args( o, arr );} \
...
#define TYPEOF_bhvm_vop_ar0_spect_s 0x1576338E1F371DCEull
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar0_index_s \
  ...
  static inline void bhvm_vop_ar0_index_s_init_x( bhvm_vop_ar0_index_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar0_zro_s \
  ...
  static inline sz_t bhvm_vop_ar0_zro_s_arity( const bhvm_vop_ar0_zro_s* o ); \
  static inline sz_t* bhvm_vop_ar0_zro_s_get_index_arr( bhvm_vop_ar0_zro_s* o ); \
  static inline void bhvm_vop_ar0_zro_s_run( const bhvm_vop_ar0_zro_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar0_zro_s_sig( const bhvm_vop_ar0_zro_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar0_one_s \
  ...
  static inline sz_t bhvm_vop_ar0_one_s_arity( const bhvm_vop_ar0_one_s* o ); \
  static inline sz_t* bhvm_vop_ar0_one_s_get_index_arr( bhvm_vop_ar0_one_s* o ); \
  static inline void bhvm_vop_ar0_one_s_run( const bhvm_vop_ar0_one_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar0_one_s_sig( const bhvm_vop_ar0_one_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar0_determine_s \
  ...
  static inline sz_t bhvm_vop_ar0_determine_s_arity( const bhvm_vop_ar0_determine_s* o ); \
  static inline sz_t* bhvm_vop_ar0_determine_s_get_index_arr( bhvm_vop_ar0_determine_s* o ); \
  static inline void bhvm_vop_ar0_determine_s_run( const bhvm_vop_ar0_determine_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar0_determine_s_sig( const bhvm_vop_ar0_determine_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar0_vacate_s \
  ...
  static inline sz_t bhvm_vop_ar0_vacate_s_arity( const bhvm_vop_ar0_vacate_s* o ); \
  static inline sz_t* bhvm_vop_ar0_vacate_s_get_index_arr( bhvm_vop_ar0_vacate_s* o ); \
  static inline void bhvm_vop_ar0_vacate_s_run( const bhvm_vop_ar0_vacate_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar0_vacate_s_sig( const bhvm_vop_ar0_vacate_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar0_randomize_s \
  ...
  static inline sz_t bhvm_vop_ar0_randomize_s_arity( const bhvm_vop_ar0_randomize_s* o ); \
  static inline sz_t* bhvm_vop_ar0_randomize_s_get_index_arr( bhvm_vop_ar0_randomize_s* o ); \
  void bhvm_vop_ar0_randomize_s_run( const bhvm_vop_ar0_randomize_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar0_randomize_s_sig( const bhvm_vop_ar0_randomize_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar0_nul_dp_s \
  ...
  static inline sz_t bhvm_vop_ar0_nul_dp_s_arity( const bhvm_vop_ar0_nul_dp_s* o ); \
  static inline sz_t* bhvm_vop_ar0_nul_dp_s_get_index_arr( bhvm_vop_ar0_nul_dp_s* o ); \
  static inline void bhvm_vop_ar0_nul_dp_s_run( const bhvm_vop_ar0_nul_dp_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar0_nul_dp_s_sig( const bhvm_vop_ar0_nul_dp_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar0_rand_s \
  ...
  static inline sz_t bhvm_vop_ar0_rand_s_arity( const bhvm_vop_ar0_rand_s* o ); \
  static inline sz_t* bhvm_vop_ar0_rand_s_get_index_arr( bhvm_vop_ar0_rand_s* o ); \
  void bhvm_vop_ar0_rand_s_run( const bhvm_vop_ar0_rand_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar0_rand_s_sig( const bhvm_vop_ar0_rand_s* o ); \
...
#define BETH_EXPAND_GROUP_bhvm_vop_ar0 \
  ...
  XOILA_DECLARE_SPECT( bhvm_vop_ar0 ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( bhvm_vop_ar0 ) \
...
#define TYPEOF_bhvm_vop_ar1_spect_s 0xECA41067693662F1ull
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_index_s \
  ...
  static inline void bhvm_vop_ar1_index_s_init_x( bhvm_vop_ar1_index_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_neg_s \
  ...
  static inline sz_t bhvm_vop_ar1_neg_s_arity( const bhvm_vop_ar1_neg_s* o ); \
  static inline sz_t* bhvm_vop_ar1_neg_s_get_index_arr( bhvm_vop_ar1_neg_s* o ); \
  static inline void bhvm_vop_ar1_neg_s_run( const bhvm_vop_ar1_neg_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_neg_s_sig( const bhvm_vop_ar1_neg_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_floor_s \
  ...
  static inline sz_t bhvm_vop_ar1_floor_s_arity( const bhvm_vop_ar1_floor_s* o ); \
  static inline sz_t* bhvm_vop_ar1_floor_s_get_index_arr( bhvm_vop_ar1_floor_s* o ); \
  static inline void bhvm_vop_ar1_floor_s_run( const bhvm_vop_ar1_floor_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_floor_s_sig( const bhvm_vop_ar1_floor_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_ceil_s \
  ...
  static inline sz_t bhvm_vop_ar1_ceil_s_arity( const bhvm_vop_ar1_ceil_s* o ); \
  static inline sz_t* bhvm_vop_ar1_ceil_s_get_index_arr( bhvm_vop_ar1_ceil_s* o ); \
  static inline void bhvm_vop_ar1_ceil_s_run( const bhvm_vop_ar1_ceil_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_ceil_s_sig( const bhvm_vop_ar1_ceil_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_exp_s \
  ...
  static inline sz_t bhvm_vop_ar1_exp_s_arity( const bhvm_vop_ar1_exp_s* o ); \
  static inline sz_t* bhvm_vop_ar1_exp_s_get_index_arr( bhvm_vop_ar1_exp_s* o ); \
  static inline void bhvm_vop_ar1_exp_s_run( const bhvm_vop_ar1_exp_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_exp_s_sig( const bhvm_vop_ar1_exp_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_log_s \
  ...
  static inline sz_t bhvm_vop_ar1_log_s_arity( const bhvm_vop_ar1_log_s* o ); \
  static inline sz_t* bhvm_vop_ar1_log_s_get_index_arr( bhvm_vop_ar1_log_s* o ); \
  static inline void bhvm_vop_ar1_log_s_run( const bhvm_vop_ar1_log_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_log_s_sig( const bhvm_vop_ar1_log_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_inv_s \
  ...
  static inline sz_t bhvm_vop_ar1_inv_s_arity( const bhvm_vop_ar1_inv_s* o ); \
  static inline sz_t* bhvm_vop_ar1_inv_s_get_index_arr( bhvm_vop_ar1_inv_s* o ); \
  static inline void bhvm_vop_ar1_inv_s_run( const bhvm_vop_ar1_inv_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_inv_s_sig( const bhvm_vop_ar1_inv_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_sqr_s \
  ...
  static inline sz_t bhvm_vop_ar1_sqr_s_arity( const bhvm_vop_ar1_sqr_s* o ); \
  static inline sz_t* bhvm_vop_ar1_sqr_s_get_index_arr( bhvm_vop_ar1_sqr_s* o ); \
  static inline void bhvm_vop_ar1_sqr_s_run( const bhvm_vop_ar1_sqr_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_sqr_s_sig( const bhvm_vop_ar1_sqr_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_srt_s \
  ...
  static inline sz_t bhvm_vop_ar1_srt_s_arity( const bhvm_vop_ar1_srt_s* o ); \
  static inline sz_t* bhvm_vop_ar1_srt_s_get_index_arr( bhvm_vop_ar1_srt_s* o ); \
  static inline void bhvm_vop_ar1_srt_s_run( const bhvm_vop_ar1_srt_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_srt_s_sig( const bhvm_vop_ar1_srt_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_abs_s \
  ...
  static inline sz_t bhvm_vop_ar1_abs_s_arity( const bhvm_vop_ar1_abs_s* o ); \
  static inline sz_t* bhvm_vop_ar1_abs_s_get_index_arr( bhvm_vop_ar1_abs_s* o ); \
  static inline void bhvm_vop_ar1_abs_s_run( const bhvm_vop_ar1_abs_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_abs_s_sig( const bhvm_vop_ar1_abs_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_l1_s \
  ...
  static inline sz_t bhvm_vop_ar1_l1_s_arity( const bhvm_vop_ar1_l1_s* o ); \
  static inline sz_t* bhvm_vop_ar1_l1_s_get_index_arr( bhvm_vop_ar1_l1_s* o ); \
  static inline void bhvm_vop_ar1_l1_s_run( const bhvm_vop_ar1_l1_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_l1_s_sig( const bhvm_vop_ar1_l1_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_sigm_s \
  ...
  static inline sz_t bhvm_vop_ar1_sigm_s_arity( const bhvm_vop_ar1_sigm_s* o ); \
  static inline sz_t* bhvm_vop_ar1_sigm_s_get_index_arr( bhvm_vop_ar1_sigm_s* o ); \
  static inline void bhvm_vop_ar1_sigm_s_run( const bhvm_vop_ar1_sigm_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_sigm_s_sig( const bhvm_vop_ar1_sigm_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_sigm_hard_s \
  ...
  static inline sz_t bhvm_vop_ar1_sigm_hard_s_arity( const bhvm_vop_ar1_sigm_hard_s* o ); \
  static inline sz_t* bhvm_vop_ar1_sigm_hard_s_get_index_arr( bhvm_vop_ar1_sigm_hard_s* o ); \
  static inline void bhvm_vop_ar1_sigm_hard_s_run( const bhvm_vop_ar1_sigm_hard_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_sigm_hard_s_sig( const bhvm_vop_ar1_sigm_hard_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_sigm_leaky_s \
  ...
  static inline sz_t bhvm_vop_ar1_sigm_leaky_s_arity( const bhvm_vop_ar1_sigm_leaky_s* o ); \
  static inline sz_t* bhvm_vop_ar1_sigm_leaky_s_get_index_arr( bhvm_vop_ar1_sigm_leaky_s* o ); \
  static inline void bhvm_vop_ar1_sigm_leaky_s_run( const bhvm_vop_ar1_sigm_leaky_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_sigm_leaky_s_sig( const bhvm_vop_ar1_sigm_leaky_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_tanh_s \
  ...
  static inline sz_t bhvm_vop_ar1_tanh_s_arity( const bhvm_vop_ar1_tanh_s* o ); \
  static inline sz_t* bhvm_vop_ar1_tanh_s_get_index_arr( bhvm_vop_ar1_tanh_s* o ); \
  static inline void bhvm_vop_ar1_tanh_s_run( const bhvm_vop_ar1_tanh_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_tanh_s_sig( const bhvm_vop_ar1_tanh_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_tanh_hard_s \
  ...
  static inline sz_t bhvm_vop_ar1_tanh_hard_s_arity( const bhvm_vop_ar1_tanh_hard_s* o ); \
  static inline sz_t* bhvm_vop_ar1_tanh_hard_s_get_index_arr( bhvm_vop_ar1_tanh_hard_s* o ); \
  static inline void bhvm_vop_ar1_tanh_hard_s_run( const bhvm_vop_ar1_tanh_hard_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_tanh_hard_s_sig( const bhvm_vop_ar1_tanh_hard_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_tanh_leaky_s \
  ...
  static inline sz_t bhvm_vop_ar1_tanh_leaky_s_arity( const bhvm_vop_ar1_tanh_leaky_s* o ); \
  static inline sz_t* bhvm_vop_ar1_tanh_leaky_s_get_index_arr( bhvm_vop_ar1_tanh_leaky_s* o ); \
  static inline void bhvm_vop_ar1_tanh_leaky_s_run( const bhvm_vop_ar1_tanh_leaky_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_tanh_leaky_s_sig( const bhvm_vop_ar1_tanh_leaky_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_softplus_s \
  ...
  static inline sz_t bhvm_vop_ar1_softplus_s_arity( const bhvm_vop_ar1_softplus_s* o ); \
  static inline sz_t* bhvm_vop_ar1_softplus_s_get_index_arr( bhvm_vop_ar1_softplus_s* o ); \
  static inline void bhvm_vop_ar1_softplus_s_run( const bhvm_vop_ar1_softplus_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_softplus_s_sig( const bhvm_vop_ar1_softplus_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_softmax_s \
  ...
  static inline sz_t bhvm_vop_ar1_softmax_s_arity( const bhvm_vop_ar1_softmax_s* o ); \
  static inline sz_t* bhvm_vop_ar1_softmax_s_get_index_arr( bhvm_vop_ar1_softmax_s* o ); \
  static inline void bhvm_vop_ar1_softmax_s_run( const bhvm_vop_ar1_softmax_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_softmax_s_sig( const bhvm_vop_ar1_softmax_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_relu_s \
  ...
  static inline sz_t bhvm_vop_ar1_relu_s_arity( const bhvm_vop_ar1_relu_s* o ); \
  static inline sz_t* bhvm_vop_ar1_relu_s_get_index_arr( bhvm_vop_ar1_relu_s* o ); \
  static inline void bhvm_vop_ar1_relu_s_run( const bhvm_vop_ar1_relu_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_relu_s_sig( const bhvm_vop_ar1_relu_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_relu_leaky_s \
  ...
  static inline sz_t bhvm_vop_ar1_relu_leaky_s_arity( const bhvm_vop_ar1_relu_leaky_s* o ); \
  static inline sz_t* bhvm_vop_ar1_relu_leaky_s_get_index_arr( bhvm_vop_ar1_relu_leaky_s* o ); \
  static inline void bhvm_vop_ar1_relu_leaky_s_run( const bhvm_vop_ar1_relu_leaky_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_relu_leaky_s_sig( const bhvm_vop_ar1_relu_leaky_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_order_inc_s \
  ...
  static inline sz_t bhvm_vop_ar1_order_inc_s_arity( const bhvm_vop_ar1_order_inc_s* o ); \
  static inline sz_t* bhvm_vop_ar1_order_inc_s_get_index_arr( bhvm_vop_ar1_order_inc_s* o ); \
  static inline void bhvm_vop_ar1_order_inc_s_run( const bhvm_vop_ar1_order_inc_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_order_inc_s_sig( const bhvm_vop_ar1_order_inc_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_order_dec_s \
  ...
  static inline sz_t bhvm_vop_ar1_order_dec_s_arity( const bhvm_vop_ar1_order_dec_s* o ); \
  static inline sz_t* bhvm_vop_ar1_order_dec_s_get_index_arr( bhvm_vop_ar1_order_dec_s* o ); \
  static inline void bhvm_vop_ar1_order_dec_s_run( const bhvm_vop_ar1_order_dec_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_order_dec_s_sig( const bhvm_vop_ar1_order_dec_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_order_dec_weak_s \
  ...
  static inline sz_t bhvm_vop_ar1_order_dec_weak_s_arity( const bhvm_vop_ar1_order_dec_weak_s* o ); \
  static inline sz_t* bhvm_vop_ar1_order_dec_weak_s_get_index_arr( bhvm_vop_ar1_order_dec_weak_s* o ); \
  static inline void bhvm_vop_ar1_order_dec_weak_s_run( const bhvm_vop_ar1_order_dec_weak_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_order_dec_weak_s_sig( const bhvm_vop_ar1_order_dec_weak_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_add_dp_a_s \
  ...
  static inline sz_t bhvm_vop_ar1_add_dp_a_s_arity( const bhvm_vop_ar1_add_dp_a_s* o ); \
  static inline sz_t* bhvm_vop_ar1_add_dp_a_s_get_index_arr( bhvm_vop_ar1_add_dp_a_s* o ); \
  static inline void bhvm_vop_ar1_add_dp_a_s_run( const bhvm_vop_ar1_add_dp_a_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_add_dp_a_s_sig( const bhvm_vop_ar1_add_dp_a_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_add_dp_b_s \
  ...
  static inline sz_t bhvm_vop_ar1_add_dp_b_s_arity( const bhvm_vop_ar1_add_dp_b_s* o ); \
  static inline sz_t* bhvm_vop_ar1_add_dp_b_s_get_index_arr( bhvm_vop_ar1_add_dp_b_s* o ); \
  static inline void bhvm_vop_ar1_add_dp_b_s_run( const bhvm_vop_ar1_add_dp_b_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_add_dp_b_s_sig( const bhvm_vop_ar1_add_dp_b_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_sub_dp_a_s \
  ...
  static inline sz_t bhvm_vop_ar1_sub_dp_a_s_arity( const bhvm_vop_ar1_sub_dp_a_s* o ); \
  static inline sz_t* bhvm_vop_ar1_sub_dp_a_s_get_index_arr( bhvm_vop_ar1_sub_dp_a_s* o ); \
  static inline void bhvm_vop_ar1_sub_dp_a_s_run( const bhvm_vop_ar1_sub_dp_a_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_sub_dp_a_s_sig( const bhvm_vop_ar1_sub_dp_a_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_sub_dp_b_s \
  ...
  static inline sz_t bhvm_vop_ar1_sub_dp_b_s_arity( const bhvm_vop_ar1_sub_dp_b_s* o ); \
  static inline sz_t* bhvm_vop_ar1_sub_dp_b_s_get_index_arr( bhvm_vop_ar1_sub_dp_b_s* o ); \
  static inline void bhvm_vop_ar1_sub_dp_b_s_run( const bhvm_vop_ar1_sub_dp_b_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_sub_dp_b_s_sig( const bhvm_vop_ar1_sub_dp_b_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_neg_dp_s \
  ...
  static inline sz_t bhvm_vop_ar1_neg_dp_s_arity( const bhvm_vop_ar1_neg_dp_s* o ); \
  static inline sz_t* bhvm_vop_ar1_neg_dp_s_get_index_arr( bhvm_vop_ar1_neg_dp_s* o ); \
  static inline void bhvm_vop_ar1_neg_dp_s_run( const bhvm_vop_ar1_neg_dp_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_neg_dp_s_sig( const bhvm_vop_ar1_neg_dp_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_cat_dp_a_s \
  ...
  static inline sz_t bhvm_vop_ar1_cat_dp_a_s_arity( const bhvm_vop_ar1_cat_dp_a_s* o ); \
  static inline sz_t* bhvm_vop_ar1_cat_dp_a_s_get_index_arr( bhvm_vop_ar1_cat_dp_a_s* o ); \
  static inline void bhvm_vop_ar1_cat_dp_a_s_run( const bhvm_vop_ar1_cat_dp_a_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_cat_dp_a_s_sig( const bhvm_vop_ar1_cat_dp_a_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_cat_dp_b_s \
  ...
  static inline sz_t bhvm_vop_ar1_cat_dp_b_s_arity( const bhvm_vop_ar1_cat_dp_b_s* o ); \
  static inline sz_t* bhvm_vop_ar1_cat_dp_b_s_get_index_arr( bhvm_vop_ar1_cat_dp_b_s* o ); \
  static inline void bhvm_vop_ar1_cat_dp_b_s_run( const bhvm_vop_ar1_cat_dp_b_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_cat_dp_b_s_sig( const bhvm_vop_ar1_cat_dp_b_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_ccat_dp_a_s \
  ...
  static inline sz_t bhvm_vop_ar1_ccat_dp_a_s_arity( const bhvm_vop_ar1_ccat_dp_a_s* o ); \
  static inline sz_t* bhvm_vop_ar1_ccat_dp_a_s_get_index_arr( bhvm_vop_ar1_ccat_dp_a_s* o ); \
  static inline void bhvm_vop_ar1_ccat_dp_a_s_run( const bhvm_vop_ar1_ccat_dp_a_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_ccat_dp_a_s_sig( const bhvm_vop_ar1_ccat_dp_a_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_ccat_dp_b_s \
  ...
  static inline sz_t bhvm_vop_ar1_ccat_dp_b_s_arity( const bhvm_vop_ar1_ccat_dp_b_s* o ); \
  static inline sz_t* bhvm_vop_ar1_ccat_dp_b_s_get_index_arr( bhvm_vop_ar1_ccat_dp_b_s* o ); \
  static inline void bhvm_vop_ar1_ccat_dp_b_s_run( const bhvm_vop_ar1_ccat_dp_b_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar1_ccat_dp_b_s_sig( const bhvm_vop_ar1_ccat_dp_b_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_cpy_s \
  ...
  static inline sz_t bhvm_vop_ar1_cpy_s_arity( const bhvm_vop_ar1_cpy_s* o ); \
  static inline sz_t* bhvm_vop_ar1_cpy_s_get_index_arr( bhvm_vop_ar1_cpy_s* o ); \
  static inline sc_t bhvm_vop_ar1_cpy_s_sig( const bhvm_vop_ar1_cpy_s* o ); \
  static inline void bhvm_vop_ar1_cpy_s_run( const bhvm_vop_ar1_cpy_s* o, bhvm_holor_s** ah ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_acc_s \
  ...
  static inline sz_t bhvm_vop_ar1_acc_s_arity( const bhvm_vop_ar1_acc_s* o ); \
  static inline sz_t* bhvm_vop_ar1_acc_s_get_index_arr( bhvm_vop_ar1_acc_s* o ); \
  static inline sc_t bhvm_vop_ar1_acc_s_sig( const bhvm_vop_ar1_acc_s* o ); \
  static inline void bhvm_vop_ar1_acc_s_run( const bhvm_vop_ar1_acc_s* o, bhvm_holor_s** ah ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_fork_s \
  ...
  static inline sz_t bhvm_vop_ar1_fork_s_arity( const bhvm_vop_ar1_fork_s* o ); \
  static inline sz_t* bhvm_vop_ar1_fork_s_get_index_arr( bhvm_vop_ar1_fork_s* o ); \
  static inline sc_t bhvm_vop_ar1_fork_s_sig( const bhvm_vop_ar1_fork_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar1_reshape_s \
  ...
  static inline sz_t bhvm_vop_ar1_reshape_s_arity( const bhvm_vop_ar1_reshape_s* o ); \
  static inline sz_t* bhvm_vop_ar1_reshape_s_get_index_arr( bhvm_vop_ar1_reshape_s* o ); \
  static inline sc_t bhvm_vop_ar1_reshape_s_sig( const bhvm_vop_ar1_reshape_s* o ); \
...
#define BETH_EXPAND_GROUP_bhvm_vop_ar1 \
  ...
  XOILA_DECLARE_SPECT( bhvm_vop_ar1 ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( bhvm_vop_ar1 ) \
...
#define TYPEOF_bhvm_vop_ar2_spect_s 0xA83E0E262A605B74ull
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_index_s \
  ...
  static inline void bhvm_vop_ar2_index_s_init_x( bhvm_vop_ar2_index_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_cat_s \
  ...
  static inline sz_t bhvm_vop_ar2_cat_s_arity( const bhvm_vop_ar2_cat_s* o ); \
  static inline sz_t* bhvm_vop_ar2_cat_s_get_index_arr( bhvm_vop_ar2_cat_s* o ); \
  static inline void bhvm_vop_ar2_cat_s_run( const bhvm_vop_ar2_cat_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_cat_s_sig( const bhvm_vop_ar2_cat_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_ccat_s \
  ...
  static inline sz_t bhvm_vop_ar2_ccat_s_arity( const bhvm_vop_ar2_ccat_s* o ); \
  static inline sz_t* bhvm_vop_ar2_ccat_s_get_index_arr( bhvm_vop_ar2_ccat_s* o ); \
  static inline void bhvm_vop_ar2_ccat_s_run( const bhvm_vop_ar2_ccat_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_ccat_s_sig( const bhvm_vop_ar2_ccat_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_add_s \
  ...
  static inline sz_t bhvm_vop_ar2_add_s_arity( const bhvm_vop_ar2_add_s* o ); \
  static inline sz_t* bhvm_vop_ar2_add_s_get_index_arr( bhvm_vop_ar2_add_s* o ); \
  static inline void bhvm_vop_ar2_add_s_run( const bhvm_vop_ar2_add_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_add_s_sig( const bhvm_vop_ar2_add_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_sub_s \
  ...
  static inline sz_t bhvm_vop_ar2_sub_s_arity( const bhvm_vop_ar2_sub_s* o ); \
  static inline sz_t* bhvm_vop_ar2_sub_s_get_index_arr( bhvm_vop_ar2_sub_s* o ); \
  static inline void bhvm_vop_ar2_sub_s_run( const bhvm_vop_ar2_sub_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_sub_s_sig( const bhvm_vop_ar2_sub_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_s_arity( const bhvm_vop_ar2_mul_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_s_get_index_arr( bhvm_vop_ar2_mul_s* o ); \
  static inline void bhvm_vop_ar2_mul_s_run( const bhvm_vop_ar2_mul_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_s_sig( const bhvm_vop_ar2_mul_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_div_s \
  ...
  static inline sz_t bhvm_vop_ar2_div_s_arity( const bhvm_vop_ar2_div_s* o ); \
  static inline sz_t* bhvm_vop_ar2_div_s_get_index_arr( bhvm_vop_ar2_div_s* o ); \
  static inline void bhvm_vop_ar2_div_s_run( const bhvm_vop_ar2_div_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_div_s_sig( const bhvm_vop_ar2_div_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_pow_s \
  ...
  static inline sz_t bhvm_vop_ar2_pow_s_arity( const bhvm_vop_ar2_pow_s* o ); \
  static inline sz_t* bhvm_vop_ar2_pow_s_get_index_arr( bhvm_vop_ar2_pow_s* o ); \
  static inline void bhvm_vop_ar2_pow_s_run( const bhvm_vop_ar2_pow_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_pow_s_sig( const bhvm_vop_ar2_pow_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_mvv_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_mvv_s_arity( const bhvm_vop_ar2_mul_mvv_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_mvv_s_get_index_arr( bhvm_vop_ar2_mul_mvv_s* o ); \
  static inline void bhvm_vop_ar2_mul_mvv_s_run( const bhvm_vop_ar2_mul_mvv_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_mvv_s_sig( const bhvm_vop_ar2_mul_mvv_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_vmv_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_vmv_s_arity( const bhvm_vop_ar2_mul_vmv_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_vmv_s_get_index_arr( bhvm_vop_ar2_mul_vmv_s* o ); \
  static inline void bhvm_vop_ar2_mul_vmv_s_run( const bhvm_vop_ar2_mul_vmv_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_vmv_s_sig( const bhvm_vop_ar2_mul_vmv_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_tvv_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_tvv_s_arity( const bhvm_vop_ar2_mul_tvv_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_tvv_s_get_index_arr( bhvm_vop_ar2_mul_tvv_s* o ); \
  static inline void bhvm_vop_ar2_mul_tvv_s_run( const bhvm_vop_ar2_mul_tvv_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_tvv_s_sig( const bhvm_vop_ar2_mul_tvv_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_vtv_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_vtv_s_arity( const bhvm_vop_ar2_mul_vtv_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_vtv_s_get_index_arr( bhvm_vop_ar2_mul_vtv_s* o ); \
  static inline void bhvm_vop_ar2_mul_vtv_s_run( const bhvm_vop_ar2_mul_vtv_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_vtv_s_sig( const bhvm_vop_ar2_mul_vtv_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_vvm_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_vvm_s_arity( const bhvm_vop_ar2_mul_vvm_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_vvm_s_get_index_arr( bhvm_vop_ar2_mul_vvm_s* o ); \
  static inline void bhvm_vop_ar2_mul_vvm_s_run( const bhvm_vop_ar2_mul_vvm_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_vvm_s_sig( const bhvm_vop_ar2_mul_vvm_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_mmm_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_mmm_s_arity( const bhvm_vop_ar2_mul_mmm_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_mmm_s_get_index_arr( bhvm_vop_ar2_mul_mmm_s* o ); \
  static inline void bhvm_vop_ar2_mul_mmm_s_run( const bhvm_vop_ar2_mul_mmm_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_mmm_s_sig( const bhvm_vop_ar2_mul_mmm_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_mtm_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_mtm_s_arity( const bhvm_vop_ar2_mul_mtm_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_mtm_s_get_index_arr( bhvm_vop_ar2_mul_mtm_s* o ); \
  static inline void bhvm_vop_ar2_mul_mtm_s_run( const bhvm_vop_ar2_mul_mtm_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_mtm_s_sig( const bhvm_vop_ar2_mul_mtm_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_tmm_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_tmm_s_arity( const bhvm_vop_ar2_mul_tmm_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_tmm_s_get_index_arr( bhvm_vop_ar2_mul_tmm_s* o ); \
  static inline void bhvm_vop_ar2_mul_tmm_s_run( const bhvm_vop_ar2_mul_tmm_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_tmm_s_sig( const bhvm_vop_ar2_mul_tmm_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_ttm_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_ttm_s_arity( const bhvm_vop_ar2_mul_ttm_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_ttm_s_get_index_arr( bhvm_vop_ar2_mul_ttm_s* o ); \
  static inline void bhvm_vop_ar2_mul_ttm_s_run( const bhvm_vop_ar2_mul_ttm_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_ttm_s_sig( const bhvm_vop_ar2_mul_ttm_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_logic_equal_s \
  ...
  static inline sz_t bhvm_vop_ar2_logic_equal_s_arity( const bhvm_vop_ar2_logic_equal_s* o ); \
  static inline sz_t* bhvm_vop_ar2_logic_equal_s_get_index_arr( bhvm_vop_ar2_logic_equal_s* o ); \
  static inline void bhvm_vop_ar2_logic_equal_s_run( const bhvm_vop_ar2_logic_equal_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_logic_equal_s_sig( const bhvm_vop_ar2_logic_equal_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_logic_unequal_s \
  ...
  static inline sz_t bhvm_vop_ar2_logic_unequal_s_arity( const bhvm_vop_ar2_logic_unequal_s* o ); \
  static inline sz_t* bhvm_vop_ar2_logic_unequal_s_get_index_arr( bhvm_vop_ar2_logic_unequal_s* o ); \
  static inline void bhvm_vop_ar2_logic_unequal_s_run( const bhvm_vop_ar2_logic_unequal_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_logic_unequal_s_sig( const bhvm_vop_ar2_logic_unequal_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_logic_larger_s \
  ...
  static inline sz_t bhvm_vop_ar2_logic_larger_s_arity( const bhvm_vop_ar2_logic_larger_s* o ); \
  static inline sz_t* bhvm_vop_ar2_logic_larger_s_get_index_arr( bhvm_vop_ar2_logic_larger_s* o ); \
  static inline void bhvm_vop_ar2_logic_larger_s_run( const bhvm_vop_ar2_logic_larger_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_logic_larger_s_sig( const bhvm_vop_ar2_logic_larger_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_logic_smaller_s \
  ...
  static inline sz_t bhvm_vop_ar2_logic_smaller_s_arity( const bhvm_vop_ar2_logic_smaller_s* o ); \
  static inline sz_t* bhvm_vop_ar2_logic_smaller_s_get_index_arr( bhvm_vop_ar2_logic_smaller_s* o ); \
  static inline void bhvm_vop_ar2_logic_smaller_s_run( const bhvm_vop_ar2_logic_smaller_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_logic_smaller_s_sig( const bhvm_vop_ar2_logic_smaller_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_logic_larger_equal_s \
  ...
  static inline sz_t bhvm_vop_ar2_logic_larger_equal_s_arity( const bhvm_vop_ar2_logic_larger_equal_s* o ); \
  static inline sz_t* bhvm_vop_ar2_logic_larger_equal_s_get_index_arr( bhvm_vop_ar2_logic_larger_equal_s* o ); \
  static inline void bhvm_vop_ar2_logic_larger_equal_s_run( const bhvm_vop_ar2_logic_larger_equal_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_logic_larger_equal_s_sig( const bhvm_vop_ar2_logic_larger_equal_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_logic_smaller_equal_s \
  ...
  static inline sz_t bhvm_vop_ar2_logic_smaller_equal_s_arity( const bhvm_vop_ar2_logic_smaller_equal_s* o ); \
  static inline sz_t* bhvm_vop_ar2_logic_smaller_equal_s_get_index_arr( bhvm_vop_ar2_logic_smaller_equal_s* o ); \
  static inline void bhvm_vop_ar2_logic_smaller_equal_s_run( const bhvm_vop_ar2_logic_smaller_equal_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_logic_smaller_equal_s_sig( const bhvm_vop_ar2_logic_smaller_equal_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_logic_and_s \
  ...
  static inline sz_t bhvm_vop_ar2_logic_and_s_arity( const bhvm_vop_ar2_logic_and_s* o ); \
  static inline sz_t* bhvm_vop_ar2_logic_and_s_get_index_arr( bhvm_vop_ar2_logic_and_s* o ); \
  static inline void bhvm_vop_ar2_logic_and_s_run( const bhvm_vop_ar2_logic_and_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_logic_and_s_sig( const bhvm_vop_ar2_logic_and_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_logic_or_s \
  ...
  static inline sz_t bhvm_vop_ar2_logic_or_s_arity( const bhvm_vop_ar2_logic_or_s* o ); \
  static inline sz_t* bhvm_vop_ar2_logic_or_s_get_index_arr( bhvm_vop_ar2_logic_or_s* o ); \
  static inline void bhvm_vop_ar2_logic_or_s_run( const bhvm_vop_ar2_logic_or_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_logic_or_s_sig( const bhvm_vop_ar2_logic_or_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_mvv_dp_a_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_mvv_dp_a_s_arity( const bhvm_vop_ar2_mul_mvv_dp_a_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_mvv_dp_a_s_get_index_arr( bhvm_vop_ar2_mul_mvv_dp_a_s* o ); \
  static inline void bhvm_vop_ar2_mul_mvv_dp_a_s_run( const bhvm_vop_ar2_mul_mvv_dp_a_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_mvv_dp_a_s_sig( const bhvm_vop_ar2_mul_mvv_dp_a_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_vmv_dp_a_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_vmv_dp_a_s_arity( const bhvm_vop_ar2_mul_vmv_dp_a_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_vmv_dp_a_s_get_index_arr( bhvm_vop_ar2_mul_vmv_dp_a_s* o ); \
  static inline void bhvm_vop_ar2_mul_vmv_dp_a_s_run( const bhvm_vop_ar2_mul_vmv_dp_a_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_vmv_dp_a_s_sig( const bhvm_vop_ar2_mul_vmv_dp_a_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_tvv_dp_a_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_tvv_dp_a_s_arity( const bhvm_vop_ar2_mul_tvv_dp_a_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_tvv_dp_a_s_get_index_arr( bhvm_vop_ar2_mul_tvv_dp_a_s* o ); \
  static inline void bhvm_vop_ar2_mul_tvv_dp_a_s_run( const bhvm_vop_ar2_mul_tvv_dp_a_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_tvv_dp_a_s_sig( const bhvm_vop_ar2_mul_tvv_dp_a_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_vtv_dp_a_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_vtv_dp_a_s_arity( const bhvm_vop_ar2_mul_vtv_dp_a_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_vtv_dp_a_s_get_index_arr( bhvm_vop_ar2_mul_vtv_dp_a_s* o ); \
  static inline void bhvm_vop_ar2_mul_vtv_dp_a_s_run( const bhvm_vop_ar2_mul_vtv_dp_a_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_vtv_dp_a_s_sig( const bhvm_vop_ar2_mul_vtv_dp_a_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_vvm_dp_a_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_vvm_dp_a_s_arity( const bhvm_vop_ar2_mul_vvm_dp_a_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_vvm_dp_a_s_get_index_arr( bhvm_vop_ar2_mul_vvm_dp_a_s* o ); \
  static inline void bhvm_vop_ar2_mul_vvm_dp_a_s_run( const bhvm_vop_ar2_mul_vvm_dp_a_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_vvm_dp_a_s_sig( const bhvm_vop_ar2_mul_vvm_dp_a_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_mvv_dp_b_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_mvv_dp_b_s_arity( const bhvm_vop_ar2_mul_mvv_dp_b_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_mvv_dp_b_s_get_index_arr( bhvm_vop_ar2_mul_mvv_dp_b_s* o ); \
  static inline void bhvm_vop_ar2_mul_mvv_dp_b_s_run( const bhvm_vop_ar2_mul_mvv_dp_b_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_mvv_dp_b_s_sig( const bhvm_vop_ar2_mul_mvv_dp_b_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_vmv_dp_b_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_vmv_dp_b_s_arity( const bhvm_vop_ar2_mul_vmv_dp_b_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_vmv_dp_b_s_get_index_arr( bhvm_vop_ar2_mul_vmv_dp_b_s* o ); \
  static inline void bhvm_vop_ar2_mul_vmv_dp_b_s_run( const bhvm_vop_ar2_mul_vmv_dp_b_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_vmv_dp_b_s_sig( const bhvm_vop_ar2_mul_vmv_dp_b_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_tvv_dp_b_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_tvv_dp_b_s_arity( const bhvm_vop_ar2_mul_tvv_dp_b_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_tvv_dp_b_s_get_index_arr( bhvm_vop_ar2_mul_tvv_dp_b_s* o ); \
  static inline void bhvm_vop_ar2_mul_tvv_dp_b_s_run( const bhvm_vop_ar2_mul_tvv_dp_b_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_tvv_dp_b_s_sig( const bhvm_vop_ar2_mul_tvv_dp_b_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_vtv_dp_b_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_vtv_dp_b_s_arity( const bhvm_vop_ar2_mul_vtv_dp_b_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_vtv_dp_b_s_get_index_arr( bhvm_vop_ar2_mul_vtv_dp_b_s* o ); \
  static inline void bhvm_vop_ar2_mul_vtv_dp_b_s_run( const bhvm_vop_ar2_mul_vtv_dp_b_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_vtv_dp_b_s_sig( const bhvm_vop_ar2_mul_vtv_dp_b_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_vvm_dp_b_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_vvm_dp_b_s_arity( const bhvm_vop_ar2_mul_vvm_dp_b_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_vvm_dp_b_s_get_index_arr( bhvm_vop_ar2_mul_vvm_dp_b_s* o ); \
  static inline void bhvm_vop_ar2_mul_vvm_dp_b_s_run( const bhvm_vop_ar2_mul_vvm_dp_b_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_vvm_dp_b_s_sig( const bhvm_vop_ar2_mul_vvm_dp_b_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_mmm_dp_a_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_mmm_dp_a_s_arity( const bhvm_vop_ar2_mul_mmm_dp_a_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_mmm_dp_a_s_get_index_arr( bhvm_vop_ar2_mul_mmm_dp_a_s* o ); \
  static inline void bhvm_vop_ar2_mul_mmm_dp_a_s_run( const bhvm_vop_ar2_mul_mmm_dp_a_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_mmm_dp_a_s_sig( const bhvm_vop_ar2_mul_mmm_dp_a_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_mtm_dp_a_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_mtm_dp_a_s_arity( const bhvm_vop_ar2_mul_mtm_dp_a_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_mtm_dp_a_s_get_index_arr( bhvm_vop_ar2_mul_mtm_dp_a_s* o ); \
  static inline void bhvm_vop_ar2_mul_mtm_dp_a_s_run( const bhvm_vop_ar2_mul_mtm_dp_a_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_mtm_dp_a_s_sig( const bhvm_vop_ar2_mul_mtm_dp_a_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_tmm_dp_a_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_tmm_dp_a_s_arity( const bhvm_vop_ar2_mul_tmm_dp_a_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_tmm_dp_a_s_get_index_arr( bhvm_vop_ar2_mul_tmm_dp_a_s* o ); \
  static inline void bhvm_vop_ar2_mul_tmm_dp_a_s_run( const bhvm_vop_ar2_mul_tmm_dp_a_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_tmm_dp_a_s_sig( const bhvm_vop_ar2_mul_tmm_dp_a_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_ttm_dp_a_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_ttm_dp_a_s_arity( const bhvm_vop_ar2_mul_ttm_dp_a_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_ttm_dp_a_s_get_index_arr( bhvm_vop_ar2_mul_ttm_dp_a_s* o ); \
  static inline void bhvm_vop_ar2_mul_ttm_dp_a_s_run( const bhvm_vop_ar2_mul_ttm_dp_a_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_ttm_dp_a_s_sig( const bhvm_vop_ar2_mul_ttm_dp_a_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_mmm_dp_b_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_mmm_dp_b_s_arity( const bhvm_vop_ar2_mul_mmm_dp_b_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_mmm_dp_b_s_get_index_arr( bhvm_vop_ar2_mul_mmm_dp_b_s* o ); \
  static inline void bhvm_vop_ar2_mul_mmm_dp_b_s_run( const bhvm_vop_ar2_mul_mmm_dp_b_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_mmm_dp_b_s_sig( const bhvm_vop_ar2_mul_mmm_dp_b_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_mtm_dp_b_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_mtm_dp_b_s_arity( const bhvm_vop_ar2_mul_mtm_dp_b_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_mtm_dp_b_s_get_index_arr( bhvm_vop_ar2_mul_mtm_dp_b_s* o ); \
  static inline void bhvm_vop_ar2_mul_mtm_dp_b_s_run( const bhvm_vop_ar2_mul_mtm_dp_b_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_mtm_dp_b_s_sig( const bhvm_vop_ar2_mul_mtm_dp_b_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_tmm_dp_b_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_tmm_dp_b_s_arity( const bhvm_vop_ar2_mul_tmm_dp_b_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_tmm_dp_b_s_get_index_arr( bhvm_vop_ar2_mul_tmm_dp_b_s* o ); \
  static inline void bhvm_vop_ar2_mul_tmm_dp_b_s_run( const bhvm_vop_ar2_mul_tmm_dp_b_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_tmm_dp_b_s_sig( const bhvm_vop_ar2_mul_tmm_dp_b_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_ttm_dp_b_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_ttm_dp_b_s_arity( const bhvm_vop_ar2_mul_ttm_dp_b_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_ttm_dp_b_s_get_index_arr( bhvm_vop_ar2_mul_ttm_dp_b_s* o ); \
  static inline void bhvm_vop_ar2_mul_ttm_dp_b_s_run( const bhvm_vop_ar2_mul_ttm_dp_b_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_ttm_dp_b_s_sig( const bhvm_vop_ar2_mul_ttm_dp_b_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_dp_a_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_dp_a_s_arity( const bhvm_vop_ar2_mul_dp_a_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_dp_a_s_get_index_arr( bhvm_vop_ar2_mul_dp_a_s* o ); \
  static inline void bhvm_vop_ar2_mul_dp_a_s_run( const bhvm_vop_ar2_mul_dp_a_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_dp_a_s_sig( const bhvm_vop_ar2_mul_dp_a_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_mul_dp_b_s \
  ...
  static inline sz_t bhvm_vop_ar2_mul_dp_b_s_arity( const bhvm_vop_ar2_mul_dp_b_s* o ); \
  static inline sz_t* bhvm_vop_ar2_mul_dp_b_s_get_index_arr( bhvm_vop_ar2_mul_dp_b_s* o ); \
  static inline void bhvm_vop_ar2_mul_dp_b_s_run( const bhvm_vop_ar2_mul_dp_b_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_mul_dp_b_s_sig( const bhvm_vop_ar2_mul_dp_b_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_div_dp_a_s \
  ...
  static inline sz_t bhvm_vop_ar2_div_dp_a_s_arity( const bhvm_vop_ar2_div_dp_a_s* o ); \
  static inline sz_t* bhvm_vop_ar2_div_dp_a_s_get_index_arr( bhvm_vop_ar2_div_dp_a_s* o ); \
  static inline void bhvm_vop_ar2_div_dp_a_s_run( const bhvm_vop_ar2_div_dp_a_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_div_dp_a_s_sig( const bhvm_vop_ar2_div_dp_a_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_abs_dp_s \
  ...
  static inline sz_t bhvm_vop_ar2_abs_dp_s_arity( const bhvm_vop_ar2_abs_dp_s* o ); \
  static inline sz_t* bhvm_vop_ar2_abs_dp_s_get_index_arr( bhvm_vop_ar2_abs_dp_s* o ); \
  static inline void bhvm_vop_ar2_abs_dp_s_run( const bhvm_vop_ar2_abs_dp_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_abs_dp_s_sig( const bhvm_vop_ar2_abs_dp_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_exp_dp_s \
  ...
  static inline sz_t bhvm_vop_ar2_exp_dp_s_arity( const bhvm_vop_ar2_exp_dp_s* o ); \
  static inline sz_t* bhvm_vop_ar2_exp_dp_s_get_index_arr( bhvm_vop_ar2_exp_dp_s* o ); \
  static inline void bhvm_vop_ar2_exp_dp_s_run( const bhvm_vop_ar2_exp_dp_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_exp_dp_s_sig( const bhvm_vop_ar2_exp_dp_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_log_dp_s \
  ...
  static inline sz_t bhvm_vop_ar2_log_dp_s_arity( const bhvm_vop_ar2_log_dp_s* o ); \
  static inline sz_t* bhvm_vop_ar2_log_dp_s_get_index_arr( bhvm_vop_ar2_log_dp_s* o ); \
  static inline void bhvm_vop_ar2_log_dp_s_run( const bhvm_vop_ar2_log_dp_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_log_dp_s_sig( const bhvm_vop_ar2_log_dp_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_inv_dp_s \
  ...
  static inline sz_t bhvm_vop_ar2_inv_dp_s_arity( const bhvm_vop_ar2_inv_dp_s* o ); \
  static inline sz_t* bhvm_vop_ar2_inv_dp_s_get_index_arr( bhvm_vop_ar2_inv_dp_s* o ); \
  static inline void bhvm_vop_ar2_inv_dp_s_run( const bhvm_vop_ar2_inv_dp_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_inv_dp_s_sig( const bhvm_vop_ar2_inv_dp_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_sqr_dp_s \
  ...
  static inline sz_t bhvm_vop_ar2_sqr_dp_s_arity( const bhvm_vop_ar2_sqr_dp_s* o ); \
  static inline sz_t* bhvm_vop_ar2_sqr_dp_s_get_index_arr( bhvm_vop_ar2_sqr_dp_s* o ); \
  static inline void bhvm_vop_ar2_sqr_dp_s_run( const bhvm_vop_ar2_sqr_dp_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_sqr_dp_s_sig( const bhvm_vop_ar2_sqr_dp_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_srt_dp_s \
  ...
  static inline sz_t bhvm_vop_ar2_srt_dp_s_arity( const bhvm_vop_ar2_srt_dp_s* o ); \
  static inline sz_t* bhvm_vop_ar2_srt_dp_s_get_index_arr( bhvm_vop_ar2_srt_dp_s* o ); \
  static inline void bhvm_vop_ar2_srt_dp_s_run( const bhvm_vop_ar2_srt_dp_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_srt_dp_s_sig( const bhvm_vop_ar2_srt_dp_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_sigm_dp_s \
  ...
  static inline sz_t bhvm_vop_ar2_sigm_dp_s_arity( const bhvm_vop_ar2_sigm_dp_s* o ); \
  static inline sz_t* bhvm_vop_ar2_sigm_dp_s_get_index_arr( bhvm_vop_ar2_sigm_dp_s* o ); \
  static inline void bhvm_vop_ar2_sigm_dp_s_run( const bhvm_vop_ar2_sigm_dp_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_sigm_dp_s_sig( const bhvm_vop_ar2_sigm_dp_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_sigm_hard_dp_s \
  ...
  static inline sz_t bhvm_vop_ar2_sigm_hard_dp_s_arity( const bhvm_vop_ar2_sigm_hard_dp_s* o ); \
  static inline sz_t* bhvm_vop_ar2_sigm_hard_dp_s_get_index_arr( bhvm_vop_ar2_sigm_hard_dp_s* o ); \
  static inline void bhvm_vop_ar2_sigm_hard_dp_s_run( const bhvm_vop_ar2_sigm_hard_dp_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_sigm_hard_dp_s_sig( const bhvm_vop_ar2_sigm_hard_dp_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_sigm_leaky_dp_s \
  ...
  static inline sz_t bhvm_vop_ar2_sigm_leaky_dp_s_arity( const bhvm_vop_ar2_sigm_leaky_dp_s* o ); \
  static inline sz_t* bhvm_vop_ar2_sigm_leaky_dp_s_get_index_arr( bhvm_vop_ar2_sigm_leaky_dp_s* o ); \
  static inline void bhvm_vop_ar2_sigm_leaky_dp_s_run( const bhvm_vop_ar2_sigm_leaky_dp_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_sigm_leaky_dp_s_sig( const bhvm_vop_ar2_sigm_leaky_dp_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_tanh_dp_s \
  ...
  static inline sz_t bhvm_vop_ar2_tanh_dp_s_arity( const bhvm_vop_ar2_tanh_dp_s* o ); \
  static inline sz_t* bhvm_vop_ar2_tanh_dp_s_get_index_arr( bhvm_vop_ar2_tanh_dp_s* o ); \
  static inline void bhvm_vop_ar2_tanh_dp_s_run( const bhvm_vop_ar2_tanh_dp_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_tanh_dp_s_sig( const bhvm_vop_ar2_tanh_dp_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_tanh_hard_dp_s \
  ...
  static inline sz_t bhvm_vop_ar2_tanh_hard_dp_s_arity( const bhvm_vop_ar2_tanh_hard_dp_s* o ); \
  static inline sz_t* bhvm_vop_ar2_tanh_hard_dp_s_get_index_arr( bhvm_vop_ar2_tanh_hard_dp_s* o ); \
  static inline void bhvm_vop_ar2_tanh_hard_dp_s_run( const bhvm_vop_ar2_tanh_hard_dp_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_tanh_hard_dp_s_sig( const bhvm_vop_ar2_tanh_hard_dp_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_tanh_leaky_dp_s \
  ...
  static inline sz_t bhvm_vop_ar2_tanh_leaky_dp_s_arity( const bhvm_vop_ar2_tanh_leaky_dp_s* o ); \
  static inline sz_t* bhvm_vop_ar2_tanh_leaky_dp_s_get_index_arr( bhvm_vop_ar2_tanh_leaky_dp_s* o ); \
  static inline void bhvm_vop_ar2_tanh_leaky_dp_s_run( const bhvm_vop_ar2_tanh_leaky_dp_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_tanh_leaky_dp_s_sig( const bhvm_vop_ar2_tanh_leaky_dp_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_softplus_dp_s \
  ...
  static inline sz_t bhvm_vop_ar2_softplus_dp_s_arity( const bhvm_vop_ar2_softplus_dp_s* o ); \
  static inline sz_t* bhvm_vop_ar2_softplus_dp_s_get_index_arr( bhvm_vop_ar2_softplus_dp_s* o ); \
  static inline void bhvm_vop_ar2_softplus_dp_s_run( const bhvm_vop_ar2_softplus_dp_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_softplus_dp_s_sig( const bhvm_vop_ar2_softplus_dp_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_softmax_dp_s \
  ...
  static inline sz_t bhvm_vop_ar2_softmax_dp_s_arity( const bhvm_vop_ar2_softmax_dp_s* o ); \
  static inline sz_t* bhvm_vop_ar2_softmax_dp_s_get_index_arr( bhvm_vop_ar2_softmax_dp_s* o ); \
  static inline void bhvm_vop_ar2_softmax_dp_s_run( const bhvm_vop_ar2_softmax_dp_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_softmax_dp_s_sig( const bhvm_vop_ar2_softmax_dp_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_relu_dp_s \
  ...
  static inline sz_t bhvm_vop_ar2_relu_dp_s_arity( const bhvm_vop_ar2_relu_dp_s* o ); \
  static inline sz_t* bhvm_vop_ar2_relu_dp_s_get_index_arr( bhvm_vop_ar2_relu_dp_s* o ); \
  static inline void bhvm_vop_ar2_relu_dp_s_run( const bhvm_vop_ar2_relu_dp_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_relu_dp_s_sig( const bhvm_vop_ar2_relu_dp_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_relu_leaky_dp_s \
  ...
  static inline sz_t bhvm_vop_ar2_relu_leaky_dp_s_arity( const bhvm_vop_ar2_relu_leaky_dp_s* o ); \
  static inline sz_t* bhvm_vop_ar2_relu_leaky_dp_s_get_index_arr( bhvm_vop_ar2_relu_leaky_dp_s* o ); \
  static inline void bhvm_vop_ar2_relu_leaky_dp_s_run( const bhvm_vop_ar2_relu_leaky_dp_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_relu_leaky_dp_s_sig( const bhvm_vop_ar2_relu_leaky_dp_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_iff_dp_b_s \
  ...
  static inline sz_t bhvm_vop_ar2_iff_dp_b_s_arity( const bhvm_vop_ar2_iff_dp_b_s* o ); \
  static inline sz_t* bhvm_vop_ar2_iff_dp_b_s_get_index_arr( bhvm_vop_ar2_iff_dp_b_s* o ); \
  static inline void bhvm_vop_ar2_iff_dp_b_s_run( const bhvm_vop_ar2_iff_dp_b_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_iff_dp_b_s_sig( const bhvm_vop_ar2_iff_dp_b_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar2_iff_dp_c_s \
  ...
  static inline sz_t bhvm_vop_ar2_iff_dp_c_s_arity( const bhvm_vop_ar2_iff_dp_c_s* o ); \
  static inline sz_t* bhvm_vop_ar2_iff_dp_c_s_get_index_arr( bhvm_vop_ar2_iff_dp_c_s* o ); \
  static inline void bhvm_vop_ar2_iff_dp_c_s_run( const bhvm_vop_ar2_iff_dp_c_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar2_iff_dp_c_s_sig( const bhvm_vop_ar2_iff_dp_c_s* o ); \
...
#define BETH_EXPAND_GROUP_bhvm_vop_ar2 \
  ...
  XOILA_DECLARE_SPECT( bhvm_vop_ar2 ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( bhvm_vop_ar2 ) \
...
#define TYPEOF_bhvm_vop_ar3_spect_s 0xCB45BA50616C061Full
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar3_index_s \
  ...
  static inline void bhvm_vop_ar3_index_s_init_x( bhvm_vop_ar3_index_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar3_iff_s \
  ...
  static inline sz_t bhvm_vop_ar3_iff_s_arity( const bhvm_vop_ar3_iff_s* o ); \
  static inline sz_t* bhvm_vop_ar3_iff_s_get_index_arr( bhvm_vop_ar3_iff_s* o ); \
  static inline void bhvm_vop_ar3_iff_s_run( const bhvm_vop_ar3_iff_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar3_iff_s_sig( const bhvm_vop_ar3_iff_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar3_div_dp_b_s \
  ...
  static inline sz_t bhvm_vop_ar3_div_dp_b_s_arity( const bhvm_vop_ar3_div_dp_b_s* o ); \
  static inline sz_t* bhvm_vop_ar3_div_dp_b_s_get_index_arr( bhvm_vop_ar3_div_dp_b_s* o ); \
  static inline void bhvm_vop_ar3_div_dp_b_s_run( const bhvm_vop_ar3_div_dp_b_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar3_div_dp_b_s_sig( const bhvm_vop_ar3_div_dp_b_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar3_pow_dp_a_s \
  ...
  static inline sz_t bhvm_vop_ar3_pow_dp_a_s_arity( const bhvm_vop_ar3_pow_dp_a_s* o ); \
  static inline sz_t* bhvm_vop_ar3_pow_dp_a_s_get_index_arr( bhvm_vop_ar3_pow_dp_a_s* o ); \
  static inline void bhvm_vop_ar3_pow_dp_a_s_run( const bhvm_vop_ar3_pow_dp_a_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar3_pow_dp_a_s_sig( const bhvm_vop_ar3_pow_dp_a_s* o ); \
...
#define BETH_EXPAND_ITEM_bhvm_vop_ar3_pow_dp_b_s \
  ...
  static inline sz_t bhvm_vop_ar3_pow_dp_b_s_arity( const bhvm_vop_ar3_pow_dp_b_s* o ); \
  static inline sz_t* bhvm_vop_ar3_pow_dp_b_s_get_index_arr( bhvm_vop_ar3_pow_dp_b_s* o ); \
  static inline void bhvm_vop_ar3_pow_dp_b_s_run( const bhvm_vop_ar3_pow_dp_b_s* o, bhvm_holor_s** ah ); \
  static inline sc_t bhvm_vop_ar3_pow_dp_b_s_sig( const bhvm_vop_ar3_pow_dp_b_s* o ); \
...
#define BETH_EXPAND_GROUP_bhvm_vop_ar3 \
  ...
  XOILA_DECLARE_SPECT( bhvm_vop_ar3 ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( bhvm_vop_ar3 ) \
...
#endif // __bhvm_vop_xo_H
// XOILA_OUT_SIGNATURE 0xF128B959D0FE4C8Eull
