 ...
 *  Last File Update: 2020-01-11T11:50:16Z
 *
...
BCORE_DEFINE_OBJECT_INST_P( bhvm_lop_ar1_identity_dp_zf_s )
"aware bhvm_lop_ar1"
"{"
"}";
...
void bhvm_lop_ar1_identity_dp_zf_s_f( tp_t tknit, vc_t a, vd_t r, sz_t s )
{
    ...
    switch( tknit )
    {
        case BKNIT_F22: for(sz_t i=0; i<s; i++) { ((f2_t*)r)[i]+=bhvm_lop_ar1_identity_dp_zf_s_f2(((f2_t*)a)[i]); } break;
        case BKNIT_F23: for(sz_t i=0; i<s; i++) { ((f3_t*)r)[i]+=bhvm_lop_ar1_identity_dp_zf_s_f2(((f2_t*)a)[i]); } break;
        case BKNIT_F32: for(sz_t i=0; i<s; i++) { ((f2_t*)r)[i]+=bhvm_lop_ar1_identity_dp_zf_s_f3(((f3_t*)a)[i]); } break;
        case BKNIT_F33: for(sz_t i=0; i<s; i++) { ((f3_t*)r)[i]+=bhvm_lop_ar1_identity_dp_zf_s_f3(((f3_t*)a)[i]); } break;
        default: ERR_fa( "Invalid tknit '#<tp_t>'.", tknit );
    }
}

BCORE_DEFINE_OBJECT_INST_P( bhvm_lop_ar1_neg_dp_zf_s )
"aware bhvm_lop_ar1"
"{"
"}";
...
void bhvm_lop_ar1_neg_dp_zf_s_f( tp_t tknit, vc_t a, vd_t r, sz_t s )
{
    ...
    switch( tknit )
    {
        case BKNIT_F22: for(sz_t i=0; i<s; i++) { ((f2_t*)r)[i]+=bhvm_lop_ar1_neg_dp_zf_s_f2(((f2_t*)a)[i]); } break;
        case BKNIT_F23: for(sz_t i=0; i<s; i++) { ((f3_t*)r)[i]+=bhvm_lop_ar1_neg_dp_zf_s_f2(((f2_t*)a)[i]); } break;
        case BKNIT_F32: for(sz_t i=0; i<s; i++) { ((f2_t*)r)[i]+=bhvm_lop_ar1_neg_dp_zf_s_f3(((f3_t*)a)[i]); } break;
        case BKNIT_F33: for(sz_t i=0; i<s; i++) { ((f3_t*)r)[i]+=bhvm_lop_ar1_neg_dp_zf_s_f3(((f3_t*)a)[i]); } break;
        default: ERR_fa( "Invalid tknit '#<tp_t>'.", tknit );
    }
}

BCORE_DEFINE_OBJECT_INST_P( bhvm_lop_ar1_add_dp_zf_s )
"aware bhvm_lop_ar1"
"{"
"}";
...
void bhvm_lop_ar1_add_dp_zf_s_f( tp_t tknit, vc_t a, vd_t r, sz_t s )
{
    ...
    switch( tknit )
    {
        case BKNIT_F22: for(sz_t i=0; i<s; i++) { ((f2_t*)r)[i]+=bhvm_lop_ar1_add_dp_zf_s_f2(((f2_t*)a)[i]); } break;
        case BKNIT_F23: for(sz_t i=0; i<s; i++) { ((f3_t*)r)[i]+=bhvm_lop_ar1_add_dp_zf_s_f2(((f2_t*)a)[i]); } break;
        case BKNIT_F32: for(sz_t i=0; i<s; i++) { ((f2_t*)r)[i]+=bhvm_lop_ar1_add_dp_zf_s_f3(((f3_t*)a)[i]); } break;
        case BKNIT_F33: for(sz_t i=0; i<s; i++) { ((f3_t*)r)[i]+=bhvm_lop_ar1_add_dp_zf_s_f3(((f3_t*)a)[i]); } break;
        default: ERR_fa( "Invalid tknit '#<tp_t>'.", tknit );
    }
}

BCORE_DEFINE_OBJECT_INST_P( bhvm_lop_ar1_add_dp_zg_s )
"aware bhvm_lop_ar1"
"{"
"}";
...
void bhvm_lop_ar1_add_dp_zg_s_f( tp_t tknit, vc_t a, vd_t r, sz_t s )
{
    ...
    switch( tknit )
    {
        case BKNIT_F22: for(sz_t i=0; i<s; i++) { ((f2_t*)r)[i]+=bhvm_lop_ar1_add_dp_zg_s_f2(((f2_t*)a)[i]); } break;
        case BKNIT_F23: for(sz_t i=0; i<s; i++) { ((f3_t*)r)[i]+=bhvm_lop_ar1_add_dp_zg_s_f2(((f2_t*)a)[i]); } break;
        case BKNIT_F32: for(sz_t i=0; i<s; i++) { ((f2_t*)r)[i]+=bhvm_lop_ar1_add_dp_zg_s_f3(((f3_t*)a)[i]); } break;
        case BKNIT_F33: for(sz_t i=0; i<s; i++) { ((f3_t*)r)[i]+=bhvm_lop_ar1_add_dp_zg_s_f3(((f3_t*)a)[i]); } break;
        default: ERR_fa( "Invalid tknit '#<tp_t>'.", tknit );
    }
}

BCORE_DEFINE_OBJECT_INST_P( bhvm_lop_ar1_sub_dp_zf_s )
"aware bhvm_lop_ar1"
"{"
"}";
...
void bhvm_lop_ar1_sub_dp_zf_s_f( tp_t tknit, vc_t a, vd_t r, sz_t s )
{
    ...
    switch( tknit )
    {
        case BKNIT_F22: for(sz_t i=0; i<s; i++) { ((f2_t*)r)[i]+=bhvm_lop_ar1_sub_dp_zf_s_f2(((f2_t*)a)[i]); } break;
        case BKNIT_F23: for(sz_t i=0; i<s; i++) { ((f3_t*)r)[i]+=bhvm_lop_ar1_sub_dp_zf_s_f2(((f2_t*)a)[i]); } break;
        case BKNIT_F32: for(sz_t i=0; i<s; i++) { ((f2_t*)r)[i]+=bhvm_lop_ar1_sub_dp_zf_s_f3(((f3_t*)a)[i]); } break;
        case BKNIT_F33: for(sz_t i=0; i<s; i++) { ((f3_t*)r)[i]+=bhvm_lop_ar1_sub_dp_zf_s_f3(((f3_t*)a)[i]); } break;
        default: ERR_fa( "Invalid tknit '#<tp_t>'.", tknit );
    }
}

BCORE_DEFINE_OBJECT_INST_P( bhvm_lop_ar1_sub_dp_zg_s )
"aware bhvm_lop_ar1"
"{"
"}";
...
void bhvm_lop_ar1_sub_dp_zg_s_f( tp_t tknit, vc_t a, vd_t r, sz_t s )
{
    ...
    switch( tknit )
    {
        case BKNIT_F22: for(sz_t i=0; i<s; i++) { ((f2_t*)r)[i]+=bhvm_lop_ar1_sub_dp_zg_s_f2(((f2_t*)a)[i]); } break;
        case BKNIT_F23: for(sz_t i=0; i<s; i++) { ((f3_t*)r)[i]+=bhvm_lop_ar1_sub_dp_zg_s_f2(((f2_t*)a)[i]); } break;
        case BKNIT_F32: for(sz_t i=0; i<s; i++) { ((f2_t*)r)[i]+=bhvm_lop_ar1_sub_dp_zg_s_f3(((f3_t*)a)[i]); } break;
        case BKNIT_F33: for(sz_t i=0; i<s; i++) { ((f3_t*)r)[i]+=bhvm_lop_ar1_sub_dp_zg_s_f3(((f3_t*)a)[i]); } break;
        default: ERR_fa( "Invalid tknit '#<tp_t>'.", tknit );
    }
}
...
void bhvm_lop_ar2_lgst_dp_zyf_s_f( tp_t tknit, vc_t a, vc_t b, vd_t r, sz_t s )
{
    ...
    switch( tknit )
    {
        case BKNIT_F222: for(sz_t i=0; i<s; i++) { ((f2_t*)r)[i]+=bhvm_lop_ar2_lgst_dp_zyf_s_f2(((f2_t*)a)[i],((f2_t*)b)[i]); } break;
        case BKNIT_F223: for(sz_t i=0; i<s; i++) { ((f3_t*)r)[i]+=bhvm_lop_ar2_lgst_dp_zyf_s_f2(((f2_t*)a)[i],((f2_t*)b)[i]); } break;
        case BKNIT_F232: for(sz_t i=0; i<s; i++) { ((f2_t*)r)[i]+=bhvm_lop_ar2_lgst_dp_zyf_s_f3(((f2_t*)a)[i],((f3_t*)b)[i]); } break;
        case BKNIT_F233: for(sz_t i=0; i<s; i++) { ((f3_t*)r)[i]+=bhvm_lop_ar2_lgst_dp_zyf_s_f3(((f2_t*)a)[i],((f3_t*)b)[i]); } break;
        case BKNIT_F322: for(sz_t i=0; i<s; i++) { ((f2_t*)r)[i]+=bhvm_lop_ar2_lgst_dp_zyf_s_f3(((f3_t*)a)[i],((f2_t*)b)[i]); } break;
        case BKNIT_F323: for(sz_t i=0; i<s; i++) { ((f3_t*)r)[i]+=bhvm_lop_ar2_lgst_dp_zyf_s_f3(((f3_t*)a)[i],((f2_t*)b)[i]); } break;
        case BKNIT_F332: for(sz_t i=0; i<s; i++) { ((f2_t*)r)[i]+=bhvm_lop_ar2_lgst_dp_zyf_s_f3(((f3_t*)a)[i],((f3_t*)b)[i]); } break;
        case BKNIT_F333: for(sz_t i=0; i<s; i++) { ((f3_t*)r)[i]+=bhvm_lop_ar2_lgst_dp_zyf_s_f3(((f3_t*)a)[i],((f3_t*)b)[i]); } break;
        default: ERR_fa( "Invalid tknit '#<tp_t>'.", tknit );
    }
}

BCORE_DEFINE_OBJECT_INST_P( bhvm_lop_ar2_lgst_hard_dp_zyf_s )
"aware bhvm_lop_ar2"
"{"
"}";
...
void bhvm_lop_ar2_lgst_hard_dp_zyf_s_f( tp_t tknit, vc_t a, vc_t b, vd_t r, sz_t s )
{
    ...
    switch( tknit )
    {
        case BKNIT_F222: for(sz_t i=0; i<s; i++) { ((f2_t*)r)[i]+=bhvm_lop_ar2_lgst_hard_dp_zyf_s_f2(((f2_t*)a)[i],((f2_t*)b)[i]); } break;
        case BKNIT_F223: for(sz_t i=0; i<s; i++) { ((f3_t*)r)[i]+=bhvm_lop_ar2_lgst_hard_dp_zyf_s_f2(((f2_t*)a)[i],((f2_t*)b)[i]); } break;
        case BKNIT_F232: for(sz_t i=0; i<s; i++) { ((f2_t*)r)[i]+=bhvm_lop_ar2_lgst_hard_dp_zyf_s_f3(((f2_t*)a)[i],((f3_t*)b)[i]); } break;
        case BKNIT_F233: for(sz_t i=0; i<s; i++) { ((f3_t*)r)[i]+=bhvm_lop_ar2_lgst_hard_dp_zyf_s_f3(((f2_t*)a)[i],((f3_t*)b)[i]); } break;
        case BKNIT_F322: for(sz_t i=0; i<s; i++) { ((f2_t*)r)[i]+=bhvm_lop_ar2_lgst_hard_dp_zyf_s_f3(((f3_t*)a)[i],((f2_t*)b)[i]); } break;
        case BKNIT_F323: for(sz_t i=0; i<s; i++) { ((f3_t*)r)[i]+=bhvm_lop_ar2_lgst_hard_dp_zyf_s_f3(((f3_t*)a)[i],((f2_t*)b)[i]); } break;
        case BKNIT_F332: for(sz_t i=0; i<s; i++) { ((f2_t*)r)[i]+=bhvm_lop_ar2_lgst_hard_dp_zyf_s_f3(((f3_t*)a)[i],((f3_t*)b)[i]); } break;
        case BKNIT_F333: for(sz_t i=0; i<s; i++) { ((f3_t*)r)[i]+=bhvm_lop_ar2_lgst_hard_dp_zyf_s_f3(((f3_t*)a)[i],((f3_t*)b)[i]); } break;
        default: ERR_fa( "Invalid tknit '#<tp_t>'.", tknit );
    }
}

BCORE_DEFINE_OBJECT_INST_P( bhvm_lop_ar2_lgst_leaky_dp_zyf_s )
"aware bhvm_lop_ar2"
"{"
"}";
...
void bhvm_lop_ar2_lgst_leaky_dp_zyf_s_f( tp_t tknit, vc_t a, vc_t b, vd_t r, sz_t s )
{
    ...
    switch( tknit )
    {
        case BKNIT_F222: for(sz_t i=0; i<s; i++) { ((f2_t*)r)[i]+=bhvm_lop_ar2_lgst_leaky_dp_zyf_s_f2(((f2_t*)a)[i],((f2_t*)b)[i]); } break;
        case BKNIT_F223: for(sz_t i=0; i<s; i++) { ((f3_t*)r)[i]+=bhvm_lop_ar2_lgst_leaky_dp_zyf_s_f2(((f2_t*)a)[i],((f2_t*)b)[i]); } break;
        case BKNIT_F232: for(sz_t i=0; i<s; i++) { ((f2_t*)r)[i]+=bhvm_lop_ar2_lgst_leaky_dp_zyf_s_f3(((f2_t*)a)[i],((f3_t*)b)[i]); } break;
        case BKNIT_F233: for(sz_t i=0; i<s; i++) { ((f3_t*)r)[i]+=bhvm_lop_ar2_lgst_leaky_dp_zyf_s_f3(((f2_t*)a)[i],((f3_t*)b)[i]); } break;
        case BKNIT_F322: for(sz_t i=0; i<s; i++) { ((f2_t*)r)[i]+=bhvm_lop_ar2_lgst_leaky_dp_zyf_s_f3(((f3_t*)a)[i],((f2_t*)b)[i]); } break;
        case BKNIT_F323: for(sz_t i=0; i<s; i++) { ((f3_t*)r)[i]+=bhvm_lop_ar2_lgst_leaky_dp_zyf_s_f3(((f3_t*)a)[i],((f2_t*)b)[i]); } break;
        case BKNIT_F332: for(sz_t i=0; i<s; i++) { ((f2_t*)r)[i]+=bhvm_lop_ar2_lgst_leaky_dp_zyf_s_f3(((f3_t*)a)[i],((f3_t*)b)[i]); } break;
        case BKNIT_F333: for(sz_t i=0; i<s; i++) { ((f3_t*)r)[i]+=bhvm_lop_ar2_lgst_leaky_dp_zyf_s_f3(((f3_t*)a)[i],((f3_t*)b)[i]); } break;
        default: ERR_fa( "Invalid tknit '#<tp_t>'.", tknit );
    }
}
...
vd_t bhvm_planted_lop_signal_handler( const bcore_signal_s* o )
{
    switch( bcore_signal_s_handle_type( o, typeof( "bhvm_planted_lop" ) ) )
    {
        case TYPEOF_init1:
        {
            ...
            bcore_const_x_set_d( typeof( "bhvm_planted_lop_hash" ), sr_tp( 1423229444 ) );
            ...
            BCORE_REGISTER_OBJECT( bhvm_lop_ar1_identity_dp_zf_s );
            BCORE_REGISTER_OBJECT( bhvm_lop_ar1_neg_dp_zf_s );
            BCORE_REGISTER_OBJECT( bhvm_lop_ar1_add_dp_zf_s );
            BCORE_REGISTER_OBJECT( bhvm_lop_ar1_add_dp_zg_s );
            BCORE_REGISTER_OBJECT( bhvm_lop_ar1_sub_dp_zf_s );
            BCORE_REGISTER_OBJECT( bhvm_lop_ar1_sub_dp_zg_s );
