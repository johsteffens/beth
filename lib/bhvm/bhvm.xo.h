...
#define HKEYOF_bhvm_xo 0x0894D5FB111DAEDAull

#define TYPEOF_bhvm_xo 0xC97424EF2F34E33Eull
...
#define TYPEOF_bhvm_spect_s 0x0131602690077CC6ull
...
#define BETH_EXPAND_ITEM_bhvm_holor_adl_s \
  ...
  { \
      aware_t _; \
      BCORE_ARRAY_DYN_LINK_STATIC_S( bhvm_holor_s, ); \
  }; \
...
#define BETH_EXPAND_ITEM_bhvm_holor_ads_s \
  ...
  { \
      aware_t _; \
      BCORE_ARRAY_DYN_SOLID_STATIC_S( bhvm_holor_s, ); \
  }; \
...
#define BETH_EXPAND_ITEM_bhvm_holor_mdl_s \
  ...
  { \
      aware_t _; \
      BCORE_ARRAY_DYN_LINK_STATIC_S( bhvm_holor_adl_s, ); \
  }; \
...
#define BETH_EXPAND_GROUP_bhvm \
  ...
  XOILA_DECLARE_SPECT( bhvm ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( bhvm ) \
...
#define TYPEOF_bhvm_hop_spect_s 0xE8B11741EC1948C6ull
#define BETH_EXPAND_GROUP_bhvm_hop \
  ...
  XOILA_DECLARE_SPECT( bhvm_hop ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( bhvm_hop ) \
...
#define TYPEOF_bhvm_hop_ar0_spect_s 0xD2ECECF456980700ull
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar0_zro_s \
  ...
  static inline void bhvm_hop_ar0_zro_s_f( bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar0_zro_s_f( bhvm_holor_s* r ){ bhvm_lop_ar0_zro_s_f(BKNIT_FA1( r->v.type ), r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar0_one_s \
  ...
  static inline void bhvm_hop_ar0_one_s_f( bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar0_one_s_f( bhvm_holor_s* r ){ bhvm_lop_ar0_one_s_f(BKNIT_FA1( r->v.type ), r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar0_nul_dp_s \
  ...
  static inline void bhvm_hop_ar0_nul_dp_s_f( bhvm_holor_s* r ); \
...
#define BETH_EXPAND_GROUP_bhvm_hop_ar0 \
  ...
  XOILA_DECLARE_SPECT( bhvm_hop_ar0 ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( bhvm_hop_ar0 ) \
...
#define TYPEOF_bhvm_hop_ar1_spect_s 0x76445FDE317A53CBull
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_l1_s \
  ...
  static inline void bhvm_hop_ar1_l1_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar1_l1_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ){ assert( r->v.size == 1 ); bhvm_lop_ar1_l1_s_f    (BKNIT_FA2( a->v.type, r->v.type ), a->v.data, r->v.data, a->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_sqrsum_s \
  ...
  static inline void bhvm_hop_ar1_sqrsum_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar1_sqrsum_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ){ assert( r->v.size == 1 ); bhvm_lop_ar1_sqrsum_s_f(BKNIT_FA2( a->v.type, r->v.type ), a->v.data, r->v.data, a->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_cpy_s \
  ...
  static inline void bhvm_hop_ar1_cpy_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar1_cpy_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ){ assert( a->v.size == r->v.size ); bhvm_lop_ar1_cpy_s_f  (BKNIT_FA2( a->v.type, r->v.type ), a->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_neg_s \
  ...
  static inline void bhvm_hop_ar1_neg_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar1_neg_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ){ assert( a->v.size == r->v.size ); bhvm_lop_ar1_neg_s_f  (BKNIT_FA2( a->v.type, r->v.type ), a->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_floor_s \
  ...
  static inline void bhvm_hop_ar1_floor_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar1_floor_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ){ assert( a->v.size == r->v.size ); bhvm_lop_ar1_floor_s_f(BKNIT_FA2( a->v.type, r->v.type ), a->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_ceil_s \
  ...
  static inline void bhvm_hop_ar1_ceil_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar1_ceil_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ){ assert( a->v.size == r->v.size ); bhvm_lop_ar1_ceil_s_f (BKNIT_FA2( a->v.type, r->v.type ), a->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_exp_s \
  ...
  static inline void bhvm_hop_ar1_exp_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar1_exp_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ){ assert( a->v.size == r->v.size ); bhvm_lop_ar1_exp_s_f  (BKNIT_FA2( a->v.type, r->v.type ), a->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_log_s \
  ...
  static inline void bhvm_hop_ar1_log_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar1_log_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ){ assert( a->v.size == r->v.size ); bhvm_lop_ar1_log_s_f  (BKNIT_FA2( a->v.type, r->v.type ), a->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_inv_s \
  ...
  static inline void bhvm_hop_ar1_inv_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar1_inv_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ){ assert( a->v.size == r->v.size ); bhvm_lop_ar1_inv_s_f  (BKNIT_FA2( a->v.type, r->v.type ), a->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_abs_s \
  ...
  static inline void bhvm_hop_ar1_abs_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar1_abs_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ){ assert( a->v.size == r->v.size ); bhvm_lop_ar1_abs_s_f  (BKNIT_FA2( a->v.type, r->v.type ), a->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_sig_s \
  ...
  static inline void bhvm_hop_ar1_sig_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar1_sig_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ){ assert( a->v.size == r->v.size ); bhvm_lop_ar1_sig_s_f  (BKNIT_FA2( a->v.type, r->v.type ), a->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_sqr_s \
  ...
  static inline void bhvm_hop_ar1_sqr_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar1_sqr_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ){ assert( a->v.size == r->v.size ); bhvm_lop_ar1_sqr_s_f  (BKNIT_FA2( a->v.type, r->v.type ), a->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_srt_s \
  ...
  static inline void bhvm_hop_ar1_srt_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar1_srt_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ){ assert( a->v.size == r->v.size ); bhvm_lop_ar1_srt_s_f  (BKNIT_FA2( a->v.type, r->v.type ), a->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_sigm_s \
  ...
  static inline void bhvm_hop_ar1_sigm_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar1_sigm_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ){ assert( a->v.size == r->v.size ); bhvm_lop_ar1_sigm_s_f      (BKNIT_FA2( a->v.type, r->v.type ), a->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_sigm_hard_s \
  ...
  static inline void bhvm_hop_ar1_sigm_hard_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar1_sigm_hard_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ){ assert( a->v.size == r->v.size ); bhvm_lop_ar1_sigm_hard_s_f (BKNIT_FA2( a->v.type, r->v.type ), a->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_sigm_leaky_s \
  ...
  static inline void bhvm_hop_ar1_sigm_leaky_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar1_sigm_leaky_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ){ assert( a->v.size == r->v.size ); bhvm_lop_ar1_sigm_leaky_s_f(BKNIT_FA2( a->v.type, r->v.type ), a->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_tanh_s \
  ...
  static inline void bhvm_hop_ar1_tanh_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar1_tanh_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ){ assert( a->v.size == r->v.size ); bhvm_lop_ar1_tanh_s_f      (BKNIT_FA2( a->v.type, r->v.type ), a->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_tanh_hard_s \
  ...
  static inline void bhvm_hop_ar1_tanh_hard_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar1_tanh_hard_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ){ assert( a->v.size == r->v.size ); bhvm_lop_ar1_tanh_hard_s_f (BKNIT_FA2( a->v.type, r->v.type ), a->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_tanh_leaky_s \
  ...
  static inline void bhvm_hop_ar1_tanh_leaky_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar1_tanh_leaky_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ){ assert( a->v.size == r->v.size ); bhvm_lop_ar1_tanh_leaky_s_f(BKNIT_FA2( a->v.type, r->v.type ), a->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_softplus_s \
  ...
  static inline void bhvm_hop_ar1_softplus_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar1_softplus_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ){ assert( a->v.size == r->v.size ); bhvm_lop_ar1_softplus_s_f  (BKNIT_FA2( a->v.type, r->v.type ), a->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_relu_s \
  ...
  static inline void bhvm_hop_ar1_relu_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar1_relu_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ){ assert( a->v.size == r->v.size ); bhvm_lop_ar1_relu_s_f      (BKNIT_FA2( a->v.type, r->v.type ), a->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_relu_leaky_s \
  ...
  static inline void bhvm_hop_ar1_relu_leaky_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar1_relu_leaky_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ){ assert( a->v.size == r->v.size ); bhvm_lop_ar1_relu_leaky_s_f(BKNIT_FA2( a->v.type, r->v.type ), a->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_neg_dp_zf_s \
  ...
  static inline void bhvm_hop_ar1_neg_dp_zf_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_cat_dp_zf_s \
  ...
  static inline void bhvm_hop_ar1_cat_dp_zf_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_cat_dp_zg_s \
  ...
  static inline void bhvm_hop_ar1_cat_dp_zg_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_ccat_dp_zf_s \
  ...
  static inline void bhvm_hop_ar1_ccat_dp_zf_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_ccat_dp_zg_s \
  ...
  static inline void bhvm_hop_ar1_ccat_dp_zg_s_f( const bhvm_holor_s* a, bhvm_holor_s* r ); \
...
#define BETH_EXPAND_GROUP_bhvm_hop_ar1 \
  ...
  XOILA_DECLARE_SPECT( bhvm_hop_ar1 ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( bhvm_hop_ar1 ) \
...
#define TYPEOF_bhvm_hop_ar1_eci_spect_s 0x3583408865EB0453ull
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_eci_cpy_acc_s \
  ...
  static inline f2_t bhvm_hop_ar1_eci_cpy_acc_s_f2( f2_t a ); \
  static inline f3_t bhvm_hop_ar1_eci_cpy_acc_s_f3( f3_t a ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_eci_neg_acc_s \
  ...
  static inline f2_t bhvm_hop_ar1_eci_neg_acc_s_f2( f2_t a ); \
  static inline f3_t bhvm_hop_ar1_eci_neg_acc_s_f3( f3_t a ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_eci_inv_acc_s \
  ...
  static inline f2_t bhvm_hop_ar1_eci_inv_acc_s_f2( f2_t a ); \
  static inline f3_t bhvm_hop_ar1_eci_inv_acc_s_f3( f3_t a ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_eci_cpy_s \
  ...
  static inline f2_t bhvm_hop_ar1_eci_cpy_s_f2( f2_t a ); \
  static inline f3_t bhvm_hop_ar1_eci_cpy_s_f3( f3_t a ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_eci_neg_s \
  ...
  static inline f2_t bhvm_hop_ar1_eci_neg_s_f2( f2_t a ); \
  static inline f3_t bhvm_hop_ar1_eci_neg_s_f3( f3_t a ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar1_eci_inv_s \
  ...
  static inline f2_t bhvm_hop_ar1_eci_inv_s_f2( f2_t a ); \
  static inline f3_t bhvm_hop_ar1_eci_inv_s_f3( f3_t a ); \
...
#define BETH_EXPAND_GROUP_bhvm_hop_ar1_eci \
  ...
  XOILA_DECLARE_SPECT( bhvm_hop_ar1_eci ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( bhvm_hop_ar1_eci ) \
...
#define TYPEOF_bhvm_hop_ar2_spect_s 0x963966A5F59796CAull
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_sub_sqrsum_s \
  ...
  static inline void bhvm_hop_ar2_sub_sqrsum_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_sub_sqrsum_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVS; bhvm_lop_ar2_sub_sqrsum_s_f(BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, a->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_sub_l1_s \
  ...
  static inline void bhvm_hop_ar2_sub_l1_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_sub_l1_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVS; bhvm_lop_ar2_sub_l1_s_f    (BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, a->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_equal_s \
  ...
  static inline void bhvm_hop_ar2_equal_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_equal_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVV; bhvm_lop_ar2_equal_s_f        (BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_unequal_s \
  ...
  static inline void bhvm_hop_ar2_unequal_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_unequal_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVV; bhvm_lop_ar2_unequal_s_f      (BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_larger_s \
  ...
  static inline void bhvm_hop_ar2_larger_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_larger_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVV; bhvm_lop_ar2_larger_s_f       (BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_smaller_s \
  ...
  static inline void bhvm_hop_ar2_smaller_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_smaller_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVV; bhvm_lop_ar2_smaller_s_f      (BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_larger_equal_s \
  ...
  static inline void bhvm_hop_ar2_larger_equal_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_larger_equal_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVV; bhvm_lop_ar2_larger_equal_s_f (BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_smaller_equal_s \
  ...
  static inline void bhvm_hop_ar2_smaller_equal_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_smaller_equal_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVV; bhvm_lop_ar2_smaller_equal_s_f(BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_logic_and_s \
  ...
  static inline void bhvm_hop_ar2_logic_and_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_logic_and_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVV; bhvm_lop_ar2_logic_and_s_f    (BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_logic_or_s \
  ...
  static inline void bhvm_hop_ar2_logic_or_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_logic_or_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVV; bhvm_lop_ar2_logic_or_s_f     (BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_abs_dp_zaf_s \
  ...
  static inline void bhvm_hop_ar2_abs_dp_zaf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_abs_dp_zaf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVV; bhvm_lop_ar2_abs_dp_zaf_s_f (BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_exp_dp_zyf_s \
  ...
  static inline void bhvm_hop_ar2_exp_dp_zyf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_exp_dp_zyf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVV; bhvm_lop_ar2_exp_dp_zyf_s_f (BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_log_dp_zaf_s \
  ...
  static inline void bhvm_hop_ar2_log_dp_zaf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_log_dp_zaf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVV; bhvm_lop_ar2_log_dp_zaf_s_f (BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_inv_dp_zyf_s \
  ...
  static inline void bhvm_hop_ar2_inv_dp_zyf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_inv_dp_zyf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVV; bhvm_lop_ar2_inv_dp_zyf_s_f (BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_sqr_dp_zaf_s \
  ...
  static inline void bhvm_hop_ar2_sqr_dp_zaf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_sqr_dp_zaf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVV; bhvm_lop_ar2_sqr_dp_zaf_s_f (BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_srt_dp_zyf_s \
  ...
  static inline void bhvm_hop_ar2_srt_dp_zyf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_srt_dp_zyf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVV; bhvm_lop_ar2_srt_dp_zyf_s_f (BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_sigm_dp_zyf_s \
  ...
  static inline void bhvm_hop_ar2_sigm_dp_zyf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_sigm_dp_zyf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVV; bhvm_lop_ar2_sigm_dp_zyf_s_f(BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_sigm_hard_dp_zyf_s \
  ...
  static inline void bhvm_hop_ar2_sigm_hard_dp_zyf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_sigm_hard_dp_zyf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVV; bhvm_lop_ar2_sigm_hard_dp_zyf_s_f (BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_sigm_leaky_dp_zyf_s \
  ...
  static inline void bhvm_hop_ar2_sigm_leaky_dp_zyf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_sigm_leaky_dp_zyf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVV; bhvm_lop_ar2_sigm_leaky_dp_zyf_s_f(BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_tanh_dp_zyf_s \
  ...
  static inline void bhvm_hop_ar2_tanh_dp_zyf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_tanh_dp_zyf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVV; bhvm_lop_ar2_tanh_dp_zyf_s_f      (BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_tanh_hard_dp_zyf_s \
  ...
  static inline void bhvm_hop_ar2_tanh_hard_dp_zyf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_tanh_hard_dp_zyf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVV; bhvm_lop_ar2_tanh_hard_dp_zyf_s_f (BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_tanh_leaky_dp_zyf_s \
  ...
  static inline void bhvm_hop_ar2_tanh_leaky_dp_zyf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_tanh_leaky_dp_zyf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVV; bhvm_lop_ar2_tanh_leaky_dp_zyf_s_f(BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_softplus_dp_zyf_s \
  ...
  static inline void bhvm_hop_ar2_softplus_dp_zyf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_softplus_dp_zyf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVV; bhvm_lop_ar2_softplus_dp_zyf_s_f  (BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_relu_dp_zyf_s \
  ...
  static inline void bhvm_hop_ar2_relu_dp_zyf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_relu_dp_zyf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVV; bhvm_lop_ar2_relu_dp_zyf_s_f      (BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_relu_leaky_dp_zyf_s \
  ...
  static inline void bhvm_hop_ar2_relu_leaky_dp_zyf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_relu_leaky_dp_zyf_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVV; bhvm_lop_ar2_relu_leaky_dp_zyf_s_f(BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, r->v.size );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_mul_mvv_s \
  ...
  static inline void bhvm_hop_ar2_mul_mvv_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_mul_mvv_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_MVV; bhvm_lop_ar2_mul_mvv_s_f_m(BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, a->s.data[ 1 ], a->s.data[ 0 ] );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_mul_vmv_s \
  ...
  static inline void bhvm_hop_ar2_mul_vmv_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_mul_vmv_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VMV; bhvm_lop_ar2_mul_vmv_s_f_m(BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, b->s.data[ 1 ], b->s.data[ 0 ] );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_mul_vvm_s \
  ...
  static inline void bhvm_hop_ar2_mul_vvm_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_mul_vvm_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVM; bhvm_lop_ar2_mul_vvm_s_f_m(BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, r->s.data[ 1 ], r->s.data[ 0 ] );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_mul_tvv_s \
  ...
  static inline void bhvm_hop_ar2_mul_tvv_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_mul_tvv_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_TVV; bhvm_lop_ar2_mul_vmv_s_f_m(BKNIT_FA3( b->v.type, a->v.type, r->v.type ), b->v.data, a->v.data, r->v.data, a->s.data[ 1 ], a->s.data[ 0 ] );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_mul_vtv_s \
  ...
  static inline void bhvm_hop_ar2_mul_vtv_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_mul_vtv_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VTV; bhvm_lop_ar2_mul_mvv_s_f_m(BKNIT_FA3( b->v.type, a->v.type, r->v.type ), b->v.data, a->v.data, r->v.data, b->s.data[ 1 ], b->s.data[ 0 ] );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_mul_acc_mvv_s \
  ...
  static inline void bhvm_hop_ar2_mul_acc_mvv_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_mul_acc_mvv_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_MVV; bhvm_lop_ar2_mul_acc_mvv_s_f_m(BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, a->s.data[ 1 ], a->s.data[ 0 ] );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_mul_acc_vmv_s \
  ...
  static inline void bhvm_hop_ar2_mul_acc_vmv_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_mul_acc_vmv_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VMV; bhvm_lop_ar2_mul_acc_vmv_s_f_m(BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, b->s.data[ 1 ], b->s.data[ 0 ] );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_mul_acc_tvv_s \
  ...
  static inline void bhvm_hop_ar2_mul_acc_tvv_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_mul_acc_tvv_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_TVV; bhvm_lop_ar2_mul_acc_vmv_s_f_m(BKNIT_FA3( b->v.type, a->v.type, r->v.type ), b->v.data, a->v.data, r->v.data, a->s.data[ 1 ], a->s.data[ 0 ] );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_mul_acc_vtv_s \
  ...
  static inline void bhvm_hop_ar2_mul_acc_vtv_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_mul_acc_vtv_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VTV; bhvm_lop_ar2_mul_acc_mvv_s_f_m(BKNIT_FA3( b->v.type, a->v.type, r->v.type ), b->v.data, a->v.data, r->v.data, b->s.data[ 1 ], b->s.data[ 0 ] );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_mul_acc_vvm_s \
  ...
  static inline void bhvm_hop_ar2_mul_acc_vvm_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
  static inline void bhvm_hop_ar2_mul_acc_vvm_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ){ BODY_ASSERT_VVM; bhvm_lop_ar2_mul_acc_vvm_s_f_m(BKNIT_FA3( a->v.type, b->v.type, r->v.type ), a->v.data, b->v.data, r->v.data, r->s.data[ 1 ], r->s.data[ 0 ] );}
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_cat_s \
  ...
  static inline void bhvm_hop_ar2_cat_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_ccat_s \
  ...
  static inline void bhvm_hop_ar2_ccat_s_f( const bhvm_holor_s* a, const bhvm_holor_s* b, bhvm_holor_s* r ); \
...
#define BETH_EXPAND_GROUP_bhvm_hop_ar2 \
  ...
  XOILA_DECLARE_SPECT( bhvm_hop_ar2 ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( bhvm_hop_ar2 ) \
...
#define TYPEOF_bhvm_hop_ar2_eci_spect_s 0xAAA68D9546FE8F1Aull
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_eci_add_acc_s \
  ...
  static inline f2_t bhvm_hop_ar2_eci_add_acc_s_f2( f2_t a, f2_t b ); \
  static inline f3_t bhvm_hop_ar2_eci_add_acc_s_f3( f3_t a, f3_t b ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_eci_sub_acc_s \
  ...
  static inline f2_t bhvm_hop_ar2_eci_sub_acc_s_f2( f2_t a, f2_t b ); \
  static inline f3_t bhvm_hop_ar2_eci_sub_acc_s_f3( f3_t a, f3_t b ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_eci_mul_acc_s \
  ...
  static inline f2_t bhvm_hop_ar2_eci_mul_acc_s_f2( f2_t a, f2_t b ); \
  static inline f3_t bhvm_hop_ar2_eci_mul_acc_s_f3( f3_t a, f3_t b ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_eci_div_acc_s \
  ...
  static inline f2_t bhvm_hop_ar2_eci_div_acc_s_f2( f2_t a, f2_t b ); \
  static inline f3_t bhvm_hop_ar2_eci_div_acc_s_f3( f3_t a, f3_t b ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_eci_pow_acc_s \
  ...
  static inline f2_t bhvm_hop_ar2_eci_pow_acc_s_f2( f2_t a, f2_t b ); \
  static inline f3_t bhvm_hop_ar2_eci_pow_acc_s_f3( f3_t a, f3_t b ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_eci_iff_dp_b_azg_s \
  ...
  static inline f2_t bhvm_hop_ar2_eci_iff_dp_b_azg_s_f2( f2_t a, f2_t b ); \
  static inline f3_t bhvm_hop_ar2_eci_iff_dp_b_azg_s_f3( f3_t a, f3_t b ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_eci_iff_dp_c_azh_s \
  ...
  static inline f2_t bhvm_hop_ar2_eci_iff_dp_c_azh_s_f2( f2_t a, f2_t b ); \
  static inline f3_t bhvm_hop_ar2_eci_iff_dp_c_azh_s_f3( f3_t a, f3_t b ); \
...
#define BETH_EXPAND_GROUP_bhvm_hop_ar2_eci \
  ...
  XOILA_DECLARE_SPECT( bhvm_hop_ar2_eci ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( bhvm_hop_ar2_eci ) \
...
#define TYPEOF_bhvm_hop_ar2_eci_logic_spect_s 0x1C9445884D9864B7ull
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_eci_logic_equal_s \
  ...
  static inline f2_t bhvm_hop_ar2_eci_logic_equal_s_f2( f2_t a, f2_t b ); \
  static inline f3_t bhvm_hop_ar2_eci_logic_equal_s_f3( f3_t a, f3_t b ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_eci_logic_unequal_s \
  ...
  static inline f2_t bhvm_hop_ar2_eci_logic_unequal_s_f2( f2_t a, f2_t b ); \
  static inline f3_t bhvm_hop_ar2_eci_logic_unequal_s_f3( f3_t a, f3_t b ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_eci_logic_larger_s \
  ...
  static inline f2_t bhvm_hop_ar2_eci_logic_larger_s_f2( f2_t a, f2_t b ); \
  static inline f3_t bhvm_hop_ar2_eci_logic_larger_s_f3( f3_t a, f3_t b ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_eci_logic_smaller_s \
  ...
  static inline f2_t bhvm_hop_ar2_eci_logic_smaller_s_f2( f2_t a, f2_t b ); \
  static inline f3_t bhvm_hop_ar2_eci_logic_smaller_s_f3( f3_t a, f3_t b ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_eci_logic_larger_equal_s \
  ...
  static inline f2_t bhvm_hop_ar2_eci_logic_larger_equal_s_f2( f2_t a, f2_t b ); \
  static inline f3_t bhvm_hop_ar2_eci_logic_larger_equal_s_f3( f3_t a, f3_t b ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_eci_logic_smaller_equal_s \
  ...
  static inline f2_t bhvm_hop_ar2_eci_logic_smaller_equal_s_f2( f2_t a, f2_t b ); \
  static inline f3_t bhvm_hop_ar2_eci_logic_smaller_equal_s_f3( f3_t a, f3_t b ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_eci_logic_and_s \
  ...
  static inline f2_t bhvm_hop_ar2_eci_logic_and_s_f2( f2_t a, f2_t b ); \
  static inline f3_t bhvm_hop_ar2_eci_logic_and_s_f3( f3_t a, f3_t b ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar2_eci_logic_or_s \
  ...
  static inline f2_t bhvm_hop_ar2_eci_logic_or_s_f2( f2_t a, f2_t b ); \
  static inline f3_t bhvm_hop_ar2_eci_logic_or_s_f3( f3_t a, f3_t b ); \
...
#define BETH_EXPAND_GROUP_bhvm_hop_ar2_eci_logic \
  ...
  XOILA_DECLARE_SPECT( bhvm_hop_ar2_eci_logic ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( bhvm_hop_ar2_eci_logic ) \
...
#define TYPEOF_bhvm_hop_ar3_spect_s 0x26390EA108F06B8Dull
#define BETH_EXPAND_GROUP_bhvm_hop_ar3 \
  BCORE_FORWARD_OBJECT( bhvm_hop_ar3 ); \
  XOILA_DECLARE_SPECT( bhvm_hop_ar3 ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( bhvm_hop_ar3 )

//----------------------------------------------------------------------------------------------------------------------
// group: bhvm_hop_ar3_eci

#define TYPEOF_bhvm_hop_ar3_eci 0x27DF246C1B1166A9ull
#define TYPEOF_bhvm_hop_ar3_eci_spect_s 0x37FDCC76615A7C65ull
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar3_eci_iff_s \
  ...
  static inline f2_t bhvm_hop_ar3_eci_iff_s_f2( f2_t a, f2_t b, f2_t c ); \
  static inline f3_t bhvm_hop_ar3_eci_iff_s_f3( f3_t a, f3_t b, f3_t c ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar3_eci_iff_acc_s \
  ...
  static inline f2_t bhvm_hop_ar3_eci_iff_acc_s_f2( f2_t a, f2_t b, f2_t c ); \
  static inline f3_t bhvm_hop_ar3_eci_iff_acc_s_f3( f3_t a, f3_t b, f3_t c ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar3_eci_div_dp_zabg_s \
  ...
  static inline f2_t bhvm_hop_ar3_eci_div_dp_zabg_s_f2( f2_t a, f2_t b, f2_t c ); \
  static inline f3_t bhvm_hop_ar3_eci_div_dp_zabg_s_f3( f3_t a, f3_t b, f3_t c ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar3_eci_pow_dp_abzf_s \
  ...
  static inline f2_t bhvm_hop_ar3_eci_pow_dp_abzf_s_f2( f2_t a, f2_t b, f2_t c ); \
  static inline f3_t bhvm_hop_ar3_eci_pow_dp_abzf_s_f3( f3_t a, f3_t b, f3_t c ); \
...
#define BETH_EXPAND_ITEM_bhvm_hop_ar3_eci_pow_dp_ayzg_s \
  ...
  static inline f2_t bhvm_hop_ar3_eci_pow_dp_ayzg_s_f2( f2_t a, f2_t b, f2_t c ); \
  static inline f3_t bhvm_hop_ar3_eci_pow_dp_ayzg_s_f3( f3_t a, f3_t b, f3_t c ); \
...
#define BETH_EXPAND_GROUP_bhvm_hop_ar3_eci \
  ...
  XOILA_DECLARE_SPECT( bhvm_hop_ar3_eci ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( bhvm_hop_ar3_eci ) \
...
#define TYPEOF_bhvm_mcode_spect_s 0xA523F369284124CBull
...
#define BETH_EXPAND_ITEM_bhvm_mcode_op_s \
  ...
  static inline void bhvm_mcode_op_s_copy_x( bhvm_mcode_op_s* o, const bhvm_mcode_op_s* src ); \
  static inline void bhvm_mcode_op_s_mutated( bhvm_mcode_op_s* o ); \
  static inline void bhvm_mcode_op_s_run( const bhvm_mcode_op_s* o, bhvm_holor_s** ah ); \
  static inline void bhvm_mcode_op_s_copy_x( bhvm_mcode_op_s* o, const bhvm_mcode_op_s* src ){ o->p = o->vop ? ( bhvm_vop_spect_s* )bhvm_vop_spect_s_get_aware( o->vop ) : NULL;} \
  static inline void bhvm_mcode_op_s_mutated( bhvm_mcode_op_s* o ){ bhvm_mcode_op_s_copy_x(o,NULL );} \
...
#define BETH_EXPAND_ITEM_bhvm_mcode_nbase_s \
  ...
  { \
      aware_t _; \
      BCORE_ARRAY_DYN_LINK_STATIC_S( bhvm_mcode_node_s, ); \
  }; \
...
#define BETH_EXPAND_ITEM_bhvm_mcode_track_s \
  ...
  { \
      aware_t _; \
      tp_t name; \
      BCORE_ARRAY_DYN_SOLID_STATIC_S( bhvm_mcode_op_s, ); \
  }; \
  static inline void bhvm_mcode_track_s_run( const bhvm_mcode_track_s* o, bhvm_holor_s** ah ); \
  ...
  static inline sz_t bhvm_mcode_track_s_vop_push_c( bhvm_mcode_track_s* o, const bhvm_vop* vop ); \
  ...
  static inline void bhvm_mcode_track_s_run( const bhvm_mcode_track_s* o, bhvm_holor_s** ah ){ for( sz_t i = 0; i < o->size; i++ ) bhvm_mcode_op_s_run(&(o->data[i]),ah );} \
  static inline sz_t bhvm_mcode_track_s_vop_push_c( bhvm_mcode_track_s* o, const bhvm_vop* vop ){ return  bhvm_mcode_track_s_vop_push_d(o,bhvm_vop_a_clone(vop) );}
...
#define BETH_EXPAND_ITEM_bhvm_mcode_track_adl_s \
  ...
  { \
      aware_t _; \
      BCORE_ARRAY_DYN_LINK_STATIC_S( bhvm_mcode_track_s, ); \
  }; \
...
#define BETH_EXPAND_ITEM_bhvm_mcode_lib_s \
  ...
  static inline void bhvm_mcode_lib_s_clear( bhvm_mcode_lib_s* o ); \
  static inline bl_t bhvm_mcode_lib_s_track_exists( const bhvm_mcode_lib_s* o, tp_t name ); \
  ...
  static inline void bhvm_mcode_lib_s_track_vop_push_c( bhvm_mcode_lib_s* o, tp_t name, const bhvm_vop* vop ); \
  static inline void bhvm_mcode_lib_s_track_vop_push_d( bhvm_mcode_lib_s* o, tp_t name, bhvm_vop* vop ); \
...
#define BETH_EXPAND_ITEM_bhvm_mcode_frame_s \
  ...
  static inline bhvm_mcode_track_s* bhvm_mcode_frame_s_track_get( bhvm_mcode_frame_s* o, tp_t name ); \
  static inline void bhvm_mcode_frame_s_track_vop_push_c( bhvm_mcode_frame_s* o, tp_t name, const bhvm_vop* vop ); \
  static inline void bhvm_mcode_frame_s_track_vop_push_d( bhvm_mcode_frame_s* o, tp_t name, bhvm_vop* vop ); \
  static inline void bhvm_mcode_frame_s_track_vop_set_args_push_d( bhvm_mcode_frame_s* o, tp_t name, bhvm_vop* vop, const bhvm_vop_arr_ci_s* arr_ci ); \
  static inline sz_t bhvm_mcode_frame_s_push_hm( bhvm_mcode_frame_s* o, const bhvm_holor_s* h, const bhvm_mcode_hmeta* m ); \
  static inline sz_t bhvm_mcode_frame_s_push_hmc( bhvm_mcode_frame_s* o, const bhvm_holor_s* h, const bhvm_mcode_hmeta* m, char c, bhvm_vop_arr_ci_s* arr_ci ); \
  static inline bhvm_mcode_node_s* bhvm_mcode_frame_s_push_node( bhvm_mcode_frame_s* o ); \
  static inline void bhvm_mcode_frame_s_track_run( const bhvm_mcode_frame_s* o, tp_t name ); \
  static inline bhvm_mcode_track_s* bhvm_mcode_frame_s_track_get( bhvm_mcode_frame_s* o, tp_t name ){ return  ( o->lib ) ? bhvm_mcode_lib_s_track_get(o->lib,name ) : NULL;} \
...
#define BETH_EXPAND_GROUP_bhvm_mcode \
  ...
  XOILA_DECLARE_SPECT( bhvm_mcode ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( bhvm_mcode ) \
...
#define TYPEOF_bhvm_mcode_hmeta_spect_s 0x7508B08483D41965ull
...
#define BETH_EXPAND_ITEM_bhvm_mcode_hmeta_adl_s \
  ...
  { \
      aware_t _; \
      BCORE_ARRAY_DYN_LINK_STATIC_S( bhvm_mcode_hmeta, ); \
  }; \
...
#define BETH_EXPAND_GROUP_bhvm_mcode_hmeta \
  ...
  XOILA_DECLARE_SPECT( bhvm_mcode_hmeta ) \
  { \
      bcore_spect_header_s header; \
  ...
  static inline tp_t bhvm_mcode_hmeta_a_get_name( const bhvm_mcode_hmeta* o ){ const bhvm_mcode_hmeta_spect_s* p = bhvm_mcode_hmeta_spect_s_get_aware( o ); assert( p->get_name ); return p->get_name( o );} \
  static inline bl_t bhvm_mcode_hmeta_a_defines_get_name( const bhvm_mcode_hmeta* o ){ return  true;} \
  static inline tp_t bhvm_mcode_hmeta_get_name_default( const bhvm_mcode_hmeta* o ){ return  0;} \
  static inline tp_t bhvm_mcode_hmeta_a_get_pclass( const bhvm_mcode_hmeta* o ){ const bhvm_mcode_hmeta_spect_s* p = bhvm_mcode_hmeta_spect_s_get_aware( o ); assert( p->get_pclass ); return p->get_pclass( o );} \
  static inline bl_t bhvm_mcode_hmeta_a_defines_get_pclass( const bhvm_mcode_hmeta* o ){ return  true;} \
  static inline tp_t bhvm_mcode_hmeta_get_pclass_default( const bhvm_mcode_hmeta* o ){ return  0;} \
  static inline bhvm_mcode_node_s* bhvm_mcode_hmeta_a_get_node( const bhvm_mcode_hmeta* o ){ const bhvm_mcode_hmeta_spect_s* p = bhvm_mcode_hmeta_spect_s_get_aware( o ); assert( p->get_node ); return p->get_node( o );} \
  static inline bl_t bhvm_mcode_hmeta_a_defines_get_node( const bhvm_mcode_hmeta* o ){ return  true;} \
  static inline bhvm_mcode_node_s* bhvm_mcode_hmeta_get_node_default( const bhvm_mcode_hmeta* o ){ return  NULL;} \
  static inline void bhvm_mcode_hmeta_a_set_node( bhvm_mcode_hmeta* o, bhvm_mcode_node_s* node ){ const bhvm_mcode_hmeta_spect_s* p = bhvm_mcode_hmeta_spect_s_get_aware( o ); assert( p->set_node ); p->set_node( o, node );} \
  static inline bl_t bhvm_mcode_hmeta_a_defines_set_node( const bhvm_mcode_hmeta* o ){ return  true;} \
  static inline void bhvm_mcode_hmeta_set_node_default( bhvm_mcode_hmeta* o, bhvm_mcode_node_s* node ){} \
  static inline bl_t bhvm_mcode_hmeta_a_is_rollable( const bhvm_mcode_hmeta* o ){ const bhvm_mcode_hmeta_spect_s* p = bhvm_mcode_hmeta_spect_s_get_aware( o ); assert( p->is_rollable ); return p->is_rollable( o );} \
  static inline bl_t bhvm_mcode_hmeta_a_defines_is_rollable( const bhvm_mcode_hmeta* o ){ return  true;} \
  static inline bl_t bhvm_mcode_hmeta_is_rollable_default( const bhvm_mcode_hmeta* o ){ return  false;} \
  static inline bl_t bhvm_mcode_hmeta_a_is_active( const bhvm_mcode_hmeta* o ){ const bhvm_mcode_hmeta_spect_s* p = bhvm_mcode_hmeta_spect_s_get_aware( o ); assert( p->is_active ); return p->is_active( o );} \
  static inline bl_t bhvm_mcode_hmeta_a_defines_is_active( const bhvm_mcode_hmeta* o ){ return  true;} \
  static inline bl_t bhvm_mcode_hmeta_is_active_default( const bhvm_mcode_hmeta* o ){ return  true;} \
  static inline bcore_inst* bhvm_mcode_hmeta_a_get_custom( const bhvm_mcode_hmeta* o ){ const bhvm_mcode_hmeta_spect_s* p = bhvm_mcode_hmeta_spect_s_get_aware( o ); assert( p->get_custom ); return p->get_custom( o );} \
  static inline bl_t bhvm_mcode_hmeta_a_defines_get_custom( const bhvm_mcode_hmeta* o ){ return  true;} \
  static inline bcore_inst* bhvm_mcode_hmeta_get_custom_default( const bhvm_mcode_hmeta* o ){ return  NULL;} \
  static inline bcore_inst* bhvm_mcode_hmeta_a_set_custom( bhvm_mcode_hmeta* o, const bcore_inst* custom ){ const bhvm_mcode_hmeta_spect_s* p = bhvm_mcode_hmeta_spect_s_get_aware( o ); assert( p->set_custom ); return p->set_custom( o, custom );} \
  static inline bl_t bhvm_mcode_hmeta_a_defines_set_custom( const bhvm_mcode_hmeta* o ){ return  true;} \
  static inline bcore_inst* bhvm_mcode_hmeta_set_custom_default( bhvm_mcode_hmeta* o, const bcore_inst* custom ){ return  NULL;} \
...
#define TYPEOF_bhvm_mcode_hbase_spect_s 0x40A124C26C44A585ull
...
#define BETH_EXPAND_ITEM_bhvm_mcode_hbase_s \
  ...
  { \
      ...
      sz_t copy_size_limit; \
  }; \
  bhvm_mcode_hbase_s* bhvm_mcode_hbase_s_set_size( bhvm_mcode_hbase_s* o, sz_t size ); \
  static inline void bhvm_mcode_hbase_s_mutated( bhvm_mcode_hbase_s* o ); \
  static inline void bhvm_mcode_hbase_s_copy_x( bhvm_mcode_hbase_s* o, const bhvm_mcode_hbase_s* src ); \
  static inline sz_t bhvm_mcode_hbase_s_get_size( const bhvm_mcode_hbase_s* o ); \
  ...
  static inline bhvm_holor_s* bhvm_mcode_hbase_s_get_holor( const bhvm_mcode_hbase_s* o, sz_t index ); \
  static inline bhvm_mcode_hmeta* bhvm_mcode_hbase_s_get_hmeta( const bhvm_mcode_hbase_s* o, sz_t index ); \
  ...
  static inline void bhvm_mcode_hbase_s_copy_x( bhvm_mcode_hbase_s* o, const bhvm_mcode_hbase_s* src ){ if( o->copy_size_limit >= 0 ) bhvm_mcode_hbase_s_set_size(o,o->copy_size_limit );} \
...
#define BETH_EXPAND_GROUP_bhvm_mcode_hbase \
  ...
  XOILA_DECLARE_SPECT( bhvm_mcode_hbase ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( bhvm_mcode_hbase ) \
...
#endif // __bhvm_xo_H
// XOILA_OUT_SIGNATURE 0xCE943F0557CB47AEull
