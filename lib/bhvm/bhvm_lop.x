...
group :ar1 =
{
    ...
    stamp :cpy_s      { func :.f2 =  a; func :.f3 =  a; func :.f :body_v_cv; }
    stamp :identity_s { func :.f2 =  a; func :.f3 =  a; func :.f :body_v_cv; } // same as cpy
    stamp :neg_s      { func :.f2 = -a; func :.f3 = -a; func :.f :body_v_cv; }
    stamp :floor_s    { func :.f2 = floorf(a); func :.f3 =  floor(a); func :.f :body_v_cv; }
    stamp :ceil_s     { func :.f2 =  ceilf(a); func :.f3 =   ceil(a); func :.f :body_v_cv; }
    stamp :exp_s      { func :.f2 = f2_exp(a); func :.f3 = f3_exp(a); func :.f :body_v_cv; }
    stamp :log_s      { func :.f2 = f2_log(a); func :.f3 = f3_log(a); func :.f :body_v_cv; }
    stamp :inv_s      { func :.f2 = f2_inv(a); func :.f3 = f3_inv(a); func :.f :body_v_cv; }

    stamp :abs_s      { func :.f2 = f2_abs(a); func :.f3 = f3_abs(a); func :.f :body_v_cv; }
    stamp :sig_s      { func :.f2 = f2_sig(a); func :.f3 = f3_sig(a); func :.f :body_v_cv; }
    stamp :l1_s       { func :.f2 = f2_abs(a); func :.f3 = f3_abs(a); func :.f :body_v_cs; }
    stamp :sqr_s      { func :.f2 = f2_sqr(a); func :.f3 = f3_sqr(a); func :.f :body_v_cv; }
...
group :ar2 =
{
    ...
    stamp :inv_dp_zyf_s { func :.f2 = -a*b*b;     func :.f3 = -a*b*b;     func :.f :body_vv_av; }
    ...
    stamp :branch_vvvv_dp_azg_s = { func :.f2 = a > 0 ? b : 0; func :.f3 = a > 0 ? b : 0; func :.f :body_vv_av; }
    stamp :branch_vvvv_dp_azh_s = { func :.f2 = a > 0 ? 0 : b; func :.f3 = a > 0 ? 0 : b; func :.f :body_vv_av; }
