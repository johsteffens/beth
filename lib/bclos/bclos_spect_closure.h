...
// (optional) defines a closure: (re)binds instance; env deemed lexical environment
typedef void (*bclos_closure_fp_def )( vd_t o, bclos_environment_s* env );

// calls closure function; env deemed dynamic environment (optional);
typedef sr_s (*bclos_closure_fp_call )( vc_t o, bclos_environment_s* env, const bclos_arguments_s* args );
...
sr_s bclos_closure_spect_call_nv( const bclos_closure_s* p, vc_t o, bclos_environment_s* env, sz_t n, va_list args ); // call with n arguments
sr_s bclos_closure_spect_call_na( const bclos_closure_s* p, vc_t o, bclos_environment_s* env, sz_t n, ...          ); // call with n arguments
...
sr_s bclos_closure_q_call_nv( const sr_s* o, bclos_environment_s* env, sz_t n, va_list args ); // call with n arguments
sr_s bclos_closure_q_call_na( const sr_s* o, bclos_environment_s* env, sz_t n, ...          ); // call with n arguments
