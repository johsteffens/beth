...
{
    bcore_array_t_push( TYPEOF_bclos_procedure_s, (bcore_array*)o, statement );
}
...
static bcore_self_s* procedure_s_create_self( void )
{
    ...
    bcore_self_s* self = BCORE_SELF_S_BUILD_PARSE_SC( def, bclos_procedure_s );
...
static st_s* procedure_selftest( void )
{
    ...
    {
        bcore_self_s* self = bcore_self_s_build_parse_sc( "test_add = bclos_closure {}", 0, 0 );
        bcore_self_s_push_ns_func( self, ( fp_t )test_add, "bclos_closure_fp_call", "call" );
        bcore_flect_type_self_d( self );
    }
    {
        bcore_self_s* self = bcore_self_s_build_parse_sc( "test_mul = bclos_closure {}", 0, 0 );
