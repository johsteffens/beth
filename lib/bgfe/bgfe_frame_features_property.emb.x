...
feature er_t set_stretch           ( m@* o, bl_t flag  ) = 0; // stretches all elements to fill expanded space
feature er_t set_stretch_last      ( m@* o, bl_t flag  ) = 0; // stretches the last element to fill expanded space
feature er_t set_stretch_first     ( m@* o, bl_t flag  ) = 0; // stretches the first element to fill expanded space
...
feature er_t set_glimpse_chars    ( m@* o, sz_t value           ) = 0; // number of characters displayed in glimpse
