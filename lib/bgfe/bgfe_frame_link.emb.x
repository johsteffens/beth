...
func (:s) gboolean rtt_button_main_signal_button_press_event( m GtkWidget* drw, GdkEventButton* event, m@* o )
{
    if( verbatim_C{ event->button == 1 } )
    {
        o.mutex.lock();
        o.rts_main_pressed = true;
        o.mutex.unlock();
    }
    = FALSE;
}
...
func (:s) er_t set_text( m@* o, sc_t text, bl_t force )
{
    if( !force )
    {
...
func (:s) er_t set_text_from_client_status( m@* o, bl_t force )
{
    m$* text = st_s!^;
...
func (:s) er_t rebuild( m@* o )
{
    ...
    if( o.client.o )
    {
        ...
        o.client_edit_frame_type( o.client.o, o.client.type(), o.client_name, action_type.1, frame_type.1 );
    ...
    o.set_text_from_client_status( true );
    = 0;
}
...
func (:s) er_t rtt_rebuild( m@* o, vd_t unused )
{
    ...
    if( o.clearable )
    {
        ...
        gtk_widget_set_name( o.rtt_button_clear, "bgfe_button_compact" );
...
func (:s) client_distraction
{
    ...
    if( o.embedded_frame )
    {
        o.embedded_frame.client_distraction( initiator, action_type );
    }
    else if( o.window    )
    {
        o.window.client_distraction( initiator, action_type );
    }

    if( o.type_dialog )
    {
        o.type_dialog.client_distraction( initiator, action_type );
    }
...
func (:s) bgfe_notify_receiver.notify_receive
{
    if( o.is_open )
    {
        if( notify_type == change_confirm~ ) o.set_text_from_client_status( false );
    }
    = 0;
}
...
func (:s) bgfe_frame.cycle
{
    ...
    bl_t main_pressed = o.rts_main_pressed;
    bl_t clear_clicked = o.rts_clear_clicked;
    o.rts_main_clicked = false;
    o.rts_main_pressed = false;
    o.rts_clear_clicked = false;
    o.mutex.unlock();

    if( main_pressed )
    {
        o.ignore_clicked_once = ( o.window != NULL && o.window.is_open && o.window.is_fleeting ) || ( o.type_dialog != NULL && o.type_dialog.is_open() );
    }

    if( main_clicked )
    {
        if( o.ignore_clicked_once )
        {
            o.ignore_clicked_once = false;
            main_clicked = false;
        }
    }

    bl_t link_changed = false;
    if( main_clicked || o.type_dialog )
    {
        if( o.type_dialog )
        {
            if( main_clicked )
            ...
            else
            {
                ...
                if( !o.type_dialog.is_open() )
                {
                    if( o.type_dialog.apply() )
                    {
                        ...
                        if
                        (
                            ( x_stamp_t_is_stamp( type ) && x_stamp_t_is_aware( type ) )
                             && ( o.allow_custom_type || ( o.type_list && o.type_list.exists( type ) ) )
                        )
                        {
                            if( x_inst_is_creatable( type ) )
                            {
                                o.client.tsm( type, x_inst_t_create( type ) );
                            }
                            else
                            {
...
func (:s) bgfe_frame.upsync
{
    ...
    else
    {
        ...
        o.set_text_from_client_status( false );
    }
...
group :type_dialog
{
    ...
    stamp :s
    {
        ...
        func er_t update_status( m@* o )
        {
            ...
            {
                o.status = ( o.parent.type_list && o.parent.type_list.exists( type ) ) ? "VALID" : "invalid";
            }
            = 0;
        }
        ...
        {
            o.text.copy_sc( bnameof( item.case_tp ) );
            o.update_status();
            o.window.upsync();
            = 0;
        }
        ...
        func bgfe_client.bgfe_edit_frame
        {
            if( content == (vd_t)o )
            {
                ...
                {
                    frame.set_manual_content( true );
                    frame.add_content_t( o.prompt, sc_t~, 0 );
                    ...
                    if( o.choice )
                    {
                        f.add_content( o.choice, 0 );
                    }
                    frame.add_frame( f );

                    frame.add_content_t( o.status, sc_t~, 0 );
                    frame.add_content( o.buttons, 0 );
        ...
        {
            if( o.window ) o.window.client_distraction( initiator, action_type );
            = 0;
        }

        func er_t open( m@* o, m bgfe_frame_link_s* parent )
        {
            o.reset();
            if( parent.type_list )
            {
        ...
        func er_t close( m@* o )
        {
            if( o.window && o.window.is_open() ) o.window.close();
            o.window =< NULL;
            o.choice =< NULL;
            = 0;
        }

        func bl_t is_open( m@* o )
        {
            = ( o.window && o.window.is_open && !o.exit() );
        }
