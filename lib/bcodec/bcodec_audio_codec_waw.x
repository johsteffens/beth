...
group :param
{
    ...
    stamp :s
    {
        ...
        func bcodec_audio_codec_param.frames_per_slice = o.frames >> 1;
        func bcodec_audio_codec_param.frames_per_page = o.frames_per_slice() * o.slices_per_page;
        ...
        func bcodec_audio_codec_param.get_channels = o.channels;
    }
    ...
    func (:s) bcodec_audio_codec_param.setup
    {
        if( o.is_setup ) = o;
        o.is_setup = true;
...
group :page bcodec_audio_codec_page
{
    ...
    func (:stage10_s) bcodec_audio_codec_page.encode
    {
    ...
    func (:stage10_s) bcodec_audio_codec_page.decode
    {
        ASSERT( param.is_setup );
        sz_t half_frames = param.frames >> 1;
    ...
    func (:stage20_s) bcodec_audio_codec_page.encode
    {
        ASSERT( param.is_setup );
    ...
    func (:stage20_s) bcodec_audio_codec_page.decode
    {
        ASSERT( param.is_setup );
    ...
    func (:stage30_s) bcodec_audio_codec_page.encode
    {
        ASSERT( param.is_setup );
    ...
    func (:stage30_s) bcodec_audio_codec_page.decode
    {
        ASSERT( param.is_setup );
        :stage20_s^ prev;
...
stamp :sequence_s x_array
{
    ...
    func bcodec_audio_codec_sequence.total_frames = o.total_frames;
    func bcodec_audio_codec_sequence.param = o.param;
...
stamp :encoder_s bcodec_audio_codec_encoder
{
    ...
    func bcodec_audio_codec_encoder.set_param o.reset().param =< param.clone();
    func bcodec_audio_codec_encoder.push_d = o.setup().push_buffer_d( buffer ).encode( false );
    func bcodec_audio_codec_encoder.push_c = o.push_d( buffer.clone() );
    func m :sequence_s* m_get_sequence( m@* o ) = o.finish().sequence;
    func c :sequence_s* c_get_sequence( m@* o ) = o.m_get_sequence();
    func bcodec_audio_codec_encoder.d_get_sequence
    {
        d :sequence_s* sequence = o.m_get_sequence().fork();
        o.sequence =< NULL;
        = sequence;
    }
    func bcodec_audio_codec_encoder.get_context = o.context;
};
...
stamp :decoder_s bcodec_audio_codec_decoder
{
    :param_s => param;
    ...
    func bcodec_audio_codec_decoder.set_sequence_d { o.reset().sequence =< sequence; o.setup().decode(); }
    func bcodec_audio_codec_decoder.eos = ( !o.sequence_buf || o.sequence_buf.size() == 0 );
    func bcodec_audio_codec_decoder.d_get_buffer = o.setup().decode().pop_first_buffer();
    func bcodec_audio_codec_decoder.get_context = o.context;
}
