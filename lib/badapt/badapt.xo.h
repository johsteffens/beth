...
#ifndef __badapt_xo_H
#define __badapt_xo_H

#include "bcore_control.h"

//To force a rebuild of this target by xoico, reset the hash key value below to 0.
#define HKEYOF_badapt_xo 0x667F2787DC3CB20Full

#define TYPEOF_badapt_xo 0xA8DD6C27EBCCA245ull
...
#define TYPEOF_badapt_dynamics_spect_s 0xFB196E3CAE5D5BC2ull
...
#define BETH_EXPAND_GROUP_badapt_dynamics \
  ...
  XOILA_DECLARE_SPECT( badapt_dynamics ) \
  { \
      bcore_spect_header_s header; \
      badapt_dynamics_weights_adapt weights_adapt; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( badapt_dynamics ) \
  static inline void badapt_dynamics_a_weights_adapt( const badapt_dynamics* o, const bmath_vf3_s* in, bmath_mf3_s* w, const bmath_vf3_s* grad_out, f3_t epsilon_factor ){ const badapt_dynamics_spect_s* p = badapt_dynamics_spect_s_get_aware( o ); assert( p->weights_adapt ); p->weights_adapt( o, in, w, grad_out, epsilon_factor );} \
...
#define TYPEOF_badapt_adaptive_spect_s 0xE3EF031CE5A573E2ull
#define BETH_EXPAND_GROUP_badapt_adaptive \
  ...
  XOILA_DECLARE_SPECT( badapt_adaptive ) \
  { \
      bcore_spect_header_s header; \
  ...
  static inline sz_t badapt_adaptive_a_get_in_size( const badapt_adaptive* o ){ const badapt_adaptive_spect_s* p = badapt_adaptive_spect_s_get_aware( o ); assert( p->get_in_size ); return p->get_in_size( o );} \
  static inline bl_t badapt_adaptive_a_defines_get_in_size( const badapt_adaptive* o ){ return  true;} \
  static inline sz_t badapt_adaptive_a_get_out_size( const badapt_adaptive* o ){ const badapt_adaptive_spect_s* p = badapt_adaptive_spect_s_get_aware( o ); assert( p->get_out_size ); return p->get_out_size( o );} \
  static inline bl_t badapt_adaptive_a_defines_get_out_size( const badapt_adaptive* o ){ return  true;} \
  static inline void badapt_adaptive_a_infer( const badapt_adaptive* o, const bmath_vf3_s* in, bmath_vf3_s* out ){ const badapt_adaptive_spect_s* p = badapt_adaptive_spect_s_get_aware( o ); assert( p->infer ); p->infer( o, in, out );} \
  static inline bl_t badapt_adaptive_a_defines_infer( const badapt_adaptive* o ){ return  badapt_adaptive_spect_s_get_aware( o )->infer != NULL;} \
  static inline void badapt_adaptive_a_minfer( badapt_adaptive* o, const bmath_vf3_s* in, bmath_vf3_s* out ){ const badapt_adaptive_spect_s* p = badapt_adaptive_spect_s_get_aware( o ); assert( p->minfer ); p->minfer( o, in, out );} \
  static inline bl_t badapt_adaptive_a_defines_minfer( const badapt_adaptive* o ){ return  true;} \
  static inline void badapt_adaptive_a_bgrad( const badapt_adaptive* o, bmath_vf3_s* grad_in, const bmath_vf3_s* grad_out ){ const badapt_adaptive_spect_s* p = badapt_adaptive_spect_s_get_aware( o ); assert( p->bgrad ); p->bgrad( o, grad_in, grad_out );} \
  static inline bl_t badapt_adaptive_a_defines_bgrad( const badapt_adaptive* o ){ return  badapt_adaptive_spect_s_get_aware( o )->bgrad != NULL;} \
  static inline void badapt_adaptive_a_bgrad_adapt( badapt_adaptive* o, bmath_vf3_s* grad_in, const bmath_vf3_s* grad_out ){ const badapt_adaptive_spect_s* p = badapt_adaptive_spect_s_get_aware( o ); assert( p->bgrad_adapt ); p->bgrad_adapt( o, grad_in, grad_out );} \
  static inline bl_t badapt_adaptive_a_defines_bgrad_adapt( const badapt_adaptive* o ){ return  true;} \
  static inline void badapt_adaptive_a_reset( badapt_adaptive* o ){ const badapt_adaptive_spect_s* p = badapt_adaptive_spect_s_get_aware( o ); assert( p->reset ); p->reset( o );} \
  static inline bl_t badapt_adaptive_a_defines_reset( const badapt_adaptive* o ){ return  badapt_adaptive_spect_s_get_aware( o )->reset != NULL;} \
  static inline void badapt_adaptive_a_get_weights_min_max( const badapt_adaptive* o, f3_t* min, f3_t* max ){ const badapt_adaptive_spect_s* p = badapt_adaptive_spect_s_get_aware( o ); assert( p->get_weights_min_max ); p->get_weights_min_max( o, min, max );} \
  static inline bl_t badapt_adaptive_a_defines_get_weights_min_max( const badapt_adaptive* o ){ return  badapt_adaptive_spect_s_get_aware( o )->get_weights_min_max != NULL;} \
  static inline void badapt_adaptive_a_get_dynamics_std( const badapt_adaptive* o, badapt_dynamics_std_s* dynamics ){ const badapt_adaptive_spect_s* p = badapt_adaptive_spect_s_get_aware( o ); assert( p->get_dynamics_std ); p->get_dynamics_std( o, dynamics );} \
  static inline bl_t badapt_adaptive_a_defines_get_dynamics_std( const badapt_adaptive* o ){ return  badapt_adaptive_spect_s_get_aware( o )->get_dynamics_std != NULL;} \
  static inline void badapt_adaptive_a_set_dynamics_std( badapt_adaptive* o, const badapt_dynamics_std_s* dynamics ){ const badapt_adaptive_spect_s* p = badapt_adaptive_spect_s_get_aware( o ); assert( p->set_dynamics_std ); p->set_dynamics_std( o, dynamics );} \
  static inline bl_t badapt_adaptive_a_defines_set_dynamics_std( const badapt_adaptive* o ){ return  badapt_adaptive_spect_s_get_aware( o )->set_dynamics_std != NULL;} \
  static inline void badapt_adaptive_a_arc_to_sink( const badapt_adaptive* o, bcore_sink* sink ){ const badapt_adaptive_spect_s* p = badapt_adaptive_spect_s_get_aware( o ); assert( p->arc_to_sink ); p->arc_to_sink( o, sink );} \
  static inline bl_t badapt_adaptive_a_defines_arc_to_sink( const badapt_adaptive* o ){ return  true;} \
  static inline void badapt_adaptive_arc_to_sink_default( const badapt_adaptive* o, bcore_sink* sink ){ bcore_txt_ml_a_to_sink( o, sink );} \
  static inline f3_t badapt_adaptive_a_infer_f3( const badapt_adaptive* o, const bmath_vf3_s* in ){ const badapt_adaptive_spect_s* p = badapt_adaptive_spect_s_get_aware( o ); assert( p->infer_f3 ); return p->infer_f3( o, in );} \
  static inline bl_t badapt_adaptive_a_defines_infer_f3( const badapt_adaptive* o ){ return  true;} \
  f3_t badapt_adaptive_infer_f3_default( const badapt_adaptive* o, const bmath_vf3_s* in ); \
  static inline void badapt_adaptive_a_adapt_loss( badapt_adaptive* o, const badapt_loss* loss, const bmath_vf3_s* in, const bmath_vf3_s* target, bmath_vf3_s* out ){ const badapt_adaptive_spect_s* p = badapt_adaptive_spect_s_get_aware( o ); assert( p->adapt_loss ); p->adapt_loss( o, loss, in, target, out );} \
  static inline bl_t badapt_adaptive_a_defines_adapt_loss( const badapt_adaptive* o ){ return  true;} \
  void badapt_adaptive_adapt_loss_default( badapt_adaptive* o, const badapt_loss* loss, const bmath_vf3_s* in, const bmath_vf3_s* target, bmath_vf3_s* out ); \
  static inline f3_t badapt_adaptive_a_adapt_loss_f3( badapt_adaptive* o, const badapt_loss* loss, const bmath_vf3_s* in, f3_t target ){ const badapt_adaptive_spect_s* p = badapt_adaptive_spect_s_get_aware( o ); assert( p->adapt_loss_f3 ); return p->adapt_loss_f3( o, loss, in, target );} \
  static inline bl_t badapt_adaptive_a_defines_adapt_loss_f3( const badapt_adaptive* o ){ return  true;} \
  f3_t badapt_adaptive_adapt_loss_f3_default( badapt_adaptive* o, const badapt_loss* loss, const bmath_vf3_s* in, f3_t target );

//----------------------------------------------------------------------------------------------------------------------
// group: badapt_builder

#define TYPEOF_badapt_builder 0x93A45464E95C3C37ull
#define TYPEOF_badapt_builder_spect_s 0xEF301D62AC664C67ull
#define BETH_EXPAND_GROUP_badapt_builder \
  ...
  XOILA_DECLARE_SPECT( badapt_builder ) \
  { \
      bcore_spect_header_s header; \
  ...
  static inline sz_t badapt_builder_a_get_in_size( const badapt_builder* o ){ const badapt_builder_spect_s* p = badapt_builder_spect_s_get_aware( o ); assert( p->get_in_size ); return p->get_in_size( o );} \
  static inline bl_t badapt_builder_a_defines_get_in_size( const badapt_builder* o ){ return  true;} \
  static inline void badapt_builder_a_set_in_size( badapt_builder* o, sz_t size ){ const badapt_builder_spect_s* p = badapt_builder_spect_s_get_aware( o ); assert( p->set_in_size ); p->set_in_size( o, size );} \
  static inline bl_t badapt_builder_a_defines_set_in_size( const badapt_builder* o ){ return  true;} \
  static inline sz_t badapt_builder_a_get_out_size( const badapt_builder* o ){ const badapt_builder_spect_s* p = badapt_builder_spect_s_get_aware( o ); assert( p->get_out_size ); return p->get_out_size( o );} \
  static inline bl_t badapt_builder_a_defines_get_out_size( const badapt_builder* o ){ return  true;} \
  static inline void badapt_builder_a_set_out_size( badapt_builder* o, sz_t size ){ const badapt_builder_spect_s* p = badapt_builder_spect_s_get_aware( o ); assert( p->set_out_size ); p->set_out_size( o, size );} \
  static inline bl_t badapt_builder_a_defines_set_out_size( const badapt_builder* o ){ return  true;} \
  static inline badapt_adaptive* badapt_builder_a_build( const badapt_builder* o ){ const badapt_builder_spect_s* p = badapt_builder_spect_s_get_aware( o ); assert( p->build ); return p->build( o );} \
...
#define TYPEOF_badapt_problem_spect_s 0x07ADC938F9875167ull
...
#define BETH_EXPAND_ITEM_badapt_problem_sine_random_s \
  ...
  { \
      ...
      f3_t pos_tgt; \
      f3_t neg_tgt; \
      badapt_loss* preferred_loss; \
  }; \
  static inline const badapt_loss* badapt_problem_sine_random_s_preferred_loss( const badapt_problem_sine_random_s* o ); \
  static inline sz_t badapt_problem_sine_random_s_get_in_size( const badapt_problem_sine_random_s* o ); \
  static inline sz_t badapt_problem_sine_random_s_get_out_size( const badapt_problem_sine_random_s* o ); \
...
#define BETH_EXPAND_ITEM_badapt_problem_binary_add_s \
  ...
  static inline const badapt_loss* badapt_problem_binary_add_s_preferred_loss( const badapt_problem_binary_add_s* o ); \
  static inline sz_t badapt_problem_binary_add_s_get_in_size( const badapt_problem_binary_add_s* o ); \
  static inline sz_t badapt_problem_binary_add_s_get_out_size( const badapt_problem_binary_add_s* o ); \
...
#define BETH_EXPAND_ITEM_badapt_problem_binary_mul_s \
  ...
  static inline const badapt_loss* badapt_problem_binary_mul_s_preferred_loss( const badapt_problem_binary_mul_s* o ); \
  static inline sz_t badapt_problem_binary_mul_s_get_in_size( const badapt_problem_binary_mul_s* o ); \
  static inline sz_t badapt_problem_binary_mul_s_get_out_size( const badapt_problem_binary_mul_s* o ); \
...
#define BETH_EXPAND_ITEM_badapt_problem_binary_xsg3_s \
  ...
  static inline const badapt_loss* badapt_problem_binary_xsg3_s_preferred_loss( const badapt_problem_binary_xsg3_s* o ); \
  static inline sz_t badapt_problem_binary_xsg3_s_get_in_size( const badapt_problem_binary_xsg3_s* o ); \
  static inline sz_t badapt_problem_binary_xsg3_s_get_out_size( const badapt_problem_binary_xsg3_s* o ); \
...
#define BETH_EXPAND_ITEM_badapt_problem_binary_hash_s \
  ...
  static inline const badapt_loss* badapt_problem_binary_hash_s_preferred_loss( const badapt_problem_binary_hash_s* o ); \
  static inline sz_t badapt_problem_binary_hash_s_get_in_size( const badapt_problem_binary_hash_s* o ); \
  static inline sz_t badapt_problem_binary_hash_s_get_out_size( const badapt_problem_binary_hash_s* o ); \
...
#define BETH_EXPAND_ITEM_badapt_problem_polynom_s \
  ...
  static inline const badapt_loss* badapt_problem_polynom_s_preferred_loss( const badapt_problem_polynom_s* o ); \
  static inline sz_t badapt_problem_polynom_s_get_in_size( const badapt_problem_polynom_s* o ); \
  static inline sz_t badapt_problem_polynom_s_get_out_size( const badapt_problem_polynom_s* o ); \
...
#define BETH_EXPAND_GROUP_badapt_problem \
  ...
  XOILA_DECLARE_SPECT( badapt_problem ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( badapt_problem ) \
...
#define TYPEOF_badapt_activation_spect_s 0x34980A18254E6C88ull
...
#define BETH_EXPAND_ITEM_badapt_activation_zero_s \
  ...
  static inline f3_t badapt_activation_zero_s_fx( const badapt_activation_zero_s* o, f3_t x ); \
  static inline f3_t badapt_activation_zero_s_dy( const badapt_activation_zero_s* o, f3_t y ); \
...
#define BETH_EXPAND_ITEM_badapt_activation_one_s \
  ...
  static inline f3_t badapt_activation_one_s_fx( const badapt_activation_one_s* o, f3_t x ); \
  static inline f3_t badapt_activation_one_s_dy( const badapt_activation_one_s* o, f3_t y ); \
...
#define BETH_EXPAND_ITEM_badapt_activation_linear_s \
  ...
  static inline f3_t badapt_activation_linear_s_fx( const badapt_activation_linear_s* o, f3_t x ); \
  static inline f3_t badapt_activation_linear_s_dy( const badapt_activation_linear_s* o, f3_t y ); \
...
#define BETH_EXPAND_ITEM_badapt_activation_sigm_s \
  ...
  static inline f3_t badapt_activation_sigm_s_fx( const badapt_activation_sigm_s* o, f3_t x ); \
  static inline f3_t badapt_activation_sigm_s_dy( const badapt_activation_sigm_s* o, f3_t y ); \
...
#define BETH_EXPAND_ITEM_badapt_activation_sigm_hard_s \
  ...
  static inline f3_t badapt_activation_sigm_hard_s_fx( const badapt_activation_sigm_hard_s* o, f3_t x ); \
  static inline f3_t badapt_activation_sigm_hard_s_dy( const badapt_activation_sigm_hard_s* o, f3_t y ); \
...
#define BETH_EXPAND_ITEM_badapt_activation_sigm_leaky_s \
  ...
  static inline f3_t badapt_activation_sigm_leaky_s_fx( const badapt_activation_sigm_leaky_s* o, f3_t x ); \
  static inline f3_t badapt_activation_sigm_leaky_s_dy( const badapt_activation_sigm_leaky_s* o, f3_t y ); \
...
#define BETH_EXPAND_ITEM_badapt_activation_tanh_s \
  ...
  static inline f3_t badapt_activation_tanh_s_fx( const badapt_activation_tanh_s* o, f3_t x ); \
  static inline f3_t badapt_activation_tanh_s_dy( const badapt_activation_tanh_s* o, f3_t y ); \
...
#define BETH_EXPAND_ITEM_badapt_activation_tanh_hard_s \
  ...
  static inline f3_t badapt_activation_tanh_hard_s_fx( const badapt_activation_tanh_hard_s* o, f3_t x ); \
  static inline f3_t badapt_activation_tanh_hard_s_dy( const badapt_activation_tanh_hard_s* o, f3_t y ); \
...
#define BETH_EXPAND_ITEM_badapt_activation_tanh_leaky_s \
  ...
  static inline f3_t badapt_activation_tanh_leaky_s_fx( const badapt_activation_tanh_leaky_s* o, f3_t x ); \
  static inline f3_t badapt_activation_tanh_leaky_s_dy( const badapt_activation_tanh_leaky_s* o, f3_t y ); \
...
#define BETH_EXPAND_ITEM_badapt_activation_softplus_s \
  ...
  static inline f3_t badapt_activation_softplus_s_fx( const badapt_activation_softplus_s* o, f3_t x ); \
  static inline f3_t badapt_activation_softplus_s_dy( const badapt_activation_softplus_s* o, f3_t y ); \
...
#define BETH_EXPAND_ITEM_badapt_activation_relu_s \
  ...
  static inline f3_t badapt_activation_relu_s_fx( const badapt_activation_relu_s* o, f3_t x ); \
  static inline f3_t badapt_activation_relu_s_dy( const badapt_activation_relu_s* o, f3_t y ); \
...
#define BETH_EXPAND_ITEM_badapt_activation_leaky_relu_s \
  ...
  static inline f3_t badapt_activation_leaky_relu_s_fx( const badapt_activation_leaky_relu_s* o, f3_t x ); \
  static inline f3_t badapt_activation_leaky_relu_s_dy( const badapt_activation_leaky_relu_s* o, f3_t y ); \
...
#define BETH_EXPAND_GROUP_badapt_activation \
  ...
  XOILA_DECLARE_SPECT( badapt_activation ) \
  { \
      bcore_spect_header_s header; \
  ...
  static inline f3_t badapt_activation_a_fx( const badapt_activation* o, f3_t x ){ const badapt_activation_spect_s* p = badapt_activation_spect_s_get_aware( o ); assert( p->fx ); return p->fx( o, x );} \
  static inline bl_t badapt_activation_a_defines_fx( const badapt_activation* o ){ return  true;} \
  static inline f3_t badapt_activation_p_fx( const badapt_activation_spect_s* p, const badapt_activation* o, f3_t x ){ assert( p->fx ); return p->fx( o, x );} \
  static inline bl_t badapt_activation_p_defines_fx( const badapt_activation_spect_s* p ){ return  true;} \
  static inline f3_t badapt_activation_a_dy( const badapt_activation* o, f3_t y ){ const badapt_activation_spect_s* p = badapt_activation_spect_s_get_aware( o ); assert( p->dy ); return p->dy( o, y );} \
  static inline bl_t badapt_activation_a_defines_dy( const badapt_activation* o ){ return  true;} \
  static inline f3_t badapt_activation_p_dy( const badapt_activation_spect_s* p, const badapt_activation* o, f3_t y ){ assert( p->dy ); return p->dy( o, y );} \
  static inline bl_t badapt_activation_p_defines_dy( const badapt_activation_spect_s* p ){ return  true;} \
...
#define TYPEOF_badapt_activator_spect_s 0x335FB697159D7283ull
...
#define BETH_EXPAND_ITEM_badapt_activator_plain_s \
  ...
  static inline void badapt_activator_plain_s_set_activation( badapt_activator_plain_s* o, const badapt_activation* activation ); \
  static inline const badapt_activation* badapt_activator_plain_s_get_activation( const badapt_activator_plain_s* o ); \
...
#define BETH_EXPAND_ITEM_badapt_arr_layer_activator_s \
  ...
  { \
      aware_t _; \
      BCORE_ARRAY_DYN_SOLID_STATIC_S( badapt_layer_activator_s, arr_ ); \
  }; \
...
#define BETH_EXPAND_ITEM_badapt_arr_activator_s \
  ...
  { \
      aware_t _; \
      BCORE_ARRAY_DYN_LINK_STATIC_S( badapt_activator, arr_ ); \
  }; \
...
#define BETH_EXPAND_GROUP_badapt_activator \
  ...
  XOILA_DECLARE_SPECT( badapt_activator ) \
  { \
      bcore_spect_header_s header; \
  ...
  static inline const badapt_activation* badapt_activator_a_get_activation( const badapt_activator* o ){ const badapt_activator_spect_s* p = badapt_activator_spect_s_get_aware( o ); assert( p->get_activation ); return p->get_activation( o );} \
  static inline bl_t badapt_activator_a_defines_get_activation( const badapt_activator* o ){ return  true;} \
  static inline const badapt_activation* badapt_activator_get_activation_default( const badapt_activator* o ){ return  NULL;} \
  static inline void badapt_activator_a_set_activation( badapt_activator* o, const badapt_activation* activation ){ const badapt_activator_spect_s* p = badapt_activator_spect_s_get_aware( o ); assert( p->set_activation ); p->set_activation( o, activation );} \
  static inline bl_t badapt_activator_a_defines_set_activation( const badapt_activator* o ){ return  true;} \
  static inline void badapt_activator_set_activation_default( badapt_activator* o, const badapt_activation* activation ){} \
  static inline void badapt_activator_a_infer( const badapt_activator* o, const bmath_vf3_s* in, bmath_vf3_s* out ){ const badapt_activator_spect_s* p = badapt_activator_spect_s_get_aware( o ); assert( p->infer ); p->infer( o, in, out );} \
  static inline bl_t badapt_activator_a_defines_infer( const badapt_activator* o ){ return  true;} \
  static inline void badapt_activator_a_bgrad( const badapt_activator* o, bmath_vf3_s* grad_in, const bmath_vf3_s* grad_out, const bmath_vf3_s* out ){ const badapt_activator_spect_s* p = badapt_activator_spect_s_get_aware( o ); assert( p->bgrad ); p->bgrad( o, grad_in, grad_out, out );} \
...
#define TYPEOF_badapt_loss_spect_s 0x8E402430347AF3DFull
...
#define BETH_EXPAND_ITEM_badapt_loss_l2_s \
  ...
  static inline f3_t badapt_loss_l2_s_loss( const badapt_loss_l2_s* o, const bmath_vf3_s* out, const bmath_vf3_s* target ); \
  static inline f3_t badapt_loss_l2_s_loss_f3( const badapt_loss_l2_s* o, f3_t out, f3_t target ); \
  static inline void badapt_loss_l2_s_bgrad( const badapt_loss_l2_s* o, const bmath_vf3_s* out, const bmath_vf3_s* target, bmath_vf3_s* grad ); \
...
#define BETH_EXPAND_GROUP_badapt_loss \
  ...
  XOILA_DECLARE_SPECT( badapt_loss ) \
  { \
      bcore_spect_header_s header; \
  ...
  static inline f3_t badapt_loss_a_loss( const badapt_loss* o, const bmath_vf3_s* out, const bmath_vf3_s* target ){ const badapt_loss_spect_s* p = badapt_loss_spect_s_get_aware( o ); assert( p->loss ); return p->loss( o, out, target );} \
  static inline bl_t badapt_loss_a_defines_loss( const badapt_loss* o ){ return  true;} \
  static inline f3_t badapt_loss_p_loss( const badapt_loss_spect_s* p, const badapt_loss* o, const bmath_vf3_s* out, const bmath_vf3_s* target ){ assert( p->loss ); return p->loss( o, out, target );} \
  static inline bl_t badapt_loss_p_defines_loss( const badapt_loss_spect_s* p ){ return  true;} \
  static inline f3_t badapt_loss_a_loss_f3( const badapt_loss* o, f3_t out, f3_t target ){ const badapt_loss_spect_s* p = badapt_loss_spect_s_get_aware( o ); assert( p->loss_f3 ); return p->loss_f3( o, out, target );} \
  static inline bl_t badapt_loss_a_defines_loss_f3( const badapt_loss* o ){ return  true;} \
  static inline f3_t badapt_loss_p_loss_f3( const badapt_loss_spect_s* p, const badapt_loss* o, f3_t out, f3_t target ){ assert( p->loss_f3 ); return p->loss_f3( o, out, target );} \
  static inline bl_t badapt_loss_p_defines_loss_f3( const badapt_loss_spect_s* p ){ return  true;} \
  static inline void badapt_loss_a_bgrad( const badapt_loss* o, const bmath_vf3_s* out, const bmath_vf3_s* target, bmath_vf3_s* grad ){ const badapt_loss_spect_s* p = badapt_loss_spect_s_get_aware( o ); assert( p->bgrad ); p->bgrad( o, out, target, grad );} \
  static inline bl_t badapt_loss_a_defines_bgrad( const badapt_loss* o ){ return  true;} \
  static inline void badapt_loss_p_bgrad( const badapt_loss_spect_s* p, const badapt_loss* o, const bmath_vf3_s* out, const bmath_vf3_s* target, bmath_vf3_s* grad ){ assert( p->bgrad ); p->bgrad( o, out, target, grad );} \
  static inline bl_t badapt_loss_p_defines_bgrad( const badapt_loss_spect_s* p ){ return  true;} \
...
#define TYPEOF_badapt_mlp_spect_s 0x66058078ED8DBC63ull
...
#define BETH_EXPAND_ITEM_badapt_mlp_arr_layer_s \
  ...
  { \
      aware_t _; \
      BCORE_ARRAY_DYN_SOLID_STATIC_S( badapt_mlp_layer_s, arr_ ); \
  }; \
...
#define BETH_EXPAND_ITEM_badapt_mlp_s \
  ...
  static inline sz_t badapt_mlp_s_get_in_size( const badapt_mlp_s* o ); \
  static inline sz_t badapt_mlp_s_get_out_size( const badapt_mlp_s* o ); \
  static inline void badapt_mlp_s_get_dynamics_std( const badapt_mlp_s* o, badapt_dynamics_std_s* dynamics ); \
  static inline void badapt_mlp_s_set_dynamics_std( badapt_mlp_s* o, const badapt_dynamics_std_s* dynamics ); \
...
#define BETH_EXPAND_ITEM_badapt_builder_mlp_funnel_s \
  ...
  static inline sz_t badapt_builder_mlp_funnel_s_get_in_size( const badapt_builder_mlp_funnel_s* o ); \
  static inline void badapt_builder_mlp_funnel_s_set_in_size( badapt_builder_mlp_funnel_s* o, sz_t size ); \
  static inline sz_t badapt_builder_mlp_funnel_s_get_out_size( const badapt_builder_mlp_funnel_s* o ); \
  static inline void badapt_builder_mlp_funnel_s_set_out_size( badapt_builder_mlp_funnel_s* o, sz_t size ); \
...
#define BETH_EXPAND_GROUP_badapt_mlp \
  ...
  XOILA_DECLARE_SPECT( badapt_mlp ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( badapt_mlp ) \
...
#define TYPEOF_badapt_c1d_spect_s 0x7947D60F7FAD984Cull
...
#define BETH_EXPAND_ITEM_badapt_c1d_arr_layer_s \
  ...
  { \
      aware_t _; \
      BCORE_ARRAY_DYN_SOLID_STATIC_S( badapt_c1d_layer_s, arr_ ); \
  }; \
...
#define BETH_EXPAND_ITEM_badapt_c1d_s \
  ...
  static inline sz_t badapt_c1d_s_get_in_size( const badapt_c1d_s* o ); \
  static inline sz_t badapt_c1d_s_get_out_size( const badapt_c1d_s* o ); \
  static inline void badapt_c1d_s_get_dynamics_std( const badapt_c1d_s* o, badapt_dynamics_std_s* dynamics ); \
  static inline void badapt_c1d_s_set_dynamics_std( badapt_c1d_s* o, const badapt_dynamics_std_s* dynamics ); \
...
#define BETH_EXPAND_ITEM_badapt_builder_c1d_funnel_s \
  ...
  { \
      ...
      sz_t input_size; \
      sz_t input_step; \
      sz_t input_convolution_size; \
      sz_t input_kernels; \
      sz_t output_kernels; \
      f3_t kernels_rate; \
      sz_t reduction_step; \
      sz_t convolution_size; \
      u2_t random_seed; \
      badapt_dynamics_std_s dynamics; \
      badapt_arr_layer_activator_s arr_layer_activator; \
  }; \
  static inline sz_t badapt_builder_c1d_funnel_s_get_in_size( const badapt_builder_c1d_funnel_s* o ); \
  static inline void badapt_builder_c1d_funnel_s_set_in_size( badapt_builder_c1d_funnel_s* o, sz_t size ); \
  static inline sz_t badapt_builder_c1d_funnel_s_get_out_size( const badapt_builder_c1d_funnel_s* o ); \
  static inline void badapt_builder_c1d_funnel_s_set_out_size( badapt_builder_c1d_funnel_s* o, sz_t size ); \
...
#define BETH_EXPAND_GROUP_badapt_c1d \
  ...
  XOILA_DECLARE_SPECT( badapt_c1d ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( badapt_c1d ) \
...
#define TYPEOF_badapt_ern_spect_s 0xCFDC84B80BD3DABBull
...
#define BETH_EXPAND_ITEM_badapt_ern_arr_layer_s \
  ...
  { \
      aware_t _; \
      BCORE_ARRAY_DYN_LINK_STATIC_S( badapt_ern_layer_s, arr_ ); \
  }; \
...
#define BETH_EXPAND_ITEM_badapt_ern_s \
  ...
  { \
      ...
      bmath_vf3_s b_h; \
      bmath_vf3_s b_o; \
      badapt_activator* a_h; \
      badapt_activator* a_o; \
      bmath_vf3_s v_o; \
      bmath_vf3_s d_v_o; \
      bmath_vf3_s d_v_c; \
      bmath_vf3_s d_v_h; \
      ...
      bmath_mf3_s d_w_hc; \
      bmath_vf3_s d_b_h; \
      badapt_ern_arr_layer_s arr_layer; \
  }; \
  static inline sz_t badapt_ern_s_get_in_size( const badapt_ern_s* o ); \
  static inline sz_t badapt_ern_s_get_out_size( const badapt_ern_s* o ); \
  static inline void badapt_ern_s_get_dynamics_std( const badapt_ern_s* o, badapt_dynamics_std_s* dynamics ); \
  static inline void badapt_ern_s_set_dynamics_std( badapt_ern_s* o, const badapt_dynamics_std_s* dynamics ); \
...
#define BETH_EXPAND_ITEM_badapt_ern_builder_s \
  ...
  static inline sz_t badapt_ern_builder_s_get_in_size( const badapt_ern_builder_s* o ); \
  static inline void badapt_ern_builder_s_set_in_size( badapt_ern_builder_s* o, sz_t size ); \
  static inline sz_t badapt_ern_builder_s_get_out_size( const badapt_ern_builder_s* o ); \
  static inline void badapt_ern_builder_s_set_out_size( badapt_ern_builder_s* o, sz_t size ); \
...
#define BETH_EXPAND_GROUP_badapt_ern \
  ...
  XOILA_DECLARE_SPECT( badapt_ern ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( badapt_ern ) \
...
#define TYPEOF_badapt_lstm_spect_s 0x4BE752FC7E43E706ull
...
#define BETH_EXPAND_ITEM_badapt_lstm_arr_layer_s \
  ...
  { \
      aware_t _; \
      BCORE_ARRAY_DYN_LINK_STATIC_S( badapt_lstm_layer_s, arr_ ); \
  }; \
...
#define BETH_EXPAND_ITEM_badapt_lstm_s \
  ...
  { \
      ...
      bmath_vf3_s b_q; \
      bmath_vf3_s b_r; \
      badapt_activator* a_f; \
      badapt_activator* a_i; \
      badapt_activator* a_o; \
      badapt_activator* a_q; \
      badapt_activator* a_d; \
      badapt_activator* a_r; \
      bmath_vf3_s v_r; \
      bmath_vf3_s d_v_r; \
      bmath_vf3_s d_v_f; \
      bmath_vf3_s d_v_i; \
      ...
      bmath_vf3_s d_b_o; \
      bmath_vf3_s d_b_q; \
      badapt_lstm_arr_layer_s arr_layer; \
  }; \
  static inline sz_t badapt_lstm_s_get_in_size( const badapt_lstm_s* o ); \
  static inline sz_t badapt_lstm_s_get_out_size( const badapt_lstm_s* o ); \
  static inline void badapt_lstm_s_get_dynamics_std( const badapt_lstm_s* o, badapt_dynamics_std_s* dynamics ); \
  static inline void badapt_lstm_s_set_dynamics_std( badapt_lstm_s* o, const badapt_dynamics_std_s* dynamics ); \
...
#define BETH_EXPAND_ITEM_badapt_lstm_builder_s \
  ...
  static inline sz_t badapt_lstm_builder_s_get_in_size( const badapt_lstm_builder_s* o ); \
  static inline void badapt_lstm_builder_s_set_in_size( badapt_lstm_builder_s* o, sz_t size ); \
  static inline sz_t badapt_lstm_builder_s_get_out_size( const badapt_lstm_builder_s* o ); \
  static inline void badapt_lstm_builder_s_set_out_size( badapt_lstm_builder_s* o, sz_t size ); \
...
#define BETH_EXPAND_GROUP_badapt_lstm \
  ...
  XOILA_DECLARE_SPECT( badapt_lstm ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( badapt_lstm ) \
...
#define TYPEOF_badapt_supplier_spect_s 0xB84720458B901778ull
#define BETH_EXPAND_GROUP_badapt_supplier \
  ...
  XOILA_DECLARE_SPECT( badapt_supplier ) \
  { \
      bcore_spect_header_s header; \
  ...
  static inline sz_t badapt_supplier_a_get_in_size( const badapt_supplier* o ){ const badapt_supplier_spect_s* p = badapt_supplier_spect_s_get_aware( o ); assert( p->get_in_size ); return p->get_in_size( o );} \
  static inline bl_t badapt_supplier_a_defines_get_in_size( const badapt_supplier* o ){ return  true;} \
  static inline sz_t badapt_supplier_a_get_out_size( const badapt_supplier* o ){ const badapt_supplier_spect_s* p = badapt_supplier_spect_s_get_aware( o ); assert( p->get_out_size ); return p->get_out_size( o );} \
  static inline bl_t badapt_supplier_a_defines_get_out_size( const badapt_supplier* o ){ return  true;} \
  static inline void badapt_supplier_a_fetch_sample_tin( badapt_supplier* o, bmath_vf3_s* in ){ const badapt_supplier_spect_s* p = badapt_supplier_spect_s_get_aware( o ); assert( p->fetch_sample_tin ); p->fetch_sample_tin( o, in );} \
  static inline bl_t badapt_supplier_a_defines_fetch_sample_tin( const badapt_supplier* o ){ return  badapt_supplier_spect_s_get_aware( o )->fetch_sample_tin != NULL;} \
  static inline void badapt_supplier_a_fetch_sample_tio( badapt_supplier* o, bmath_vf3_s* in, bmath_vf3_s* out ){ const badapt_supplier_spect_s* p = badapt_supplier_spect_s_get_aware( o ); assert( p->fetch_sample_tio ); p->fetch_sample_tio( o, in, out );} \
  static inline bl_t badapt_supplier_a_defines_fetch_sample_tio( const badapt_supplier* o ){ return  badapt_supplier_spect_s_get_aware( o )->fetch_sample_tio != NULL;} \
  static inline void badapt_supplier_a_fetch_sample_vin( badapt_supplier* o, bmath_vf3_s* in ){ const badapt_supplier_spect_s* p = badapt_supplier_spect_s_get_aware( o ); assert( p->fetch_sample_vin ); p->fetch_sample_vin( o, in );} \
  static inline bl_t badapt_supplier_a_defines_fetch_sample_vin( const badapt_supplier* o ){ return  badapt_supplier_spect_s_get_aware( o )->fetch_sample_vin != NULL;} \
  static inline void badapt_supplier_a_fetch_sample_vio( badapt_supplier* o, bmath_vf3_s* in, bmath_vf3_s* out ){ const badapt_supplier_spect_s* p = badapt_supplier_spect_s_get_aware( o ); assert( p->fetch_sample_vio ); p->fetch_sample_vio( o, in, out );} \
  static inline bl_t badapt_supplier_a_defines_fetch_sample_vio( const badapt_supplier* o ){ return  badapt_supplier_spect_s_get_aware( o )->fetch_sample_vio != NULL;} \
  static inline const badapt_loss* badapt_supplier_a_preferred_loss( const badapt_supplier* o ){ const badapt_supplier_spect_s* p = badapt_supplier_spect_s_get_aware( o ); assert( p->preferred_loss ); return p->preferred_loss( o );} \
  static inline bl_t badapt_supplier_a_defines_preferred_loss( const badapt_supplier* o ){ return  badapt_supplier_spect_s_get_aware( o )->preferred_loss != NULL;} \
  static inline void badapt_supplier_a_setup_builder( const badapt_supplier* o, badapt_builder* builder ){ const badapt_supplier_spect_s* p = badapt_supplier_spect_s_get_aware( o ); assert( p->setup_builder ); p->setup_builder( o, builder );} \
...
#define TYPEOF_badapt_guide_spect_s 0x3EFCDC69880B7C60ull
#define BETH_EXPAND_GROUP_badapt_guide \
  ...
  XOILA_DECLARE_SPECT( badapt_guide ) \
  { \
      bcore_spect_header_s header; \
      badapt_guide_callback callback; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( badapt_guide ) \
  static inline bl_t badapt_guide_a_callback( const badapt_guide* o, badapt_training_state* state ){ const badapt_guide_spect_s* p = badapt_guide_spect_s_get_aware( o ); assert( p->callback ); return p->callback( o, state );} \
...
#define TYPEOF_badapt_training_state_spect_s 0x6E6731C11A70F30Cull
#define BETH_EXPAND_GROUP_badapt_training_state \
  ...
  XOILA_DECLARE_SPECT( badapt_training_state ) \
  { \
      bcore_spect_header_s header; \
  ...
  static inline void badapt_training_state_a_set_adaptive( badapt_training_state* o, const badapt_adaptive* adaptive ){ const badapt_training_state_spect_s* p = badapt_training_state_spect_s_get_aware( o ); assert( p->set_adaptive ); p->set_adaptive( o, adaptive );} \
  static inline bl_t badapt_training_state_a_defines_set_adaptive( const badapt_training_state* o ){ return  badapt_training_state_spect_s_get_aware( o )->set_adaptive != NULL;} \
  static inline badapt_adaptive* badapt_training_state_a_get_adaptive( const badapt_training_state* o ){ const badapt_training_state_spect_s* p = badapt_training_state_spect_s_get_aware( o ); assert( p->get_adaptive ); return p->get_adaptive( o );} \
  static inline bl_t badapt_training_state_a_defines_get_adaptive( const badapt_training_state* o ){ return  badapt_training_state_spect_s_get_aware( o )->get_adaptive != NULL;} \
  static inline void badapt_training_state_a_set_supplier( badapt_training_state* o, const badapt_supplier* supplier ){ const badapt_training_state_spect_s* p = badapt_training_state_spect_s_get_aware( o ); assert( p->set_supplier ); p->set_supplier( o, supplier );} \
  static inline bl_t badapt_training_state_a_defines_set_supplier( const badapt_training_state* o ){ return  badapt_training_state_spect_s_get_aware( o )->set_supplier != NULL;} \
  static inline badapt_supplier* badapt_training_state_a_get_supplier( const badapt_training_state* o ){ const badapt_training_state_spect_s* p = badapt_training_state_spect_s_get_aware( o ); assert( p->get_supplier ); return p->get_supplier( o );} \
  static inline bl_t badapt_training_state_a_defines_get_supplier( const badapt_training_state* o ){ return  badapt_training_state_spect_s_get_aware( o )->get_supplier != NULL;} \
  static inline void badapt_training_state_a_set_progress( badapt_training_state* o, const badapt_progress_s* progress ){ const badapt_training_state_spect_s* p = badapt_training_state_spect_s_get_aware( o ); assert( p->set_progress ); p->set_progress( o, progress );} \
  static inline bl_t badapt_training_state_a_defines_set_progress( const badapt_training_state* o ){ return  badapt_training_state_spect_s_get_aware( o )->set_progress != NULL;} \
  static inline badapt_progress_s* badapt_training_state_a_get_progress( const badapt_training_state* o ){ const badapt_training_state_spect_s* p = badapt_training_state_spect_s_get_aware( o ); assert( p->get_progress ); return p->get_progress( o );} \
  static inline bl_t badapt_training_state_a_defines_get_progress( const badapt_training_state* o ){ return  badapt_training_state_spect_s_get_aware( o )->get_progress != NULL;} \
  static inline void badapt_training_state_a_set_guide( badapt_training_state* o, const badapt_guide* guide ){ const badapt_training_state_spect_s* p = badapt_training_state_spect_s_get_aware( o ); assert( p->set_guide ); p->set_guide( o, guide );} \
  static inline bl_t badapt_training_state_a_defines_set_guide( const badapt_training_state* o ){ return  badapt_training_state_spect_s_get_aware( o )->set_guide != NULL;} \
  static inline badapt_guide* badapt_training_state_a_get_guide( const badapt_training_state* o ){ const badapt_training_state_spect_s* p = badapt_training_state_spect_s_get_aware( o ); assert( p->get_guide ); return p->get_guide( o );} \
  static inline bl_t badapt_training_state_a_defines_get_guide( const badapt_training_state* o ){ return  badapt_training_state_spect_s_get_aware( o )->get_guide != NULL;} \
  static inline void badapt_training_state_a_set_backup_path( badapt_training_state* o, sc_t name ){ const badapt_training_state_spect_s* p = badapt_training_state_spect_s_get_aware( o ); assert( p->set_backup_path ); p->set_backup_path( o, name );} \
  static inline bl_t badapt_training_state_a_defines_set_backup_path( const badapt_training_state* o ){ return  badapt_training_state_spect_s_get_aware( o )->set_backup_path != NULL;} \
  static inline sc_t badapt_training_state_a_get_backup_path( const badapt_training_state* o ){ const badapt_training_state_spect_s* p = badapt_training_state_spect_s_get_aware( o ); assert( p->get_backup_path ); return p->get_backup_path( o );} \
  static inline bl_t badapt_training_state_a_defines_get_backup_path( const badapt_training_state* o ){ return  badapt_training_state_spect_s_get_aware( o )->get_backup_path != NULL;} \
  static inline bl_t badapt_training_state_a_backup( const badapt_training_state* o ){ const badapt_training_state_spect_s* p = badapt_training_state_spect_s_get_aware( o ); assert( p->backup ); return p->backup( o );} \
  static inline bl_t badapt_training_state_a_defines_backup( const badapt_training_state* o ){ return  true;} \
  bl_t badapt_training_state_backup_default( const badapt_training_state* o ); \
  static inline bl_t badapt_training_state_a_recover( badapt_training_state* o ){ const badapt_training_state_spect_s* p = badapt_training_state_spect_s_get_aware( o ); assert( p->recover ); return p->recover( o );} \
  static inline bl_t badapt_training_state_a_defines_recover( const badapt_training_state* o ){ return  true;} \
  bl_t badapt_training_state_recover_default( badapt_training_state* o );

//----------------------------------------------------------------------------------------------------------------------
// group: badapt_trainer

#define TYPEOF_badapt_trainer 0x9AFDF67F79326DC5ull
#define TYPEOF_badapt_trainer_spect_s 0x978B7E5E558338E1ull
#define BETH_EXPAND_GROUP_badapt_trainer \
  ...
  XOILA_DECLARE_SPECT( badapt_trainer ) \
  { \
      bcore_spect_header_s header; \
  ...
  static inline void badapt_trainer_a_run( const badapt_trainer* o, badapt_training_state* state ){ const badapt_trainer_spect_s* p = badapt_trainer_spect_s_get_aware( o ); assert( p->run ); p->run( o, state );} \
  static inline bl_t badapt_trainer_a_defines_run( const badapt_trainer* o ){ return  true;} \
  static inline badapt_training_state* badapt_trainer_a_create_state( const badapt_trainer* o ){ const badapt_trainer_spect_s* p = badapt_trainer_spect_s_get_aware( o ); assert( p->create_state ); return p->create_state( o );} \
...
#define TYPEOF_badapt_training_objects_spect_s 0x82B19BFDF519312Dull
...
#define BETH_EXPAND_ITEM_badapt_training_state_std_s \
  ...
  { \
      ...
      badapt_adaptive* adaptive; \
      badapt_supplier* supplier; \
      badapt_guide* guide; \
      st_s backup_file_name; \
  }; \
  static inline void badapt_training_state_std_s_set_adaptive( badapt_training_state_std_s* o, const badapt_adaptive* adaptive ); \
  static inline badapt_adaptive* badapt_training_state_std_s_get_adaptive( const badapt_training_state_std_s* o ); \
  static inline void badapt_training_state_std_s_set_supplier( badapt_training_state_std_s* o, const badapt_supplier* supplier ); \
  static inline badapt_supplier* badapt_training_state_std_s_get_supplier( const badapt_training_state_std_s* o ); \
  static inline void badapt_training_state_std_s_set_progress( badapt_training_state_std_s* o, const badapt_progress_s* progress ); \
  static inline badapt_progress_s* badapt_training_state_std_s_get_progress( const badapt_training_state_std_s* o ); \
  static inline void badapt_training_state_std_s_set_guide( badapt_training_state_std_s* o, const badapt_guide* guide ); \
  static inline badapt_guide* badapt_training_state_std_s_get_guide( const badapt_training_state_std_s* o ); \
  static inline void badapt_training_state_std_s_set_backup_path( badapt_training_state_std_s* o, sc_t name ); \
  static inline sc_t badapt_training_state_std_s_get_backup_path( const badapt_training_state_std_s* o ); \
...
#define BETH_EXPAND_ITEM_badapt_guide_std_s \
  ...
  { \
      aware_t _; \
      f3_t annealing_factor; \
      bcore_sink* log; \
  }; \
  static inline void badapt_guide_std_s_init_x( badapt_guide_std_s* o ); \
...
#define BETH_EXPAND_GROUP_badapt_training_objects \
  ...
  XOILA_DECLARE_SPECT( badapt_training_objects ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( badapt_training_objects ) \
...
#define TYPEOF_badapt_trainer_objects_spect_s 0x4B88C86264E40C86ull
...
#define BETH_EXPAND_ITEM_badapt_trainer_batch_s \
  ...
  { \
      ...
      badapt_loss* loss; \
      sz_t batch_size; \
      sz_t batch_cycles_per_fetch; \
      sz_t fetch_cycles_per_iteration; \
      sz_t valid_size; \
      sz_t max_iterations; \
  }; \
...
#define BETH_EXPAND_ITEM_badapt_arr_sample_batch_s \
  ...
  { \
      aware_t _; \
      BCORE_ARRAY_DYN_SOLID_STATIC_S( badapt_sample_batch_s, arr_ ); \
  }; \
...
#define BETH_EXPAND_GROUP_badapt_trainer_objects \
  ...
  XOILA_DECLARE_SPECT( badapt_trainer_objects ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( badapt_trainer_objects ) \
...
vd_t badapt_xo_signal_handler( const bcore_signal_s* o );

#endif // __badapt_xo_H
// XOILA_OUT_SIGNATURE 0x249EE4AF6D15F5A7ull
