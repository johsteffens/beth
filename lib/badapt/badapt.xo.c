...
XOILA_DEFINE_SPECT( bcore_inst, badapt_dynamics )
"{"
...
XOILA_DEFINE_SPECT( bcore_inst, badapt_adaptive )
"{"
    "bcore_spect_header_s header;"
    ...
    "feature aware badapt_adaptive : arc_to_sink = badapt_adaptive_arc_to_sink_default;"
    "feature aware badapt_adaptive : infer_f3 = badapt_adaptive_infer_f3_default;"
    "feature aware badapt_adaptive : adapt_loss = badapt_adaptive_adapt_loss_default;"
    "feature aware badapt_adaptive : adapt_loss_f3 = badapt_adaptive_adapt_loss_f3_default;"
"}";

f3_t badapt_adaptive_infer_f3_default( const badapt_adaptive* o, const bmath_vf3_s* in )
{
    // badapt_adaptive.h:86:5
...
XOILA_DEFINE_SPECT( bcore_inst, badapt_builder )
"{"
    "bcore_spect_header_s header;"
...
XOILA_DEFINE_SPECT( bcore_inst, badapt_problem )
"{"
    "bcore_spect_header_s header;"
"}";
...
XOILA_DEFINE_SPECT( bcore_inst, badapt_activation )
"{"
    "bcore_spect_header_s header;"
...
XOILA_DEFINE_SPECT( bcore_inst, badapt_activator )
"{"
    "bcore_spect_header_s header;"
    "feature aware badapt_activator : get_activation = badapt_activator_get_activation_default;"
    "feature aware badapt_activator : set_activation = badapt_activator_set_activation_default;"
...
XOILA_DEFINE_SPECT( bcore_inst, badapt_loss )
"{"
    "bcore_spect_header_s header;"
...
XOILA_DEFINE_SPECT( bcore_inst, badapt_mlp )
"{"
    "bcore_spect_header_s header;"
"}";
...
XOILA_DEFINE_SPECT( bcore_inst, badapt_c1d )
"{"
    "bcore_spect_header_s header;"
"}";
...
XOILA_DEFINE_SPECT( bcore_inst, badapt_ern )
"{"
    "bcore_spect_header_s header;"
"}";
...
XOILA_DEFINE_SPECT( bcore_inst, badapt_lstm )
"{"
    "bcore_spect_header_s header;"
"}";
...
XOILA_DEFINE_SPECT( bcore_inst, badapt_supplier )
"{"
    "bcore_spect_header_s header;"
...
XOILA_DEFINE_SPECT( bcore_inst, badapt_guide )
"{"
    "bcore_spect_header_s header;"
...
XOILA_DEFINE_SPECT( bcore_inst, badapt_training_state )
"{"
    "bcore_spect_header_s header;"
    ...
    "feature aware badapt_training_state : backup = badapt_training_state_backup_default;"
    "feature aware badapt_training_state : recover = badapt_training_state_recover_default;"
"}";

bl_t badapt_training_state_backup_default( const badapt_training_state* o )
{
    // badapt_training.h:73:5
...
XOILA_DEFINE_SPECT( bcore_inst, badapt_trainer )
"{"
    "bcore_spect_header_s header;"
...
XOILA_DEFINE_SPECT( bcore_inst, badapt_training_objects )
"{"
    "bcore_spect_header_s header;"
"}";
...
XOILA_DEFINE_SPECT( bcore_inst, badapt_trainer_objects )
"{"
    "bcore_spect_header_s header;"
"}";
...
{
    switch( bcore_signal_s_handle_type( o, typeof( "badapt_xo" ) ) )
    {
        case TYPEOF_init1:
        {
            ...
            XOILA_REGISTER_SPECT( badapt_dynamics );
            ...
            BCORE_REGISTER_FFUNC( badapt_adaptive_arc_to_sink, badapt_adaptive_arc_to_sink_default );
            BCORE_REGISTER_FEATURE( badapt_adaptive_infer_f3 );
            BCORE_REGISTER_FFUNC( badapt_adaptive_infer_f3, badapt_adaptive_infer_f3_default );
            BCORE_REGISTER_FEATURE( badapt_adaptive_adapt_loss );
            BCORE_REGISTER_FFUNC( badapt_adaptive_adapt_loss, badapt_adaptive_adapt_loss_default );
            BCORE_REGISTER_FEATURE( badapt_adaptive_adapt_loss_f3 );
            BCORE_REGISTER_FFUNC( badapt_adaptive_adapt_loss_f3, badapt_adaptive_adapt_loss_f3_default );
            XOILA_REGISTER_SPECT( badapt_adaptive );
            ...
            XOILA_REGISTER_SPECT( badapt_builder );
            ...
            XOILA_REGISTER_SPECT( badapt_problem );
            ...
            XOILA_REGISTER_SPECT( badapt_activation );

            // group: badapt_activator
            BCORE_REGISTER_FEATURE( badapt_activator_get_activation );
            BCORE_REGISTER_FFUNC( badapt_activator_get_activation, badapt_activator_get_activation_default );
            BCORE_REGISTER_FEATURE( badapt_activator_set_activation );
            BCORE_REGISTER_FFUNC( badapt_activator_set_activation, badapt_activator_set_activation_default );
            ...
            XOILA_REGISTER_SPECT( badapt_activator );
            ...
            XOILA_REGISTER_SPECT( badapt_loss );
            ...
            XOILA_REGISTER_SPECT( badapt_mlp );
            ...
            XOILA_REGISTER_SPECT( badapt_c1d );
            ...
            XOILA_REGISTER_SPECT( badapt_ern );
            ...
            XOILA_REGISTER_SPECT( badapt_lstm );
            ...
            XOILA_REGISTER_SPECT( badapt_supplier );

            // group: badapt_guide
            BCORE_REGISTER_FEATURE( badapt_guide_callback );
            XOILA_REGISTER_SPECT( badapt_guide );
            ...
            BCORE_REGISTER_FFUNC( badapt_training_state_backup, badapt_training_state_backup_default );
            BCORE_REGISTER_FEATURE( badapt_training_state_recover );
            BCORE_REGISTER_FFUNC( badapt_training_state_recover, badapt_training_state_recover_default );
            XOILA_REGISTER_SPECT( badapt_training_state );

            // group: badapt_trainer
            BCORE_REGISTER_FEATURE( badapt_trainer_run );
            BCORE_REGISTER_FEATURE( badapt_trainer_create_state );
            XOILA_REGISTER_SPECT( badapt_trainer );
            ...
            XOILA_REGISTER_SPECT( badapt_training_objects );
            ...
            XOILA_REGISTER_SPECT( badapt_trainer_objects );
        }
        break;
...
// XOILA_OUT_SIGNATURE 0x639D7CE253911CABull
