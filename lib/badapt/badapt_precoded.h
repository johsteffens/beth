...
#define BETH_EXPAND_GROUP_badapt_adaptive \
  ...
  static inline void badapt_adaptive_a_get_weights_min_max( const badapt_adaptive* o, f3_t* min, f3_t* max ) { badapt_adaptive_s_get_aware( o )->get_weights_min_max( o, min, max ); } \
...
#define TYPEOF_badapt_activator_s 991795461
  ...
  #define BETH_EXPAND_ITEM_badapt_activator_softmax_s \
    ...
    static inline void badapt_activator_softmax_s_adapt( badapt_activator_softmax_s* o, bmath_vf3_s* grad_in, const bmath_vf3_s* grad_out, const bmath_vf3_s* out, f3_t epsilon ){ badapt_activator_softmax_s_bgrad( o, grad_in, grad_out, out ); } \
    static inline void badapt_activator_softmax_s_adapt_defer( badapt_activator_softmax_s* o, bmath_vf3_s* grad_in, const bmath_vf3_s* grad_out, const bmath_vf3_s* out ){ badapt_activator_softmax_s_bgrad( o, grad_in, grad_out, out ); }
...
#define BETH_EXPAND_GROUP_badapt_activator \
  ...
  static inline void badapt_activator_reset__( badapt_activator* o ) {} \
  ...
  static inline void badapt_activator_setup__( badapt_activator* o ) {} \
  static inline sz_t badapt_activator_a_get_size( const badapt_activator* o ) { return badapt_activator_s_get_aware( o )->get_size( o ); } \
  static inline bl_t badapt_activator_a_defines_get_size( const badapt_activator* o ) { return true; } \
  static inline sz_t badapt_activator_get_size__( const badapt_activator* o ) { return 0; } \
  ...
  static inline bl_t badapt_activator_a_defines_set_size( const badapt_activator* o ) { return true; } \
  static inline void badapt_activator_set_size__( badapt_activator* o, sz_t size ) {} \
  ...
  static inline bl_t badapt_activator_a_defines_adapt_defer( const badapt_activator* o ) { return true; } \
...
#define TYPEOF_badapt_jrn 3557364830
  #define TYPEOF_badapt_jrn_layer_s 3974986334
  #define BETH_EXPAND_ITEM_badapt_jrn_layer_s \
    BCORE_DECLARE_OBJECT( badapt_jrn_layer_s ) \
      {bmath_vf3_s v_x;bmath_vf3_s v_c;bmath_vf3_s v_h;bmath_vf3_s v_o;};
  #define TYPEOF_badapt_jrn_arr_layer_s 1189668010
  #define BETH_EXPAND_ITEM_badapt_jrn_arr_layer_s \
    BCORE_DECLARE_OBJECT( badapt_jrn_arr_layer_s ) \
      {aware_t _;BCORE_ARRAY_DYN_LINK_STATIC_S( badapt_jrn_layer_s, arr_ );}; \
    static inline void badapt_jrn_arr_layer_s_set_space( badapt_jrn_arr_layer_s* o, sz_t size ) { bcore_array_t_set_space( TYPEOF_badapt_jrn_arr_layer_s, ( bcore_array* )o, size ); } \
    static inline void badapt_jrn_arr_layer_s_set_size( badapt_jrn_arr_layer_s* o, sz_t size ) { bcore_array_t_set_size( TYPEOF_badapt_jrn_arr_layer_s, ( bcore_array* )o, size ); } \
    static inline void badapt_jrn_arr_layer_s_clear( badapt_jrn_arr_layer_s* o ) { bcore_array_t_set_space( TYPEOF_badapt_jrn_arr_layer_s, ( bcore_array* )o, 0 ); } \
    static inline void badapt_jrn_arr_layer_s_push_c( badapt_jrn_arr_layer_s* o, const badapt_jrn_layer_s* v ) { bcore_array_t_push( TYPEOF_badapt_jrn_arr_layer_s, ( bcore_array* )o, sr_twc( TYPEOF_badapt_jrn_layer_s, v ) ); } \
    static inline void badapt_jrn_arr_layer_s_push_d( badapt_jrn_arr_layer_s* o,       badapt_jrn_layer_s* v ) { bcore_array_t_push( TYPEOF_badapt_jrn_arr_layer_s, ( bcore_array* )o, sr_tsd( TYPEOF_badapt_jrn_layer_s, v ) ); } \
    static inline badapt_jrn_layer_s* badapt_jrn_arr_layer_s_push( badapt_jrn_arr_layer_s* o ) \
    { \
        bcore_array_t_push( TYPEOF_badapt_jrn_arr_layer_s, ( bcore_array* )o, sr_t_create( TYPEOF_badapt_jrn_layer_s ) ); \
        return bcore_array_t_get_last( TYPEOF_badapt_jrn_arr_layer_s, ( bcore_array* )o ).o; \
    }
  #define TYPEOF_badapt_jrn_s 3863226272
  #define BETH_EXPAND_ITEM_badapt_jrn_s \
    BCORE_DECLARE_OBJECT( badapt_jrn_s ) \
      {aware_t _;sz_t size_input;sz_t size_hidden;sz_t size_output;sz_t size_unfolded;badapt_dynamics_std_s dynamics;bmath_mf3_s w_hx;bmath_mf3_s w_hc;bmath_mf3_s w_oh;badapt_activator* a_h;badapt_activator* a_o;bmath_vf3_s v_go;bmath_vf3_s v_gc;bmath_vf3_s v_gh;bmath_mf3_s gw_hx;bmath_mf3_s gw_hc;bmath_mf3_s gw_oh;badapt_jrn_arr_layer_s arr_layer;}; \
    static inline sz_t badapt_jrn_s_get_in_size( const badapt_jrn_s* o ){ return o->size_input; } \
    static inline sz_t badapt_jrn_s_get_out_size( const badapt_jrn_s* o ){ return o->size_output; } \
    static inline void badapt_jrn_s_get_dynamics_std( const badapt_jrn_s* o, badapt_dynamics_std_s* dynamics ){ badapt_dynamics_std_s_copy( dynamics, &o->dynamics ); } \
    static inline void badapt_jrn_s_set_dynamics_std( badapt_jrn_s* o, const badapt_dynamics_std_s* dynamics ){ badapt_dynamics_std_s_copy( &o->dynamics, dynamics ); } \
  ...
  #define TYPEOF_badapt_jrn_builder_s 2684012268
  #define BETH_EXPAND_ITEM_badapt_jrn_builder_s \
    BCORE_DECLARE_OBJECT( badapt_jrn_builder_s ) \
      {aware_t _;sz_t size_input;sz_t size_hidden;sz_t size_output;sz_t size_unfolded;badapt_dynamics_std_s dynamics;u2_t random_seed;badapt_activator* a_h;badapt_activator* a_o;}; \
    static inline sz_t badapt_jrn_builder_s_get_in_size( const badapt_jrn_builder_s* o ){ return o->size_input; } \
    static inline void badapt_jrn_builder_s_set_in_size( badapt_jrn_builder_s* o, sz_t size ){ o->size_input = size; } \
    static inline sz_t badapt_jrn_builder_s_get_out_size( const badapt_jrn_builder_s* o ){ return o->size_output; } \
    static inline void badapt_jrn_builder_s_set_out_size( badapt_jrn_builder_s* o, sz_t size ){ o->size_output = size; } \
    badapt_adaptive* badapt_jrn_builder_s_build( const badapt_jrn_builder_s* o );
#define BETH_EXPAND_GROUP_badapt_jrn \
  BETH_EXPAND_ITEM_badapt_jrn_layer_s \
  BETH_EXPAND_ITEM_badapt_jrn_arr_layer_s \
  BETH_EXPAND_ITEM_badapt_jrn_s \
  BETH_EXPAND_ITEM_badapt_jrn_builder_s
...
#define BETH_EXPAND_GROUP_badapt_training_state \
  ...
  static inline void badapt_training_state_a_set_adaptive( badapt_training_state* o, const badapt_adaptive* adaptive ) { badapt_training_state_s_get_aware( o )->set_adaptive( o, adaptive ); } \
  ...
  static inline void badapt_training_state_a_set_supplier( badapt_training_state* o, const badapt_supplier* supplier ) { badapt_training_state_s_get_aware( o )->set_supplier( o, supplier ); } \
  ...
  static inline void badapt_training_state_a_set_progress( badapt_training_state* o, const badapt_progress_s* progress ) { badapt_training_state_s_get_aware( o )->set_progress( o, progress ); } \
