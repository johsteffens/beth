...
XOILA_DEFINE_GROUP( bcore_via_call, bcore_inst )
     ...
     *  Typical modifiers can be: Interpreter, GUI, etc
     *  Note: This feature must be executed before feature 'mutated' below.
     */
    feature 'aptr' void source( m @* o, m bcore_source* source );

    /** Called when object was mutated through via-access.
     *  This signal is generated by an object modifier.
     *  Typical modifiers can be: Interpreter, GUI, etc
     */
    feature 'aptr' void mutated( m @* o );
     ...
     *  Typical shelvers can be: Translator
     *
     *  Note:
