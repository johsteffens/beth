...
PLANT_GROUP( bcore_via_call, bcore_inst )
#ifdef PLANT_SECTION // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    /** Called when object was mutated through via-access.
     *  Note that this signal is generated by object modifiers (e.g. serialization, interpreter)
     ...
     *  This signal is typically generated by a shelver that makes use of the the via-perspective
     *  (e.g. translator).
     *  It is not generated by the via perspective itself.
     *  Note: Implementing this feature may cause an object to be copied before being shelved because
     *        shelvers are generally not supposed to modify the original.
     */
