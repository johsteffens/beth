...
{
    bcore_flect_define_creator( typeof( "bcore_hmap_u2vd_s" ),  hmap_u2vd_s_create_self );
    bcore_flect_define_creator( typeof( "bcore_hnode_tpsz_s" ), hnode_tpsz_s_create_self );
    bcore_flect_define_creator( typeof( "bcore_hmap_tpsz_s" ),  hmap_tpsz_s_create_self );
}
