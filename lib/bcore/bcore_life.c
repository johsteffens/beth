...
{
    bcore_flect_self_s* self = bcore_flect_self_s_build_parse_sc( " bcore_life_s =  bcore_inst { aware_t _; private vd_t data; private sz_t size; private sz_t space; }", sizeof( bcore_life_s ) );
