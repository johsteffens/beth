...
er_t bcore_generic_function_item_s_parse_c_code( bcore_generic_function_item_s* o, bcore_source* source )
{
    ...
    o->is_const = bcore_source_a_parse_bl_fa( source, " #?w'const'" );
...
er_t bcore_generic_function_item_s_parse_c_code_sc( bcore_generic_function_item_s* o, sc_t sc )
{
    ...
    er_t err = bcore_generic_function_item_s_parse_c_code( o, ( bcore_source* )wst );
    st_s_discard( wst );
    return err;
}
...
bcore_generic_function_item_s* bcore_generic_function_item_s_create_setup( tp_t type, s2_t indirection, bl_t is_const )
{
    ...
    bcore_generic_function_item_s_setup( item, type, indirection, is_const );
    return item;
}
...
{
    bcore_generic_function_item_s* item = bcore_generic_function_item_s_create();
    bcore_generic_function_item_s_parse_c_code( item, source );
    return item;
}
...
{
    bcore_generic_function_item_s* item = bcore_generic_function_item_s_create();
    bcore_generic_function_item_s_parse_c_code_sc( item, sc );
    return item;
}
...
{
    bcore_generic_function_item_s* item = bcore_generic_function_item_s_create();
    bcore_generic_function_item_s_parse_c_code_st( item, st );
    return item;
}
...
{
    if( o->is_const ) st_s_push_fa( st, "const " );
...
{
    BLM_INIT();
    BLM_TRY( bcore_generic_function_item_s_parse_c_code( &o->base, source ) );
    BLM_TRY( bcore_source_a_parse_em_fa( source, " ( " ) );

    while( !bcore_source_a_parse_bl_fa( source, " #=?')'" ) && !bcore_source_a_eos( source ) )
    {
        bcore_generic_function_item_s* item = BLM_A_PUSH( bcore_generic_function_item_s_create_parse_c_code( source ) );
...
{
    st_s* wst = st_s_create_weak_sc( sc );
    er_t err = bcore_generic_function_s_parse_c_code( o, ( bcore_source* )wst );
    st_s_discard( wst );
    return err;
}
...
/** Generates the declaration of the '_bgwf' function.
 *  Example: "void test_foo_bgwf( vd_t r, vd_t a[] )"
 */
er_t bcore_generic_function_s_push_c_code_bgwf_declaration( const bcore_generic_function_s* o, st_s* st )
{
    st_s_push_fa( st, "void #name_bgwf( vd_t r, vd_t a[] )", o->base.name );
    return 0;
}
 ...
 *  Example: "void test_foo_bgwf( vd_t r, vd_t a[] ) { *(s2_t*)r = test_foo( (const st_s*)a[0], *(s2_t*)a[1], *(s2_t*)a[2] ); }"
 */
...
static void test_foo_bgwf( vd_t r, vd_t a[] ){ *(s2_t*)r = test_foo( (const st_s*)a[0], *(s2_t*)a[1], *(s2_t*)a[2]); }
...
void test_declaration( sc_t sc )
{
    ...
    bcore_generic_function_s_parse_c_code_sc( f, sc );
...
static st_s* selftest( void )
{
    ...
    bcore_generic_function_s_parse_c_code_sc( f0, sc_declaration );
    f0->fp = test_foo_bgwf;

    bcore_generic_function_manager_set_c( f0 );
