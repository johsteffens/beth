...
void x_via_selftest( void )
{
    ...
    const x_inst* zoo = ((x_inst*)BLM_LEVEL_A_PUSH(0,((x_inst*)(bcore_spect_via_create_zoo( 2 ).o))));
    
    //zoo.to_sink_txt_ml( x_inst_stdout() );
    
    //x_via_path_s!^.parse_sc( "[0]" ).c_get_in( zoo )?.to_sink_txt_ml( x_inst_stdout() );
    
    sr_s sr = x_via_path_s_get_sr_in_t(((x_via_path_s*)(x_via_path_s_parse_sc(((x_via_path_s*)BLM_LEVEL_T_PUSH(0,x_via_path_s,x_via_path_s_create())),"[0].[1].vdata.data2.[0]" ))),zoo->_, zoo );
...
// XOILA_OUT_SIGNATURE 0x3B60271D835B08DEull
