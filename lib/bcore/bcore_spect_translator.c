...
static bcore_translator_s* create_from_self( const bcore_flect_self_s* t_self, const bcore_flect_self_s* o_self )
{
    ...
    o->translate_body = bcore_flect_self_s_try_external_fp( o_self, typeof( "bcore_fp_translate_body" ) );
    if( !o->translate_body ) o->translate_body = bcore_flect_self_s_get_external_fp( t_self, typeof( "bcore_fp_translate_body" ) );
    o->translate_object = bcore_flect_self_s_try_external_fp( o_self, typeof( "bcore_fp_translate_object" ) );
    if( !o->translate_object ) o->translate_object = bcore_flect_self_s_get_external_fp( t_self, typeof( "bcore_fp_translate_object" ) );
    return o;
}
