...
typedef struct bcore_object_item_s
{
    const bcore_flect_item_s*    flect_item;
    const struct bcore_object_s* perspective;
} bcore_object_item_s;

typedef struct bcore_object_body_s
{
    bcore_object_item_s* data;
    sz_t size, space;
} bcore_object_body_s;
...
static inline vd_t bcore_object_spect_clone( const bcore_object_s* o, vc_t obj )
{
    if( !obj ) return NULL;
    return o->clone( o, obj );
}

static inline vd_t bcore_object_typed_clone( u2_t type, vc_t obj )
{
    if( !obj ) return NULL;
    const bcore_object_s* o = bcore_object_s_get_typed( type );
    return o->clone( o, obj );
...
static inline vd_t bcore_object_aware_clone( vc_t obj )
{
    if( !obj ) return NULL;
    const bcore_object_s* o = bcore_object_s_get_aware( obj  );
    return o->clone( o, obj );
