...
{
    bcore_flect_self_s* self = bcore_flect_self_s_build_parse_sc( "bcore_txt_ml_translator_s = bcore_translator { aware_t _; sz_t indent; }", sizeof( bcore_txt_ml_translator_s ) );
...
{
    bcore_flect_self_s* self = bcore_flect_self_s_build_parse_sc( "bcore_txt_ml_interpreter_s = bcore_interpreter { aware_t _; }", sizeof( bcore_txt_ml_interpreter_s ) );
