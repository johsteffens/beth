//  Last update: 2026-04-21T13:59:28Z (UTC)
...
// HKEYOF_xoico 0x9947E0EF3DD50B27ull
...
XOILA_DEFINE_SPECT_NASC_BEGIN( x_inst, xoico )
"{",
...
"}",
XOILA_DEFINE_SPECT_NASC_END( x_inst, xoico )
...
XOILA_DEFINE_SPECT_NASC_BEGIN( x_inst, xoico_host )
"{",
    "bcore_spect_header_s header;",
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_name_s )
"aware xoico_name",
"{",
    "tp_t name;",
...
XOILA_DEFINE_SPECT_NASC_BEGIN( xoico, xoico_name )
"{",
    "bcore_spect_header_s header;",
"}",
XOILA_DEFINE_SPECT_NASC_END( xoico, xoico_name )
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_forward_s )
"aware xoico_forward",
"{",
    "tp_t name;",
...
XOILA_DEFINE_SPECT_NASC_BEGIN( xoico, xoico_forward )
"{",
    "bcore_spect_header_s header;",
"}",
XOILA_DEFINE_SPECT_NASC_END( xoico, xoico_forward )
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_typespec_transient_s )
...
"{",
    ...
    "func xoico:get_hash;",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_typespec_transient_s )

tp_t xoico_typespec_transient_s_get_hash( const xoico_typespec_transient_s* o )
{
    #line 45 "xoico_typespec.x"
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_typespec_s )
"aware xoico_typespec",
"{",
    "tp_t type;",
    "tp_t access_class;",
...
{
    #line 260 "xoico_typespec.x"
    
    if( o->flag_variadic )
    {
        return  GERR_fa("Cannot convert a variadic argument to bcore_generic_function_item_s\n" );
    }
    ...
    if( type == ((tp_t)(TYPEOF_type_object)) )
    {
        type = xoico_host_a_obj_type(host);
    }
    else if( type == ((tp_t)(TYPEOF_type_deduce)) )
    {
        return  GERR_fa("Cannot resolve 'type_deduce' at this point." );
    }
...
er_t xoico_typespec_s_expand_x( const xoico_typespec_s* o, const xoico_host* host, x_sink* sink )
{
    ...
    if( o->flag_static   ) x_sink_push_fa(sink,"static " );
    if( o->flag_volatile ) x_sink_push_fa(sink,"volatile " );
    if( o->flag_aware    ) x_sink_push_fa(sink,"aware " );
    if( o->flag_obliv    ) x_sink_push_fa(sink,"obliv " );
    sc_t sc_type = st_type->sc;
...
XOILA_DEFINE_SPECT_NASC_BEGIN( xoico, xoico_typespec )
"{",
    "bcore_spect_header_s header;",
"}",
XOILA_DEFINE_SPECT_NASC_END( xoico, xoico_typespec )

bl_t xoico_typespec_is_numeric( tp_t type )
{
    #line 342 "xoico_typespec.x"
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_transient_map_s )
"aware xoico_transient_map",
"{",
    "bcore_hmap_tptp_s map;",
    "func xoico:parse;",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_transient_map_s )

bcore_arr_tp_s* xoico_transient_map_s_create_key_arr( const xoico_transient_map_s* o )
{
    #line 33 "xoico_transient_map.x"
...
XOILA_DEFINE_SPECT_NASC_BEGIN( xoico, xoico_transient_map )
"{",
    "bcore_spect_header_s header;",
"}",
XOILA_DEFINE_SPECT_NASC_END( xoico, xoico_transient_map )
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_arg_s )
"aware xoico_arg",
"{",
    "x_source_point_s source_point;",
    ...
    "func xoico:convert_transient_types;",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_arg_s )
...
er_t xoico_arg_s_to_generic_function_item( const xoico_arg_s* o, const xoico_host* host, bcore_generic_function_item_s* item )
{
    ...
    BLM_TRY(xoico_typespec_s_to_generic_function_item(&(o->typespec),host, item ) )
    item->name = o->name;
    return  0;
    #line 940 "xoico.xo.c"
}
...
{
    #line 107 "xoico_arg.x"
    BLM_INIT_LEVEL(0);
    bcore_generic_function_item_s* item = ((bcore_generic_function_item_s*)BLM_LEVEL_T_PUSH(0,bcore_generic_function_item_s,bcore_generic_function_item_s_create()));
    BLM_TRY(xoico_arg_s_to_generic_function_item(o,host, item ))
    bcore_generic_function_s_push_item_d(gfunc,((bcore_generic_function_item_s*)bcore_fork(item)) );
    BLM_RETURNV(er_t, 0)
    #line 951 "xoico.xo.c"
}
...
er_t xoico_arg_s_to_self_item_st( const xoico_arg_s* o, const xoico_host* host, st_s* st )
{
    ...
    return  0;
    #line 1017 "xoico.xo.c"
}

XOILA_DEFINE_SPECT_NASC_BEGIN( xoico, xoico_arg )
"{",
    "bcore_spect_header_s header;",
"}",
XOILA_DEFINE_SPECT_NASC_END( xoico, xoico_arg )
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_args_s )
"aware x_array",
"{",
    "xoico_arg_s => [];",
    "func xoico:parse;",
...
er_t xoico_args_s_expand( const xoico_args_s* o, const xoico_host* host, bl_t first, x_sink* sink )
{
    ...
    #line 1089 "xoico.xo.c"
}

er_t xoico_args_s_push_to_generic_function( const xoico_args_s* o, const xoico_host* host, bcore_generic_function_s* gfunc )
{
    #line 79 "xoico_args.x"
    
    {const xoico_args_s* __a=o ;if(__a)for(sz_t __i=0;__i<__a->size;__i++){xoico_arg_s* arg=__a->data[__i];
    {BLM_INIT_LEVEL(4);
        bcore_generic_function_item_s* item = ((bcore_generic_function_item_s*)BLM_LEVEL_T_PUSH(4,bcore_generic_function_item_s,bcore_generic_function_item_s_create()));
        BLM_TRY(xoico_arg_s_to_generic_function_item(arg,host, item ))
        bcore_generic_function_s_push_item_d(gfunc,((bcore_generic_function_item_s*)bcore_fork(item)) );
    BLM_DOWN();}
    }}return  0;
    #line 1103 "xoico.xo.c"
}

er_t xoico_args_s_expand_x( const xoico_args_s* o, const xoico_host* host, bl_t first, x_sink* sink )
{
    #line 92 "xoico_args.x"
...
const xoico_arg_s* xoico_args_s_get_arg_by_name( const xoico_args_s* o, tp_t name )
{
    ...
    #line 1150 "xoico.xo.c"
}

XOILA_DEFINE_SPECT_NASC_BEGIN( xoico, xoico_args )
"{",
    "bcore_spect_header_s header;",
"}",
XOILA_DEFINE_SPECT_NASC_END( xoico, xoico_args )
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_signature_s )
...
er_t xoico_signature_s_parse( xoico_signature_s* o, const xoico_host* host, x_source* source )
{
    ...
    o->is_generic = x_source_parse_bl(source," #?'generic'" );
...
{
    #line 253 "xoico_signature.x"
    
    BLM_TRY(xoico_typespec_s_to_generic_function_item(&(o->typespec_ret),host,&( gfunc->base )))
    gfunc->base.name = bentypeof( sc_func_global_name );
    
    bcore_generic_function_s_clear(gfunc);
    
    if( o->arg_o ) BLM_TRY(xoico_arg_s_push_to_generic_function(o->arg_o,host, gfunc ))
    BLM_TRY(xoico_args_s_push_to_generic_function(&(o->args),host, gfunc ))
    
    return  0;
    #line 1399 "xoico.xo.c"
}

bl_t xoico_signature_s_fits_transient_type_feature( const xoico_signature_s* o )
{
    #line 268 "xoico_signature.x"
    ...
    return  true;
    #line 1410 "xoico.xo.c"
}

XOILA_DEFINE_SPECT_NASC_BEGIN( xoico, xoico_signature )
"{",
    "bcore_spect_header_s header;",
"}",
XOILA_DEFINE_SPECT_NASC_END( xoico, xoico_signature )
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_body_code_s )
"aware xoico_body",
"{",
    "bl_t single_line;",
    "tp_t hash_source;",
...
er_t xoico_body_code_s_parse_single_statement( xoico_body_code_s* o, const xoico_host* host, x_source* source )
{
    ...
    o->hash_source = hash;
    return  0;
    #line 1682 "xoico.xo.c"
}

tp_t xoico_body_code_s_get_hash( const xoico_body_code_s* o )
{
    #line 314 "xoico_body.x"
    
    tp_t hash = bcore_tp_fold_tp( bcore_tp_init(), o->_ );
    hash = bcore_tp_fold_tp( hash, o->hash_source );
    return  hash;
    #line 1692 "xoico.xo.c"
}

BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_body_s )
"aware xoico_body",
"{",
    "tp_t name;",
    "tp_t global_name;",
    ...
    "func xoico:parse;",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_body_s )

tp_t xoico_body_s_get_hash( const xoico_body_s* o )
{
    #line 327 "xoico_body.x"
...
er_t xoico_body_s_expand( const xoico_body_s* o, const xoico_host* host, const xoico_signature_s* signature, sz_t indent, x_sink* sink )
{
    ...
    BLM_RETURNV(er_t, 0)
    #line 1823 "xoico.xo.c"
}

XOILA_DEFINE_SPECT_NASC_BEGIN( xoico, xoico_body )
"{",
    "bcore_spect_header_s header;",
"}",
XOILA_DEFINE_SPECT_NASC_END( xoico, xoico_body )
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_func_s )
"aware xoico_func",
"{",
    "tp_t name;",
    "tp_t global_name;",
...
er_t xoico_func_s_parse( xoico_func_s* o, const xoico_host* host, x_source* source )
{
    ...
    if( x_source_parse_bl(source," #?'('" ) ) BLM_RETURNV(er_t, x_source_parse_error_fa(source,"Signature-enclosure '( ...sig... )' is deprecated." ))
...
er_t xoico_func_s_expand_declaration( const xoico_func_s* o, const xoico_host* host, sz_t indent, x_sink* sink )
{
    ...
    ASSERT( signature );
    xoico_compiler_s* compiler = xoico_host_a_compiler(host);
    sc_t sc_global_name = xoico_compiler_s_nameof(compiler,o->global_name );
    
    if( go_inline )
    {
        x_sink_push_fa(sink," \\\n#rn{ }", indent );
        x_sink_push_fa(sink,"static inline " );
        BLM_TRY(xoico_signature_s_expand_declaration(signature,host, sc_global_name, indent, sink ))
    ...
    {BLM_INIT_LEVEL(1);
        bcore_generic_function_s* gfunc = ((bcore_generic_function_s*)BLM_LEVEL_T_PUSH(1,bcore_generic_function_s,bcore_generic_function_s_create()));
        BLM_TRY(xoico_signature_s_to_generic_function(signature,host, sc_global_name, gfunc ))
        st_s* st = ((st_s*)BLM_LEVEL_T_PUSH(1,st_s,st_s_create()));
        BLM_TRY(bcore_generic_function_s_push_c_code_bgwf_definition_one_line(gfunc,st ))
        x_sink_push_fa(sink," \\\n#rn{ }", indent );
        x_sink_push_fa(sink,"static inline #<sc_t>;", st->sc );
    BLM_DOWN();}
    
    return  0;
    #line 2112 "xoico.xo.c"
}

er_t xoico_func_s_expand_definition( const xoico_func_s* o, const xoico_host* host, sz_t indent, x_sink* sink )
{
    #line 316 "xoico_func.x"
...
er_t xoico_func_s_expand_init1( const xoico_func_s* o, const xoico_host* host, sz_t indent, x_sink* sink )
{
    ...
    if( xoico_func_s_is_generic(o) )
    {BLM_INIT_LEVEL(1);
        bcore_generic_function_s* gfunc = ((bcore_generic_function_s*)BLM_LEVEL_T_PUSH(1,bcore_generic_function_s,bcore_generic_function_s_create()));
        BLM_TRY(xoico_signature_s_to_generic_function(o->signature,host, sc_global_name, gfunc ))
        st_s* st = ((st_s*)BLM_LEVEL_T_PUSH(1,st_s,st_s_create()));
        BLM_TRY(bcore_generic_function_s_push_x_code(gfunc,st ))
    
        x_sink_push_fa(sink,"#rn{ }bcore_generic_function_manager_register_func( \"#<sc_t>\", #<sc_t>__bgwf );\n",
            indent,
            st->sc,
            sc_global_name
        );
    ...
    return  0;
    #line 2169 "xoico.xo.c"
}

XOILA_DEFINE_SPECT_NASC_BEGIN( xoico, xoico_func )
"{",
    "bcore_spect_header_s header;",
"}",
XOILA_DEFINE_SPECT_NASC_END( xoico, xoico_func )
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_funcs_s )
"aware x_array",
"{",
    "xoico_func_s => [];",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_funcs_s )

sz_t xoico_funcs_s_get_index_from_signature_global_name( const xoico_funcs_s* o, tp_t signature_global_name )
{
    #line 34 "xoico_funcs.x"
...
tp_t xoico_funcs_s_get_hash( const xoico_funcs_s* o )
{
    ...
    return  hash;
    #line 2262 "xoico.xo.c"
}

XOILA_DEFINE_SPECT_NASC_BEGIN( xoico, xoico_funcs )
"{",
    "bcore_spect_header_s header;",
"}",
XOILA_DEFINE_SPECT_NASC_END( xoico, xoico_funcs )
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_feature_s )
"aware xoico_feature",
"{",
    "xoico_signature_s signature;",
    "xoico_funcs_s funcs;",
    ...
    "func xoico:expand_init1;",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_feature_s )

tp_t xoico_feature_s_get_hash( const xoico_feature_s* o )
{
    #line 65 "xoico_feature.x"
...
er_t xoico_feature_s_expand_init1( const xoico_feature_s* o, const xoico_host* host, sz_t indent, x_sink* sink )
{
    ...
    return  0;
    #line 2749 "xoico.xo.c"
}

XOILA_DEFINE_SPECT_NASC_BEGIN( xoico, xoico_feature )
"{",
    "bcore_spect_header_s header;",
"}",
XOILA_DEFINE_SPECT_NASC_END( xoico, xoico_feature )
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_features_s )
"aware x_array",
"{",
    "xoico_feature_s => [];",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_features_s )

sz_t xoico_features_s_get_index_from_name( const xoico_features_s* o, tp_t name )
{
    #line 28 "xoico_features.x"
    ...
    #line 2777 "xoico.xo.c"
}

bl_t xoico_features_s_exists_from_name( const xoico_features_s* o, tp_t name )
{
    #line 34 "xoico_features.x"
    
    return  ( xoico_features_s_get_index_from_name(o,name ) >= 0 );
    #line 2785 "xoico.xo.c"
}

XOILA_DEFINE_SPECT_NASC_BEGIN( xoico, xoico_features )
"{",
    "bcore_spect_header_s header;",
"}",
XOILA_DEFINE_SPECT_NASC_END( xoico, xoico_features )
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_embedded_data_s )
...
er_t xoico_embedded_data_s_parse( xoico_embedded_data_s* o, const xoico_host* host, x_source* source )
{
    ...
    if( o->embed_method == TYPEOF_as_string_without_comments )
    {
        ...
        while( !x_source_eos(source) )
        {
            char c = x_source_get_u0(source);
            if( c == '/' && x_source_inspect_u0(source) == '*' )
            {
                x_source_get_u0(source);
                while( !x_source_eos(source) ) { if( x_source_get_u0(source) == '*' ) if( x_source_get_u0(source) == '/' ) break; }
            }
            else if( c == '/' && x_source_inspect_u0(source) == '/' )
            {
                x_source_get_u0(source);
                while( !x_source_eos(source) )
                {
                    if( x_source_inspect_u0(source) == '\n' ) break;
                    x_source_get_u0(source);
                }
            }
            else if( !( c == '\n' && last_char == '\n' ) ) // do not push repeated newlines
            {
                bcore_arr_u0_s_push(o->arr,c );
                last_char = c;
            }
        }
    }
...
er_t xoico_embedded_data_s_expand_definition( const xoico_embedded_data_s* o, const xoico_host* host, sz_t indent, x_sink* sink )
{
    ...
    return  0;
    #line 2926 "xoico.xo.c"
}

XOILA_DEFINE_SPECT_NASC_BEGIN( xoico, xoico_embedded_data )
"{",
    "bcore_spect_header_s header;",
"}",
XOILA_DEFINE_SPECT_NASC_END( xoico, xoico_embedded_data )
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_group_source_stack_s )
"aware x_array",
"{",
    "aware x_source -> [];",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_group_source_stack_s )

BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_group_s )
"aware xoico_group",
"{",
    "aware xoico => [];",
    ...
    )
    {
        ...
        {BLM_INIT_LEVEL(3);
            ...
            // check for proper registration in target.embedded_sources
                ...
                const xoico_target_s* target = xoico_group_s_get_target(o);
                if( bcore_arr_st_s_find(&(target->embedded_sources),0, -1, st_s_copy_sc(((st_s*)BLM_LEVEL_T_PUSH(4,st_s,st_s_create())),x_source_get_file(embed_source) ) ) == target->embedded_sources.size )
                {
                    BLM_RETURNV(er_t, x_source_parse_error_fa(source,"Xoico: #<sc_t> is not registered in the target definition: Add the relative file-path to array 'embedded_sources'.", embed_file->sc ))
                }
            BLM_DOWN();}
        ...
        else
        {
            sz_t index = x_source_get_index(source);
            x_source_set_index(source,index );
            BLM_RETURNV(er_t, x_source_parse_error_fa(source,"Xoico group parser: Invalid expression." ))
        }
...
er_t xoico_group_s_expand_spect_definition( const xoico_group_s* o, sz_t indent, x_sink* sink )
{
    ...
    if( o->short_spect_name )
    {
        ...
        {const xoico_group_s* __a=o ;if(__a)for(sz_t __i=0;__i<__a->size;__i++){xoico* e=__a->data[__i]; BLM_TRY(xoico_a_expand_spect_definition(e,((const xoico_host*)(o)), indent + 4, false, true, sink ))
        }}x_sink_push_fa(sink,"#rn{ }\"}\";\n", indent );
    }
    else
    {
        x_sink_push_fa(sink,"#rn{ }XOILA_DEFINE_SPECT_NASC_BEGIN( #<sc_t>, #<sc_t> )\n", indent, xoico_compiler_s_nameof(compiler,o->trait_name ), o->st_name.sc );
    
        x_sink_push_fa(sink,"#rn{ }\"{\",\n", indent );
        x_sink_push_fa(sink,"#rn{ }    \"bcore_spect_header_s header;\",\n", indent );
        {const xoico_group_s* __a=o ;if(__a)for(sz_t __i=0;__i<__a->size;__i++){xoico* e=__a->data[__i]; BLM_TRY(xoico_a_expand_spect_definition(e,((const xoico_host*)(o)), indent + 4, true, true, sink ))
        }}x_sink_push_fa(sink,"#rn{ }\"}\",\n", indent );
    
        x_sink_push_fa(sink,"#rn{ }XOILA_DEFINE_SPECT_NASC_END( #<sc_t>, #<sc_t> )\n", indent, xoico_compiler_s_nameof(compiler,o->trait_name ), o->st_name.sc );
    
    }
    
    return  0;
    #line 3877 "xoico.xo.c"
}

er_t xoico_group_s_expand_definition( const xoico_group_s* o, sz_t indent, x_sink* sink )
{
    #line 1022 "xoico_group.x"
...
er_t xoico_group_s_expand_down1( const xoico_group_s* o, sz_t indent, x_sink* sink )
{
    ...
    return  0;
    #line 3963 "xoico.xo.c"
}

BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_nested_group_s )
"aware xoico_group",
"{",
...
{
    #line 232 "xoico_group.x"
    
    if( !o->group->expandable ) return  0;
    x_sink_push_fa(sink," \\\n#rn{ }  BETH_EXPAND_GROUP_#<sc_t>", indent, o->group->st_name.sc );
    return  0;
    #line 4002 "xoico.xo.c"
}

XOILA_DEFINE_SPECT_NASC_BEGIN( xoico, xoico_group )
"{",
    "bcore_spect_header_s header;",
"}",
XOILA_DEFINE_SPECT_NASC_END( xoico, xoico_group )
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_wrap_s )
"aware xoico_wrap",
"{",
    "tp_t group_name;",
    "tp_t func_name;",
...
er_t xoico_wrap_s_finalize( xoico_wrap_s* o, const xoico_host* host )
{
    ...
    BLM_RETURNV(er_t, 0)
    #line 4087 "xoico.xo.c"
}

BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_wraps_s )
"aware x_array",
"{",
    "xoico_wrap_s => [];",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_wraps_s )

XOILA_DEFINE_SPECT_NASC_BEGIN( xoico, xoico_wrap )
"{",
    "bcore_spect_header_s header;",
"}",
XOILA_DEFINE_SPECT_NASC_END( xoico, xoico_wrap )
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_stamp_s )
"aware xoico_stamp",
"{",
    "st_s st_name;",
    "tp_t tp_name;",
    ...
    "func xoico:expand_init1;",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_stamp_s )

tp_t xoico_stamp_s_get_hash( const xoico_stamp_s* o )
{
    #line 54 "xoico_stamp.x"
...
er_t xoico_stamp_s_expand_definition( const xoico_stamp_s* o, const xoico_host* host, sz_t indent, x_sink* sink )
{
    ...
    x_sink_push_fa(sink,"#rn{ }BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( #<sc_t> )\n", indent, o->st_name.sc );
    st_s* multiline_nasc_string = ((st_s*)BLM_LEVEL_T_PUSH(0,st_s,xoico_stamp_create_structured_multiline_string_nasc(self_def, indent )));
    x_sink_push_fa(sink,"#<sc_t>,\n", multiline_nasc_string->sc );
    x_sink_push_fa(sink,"#rn{ }BCORE_DEFINE_OBJECT_INST_P_NASC_END( #<sc_t> )\n", indent, o->st_name.sc );
    
    {const xoico_funcs_s* __a=&(o->funcs );if(__a)for(sz_t __i=0;__i<__a->size;__i++){xoico_func_s* func=__a->data[__i]; BLM_TRY(xoico_func_s_expand_definition(func,((const xoico_host*)(o)), indent, sink ))
    
    }}BLM_RETURNV(er_t, 0)
    #line 4857 "xoico.xo.c"
}

er_t xoico_stamp_s_expand_init1( const xoico_stamp_s* o, const xoico_host* host, sz_t indent, x_sink* sink )
{
    #line 1010 "xoico_stamp.x"
    ...
    {const xoico_funcs_s* __a=&(o->funcs );if(__a)for(sz_t __i=0;__i<__a->size;__i++){xoico_func_s* func=__a->data[__i];
    {
        ...
        if( xoico_func_s_is_generic(func) )
        {
            BLM_TRY(xoico_func_s_expand_init1(func,host, indent, sink ))
        }
    }
    }}x_sink_push_fa(sink,"#rn{ }BCORE_REGISTER_OBJECT( #<sc_t> );\n", indent, o->st_name.sc );
    return  0;
    #line 4886 "xoico.xo.c"
}

BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_stamp_self_item_s )
"aware xoico_stamp",
"{",
    "x_source_point_s source_point;",
    "st_s st;",
...
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_stamp_self_item_s )
...
er_t xoico_stamp_self_item_s_to_bcore_self_item( const xoico_stamp_self_item_s* o, const bcore_self_s* self, bcore_self_item_s* item )
{
    ...
    BLM_DOWN();}
    BLM_RETURNV(er_t, 0)
    #line 4912 "xoico.xo.c"
}

BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_stamp_arr_self_item_s )
"aware x_array",
"{",
    "xoico_stamp_self_item_s [];",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_stamp_arr_self_item_s )

XOILA_DEFINE_SPECT_NASC_BEGIN( xoico, xoico_stamp )
"{",
    "bcore_spect_header_s header;",
"}",
XOILA_DEFINE_SPECT_NASC_END( xoico, xoico_stamp )

st_s* xoico_stamp_create_embedded_string( const st_s* s )
{
    #line 163 "xoico_stamp.x"
...
st_s* xoico_stamp_create_structured_multiline_string_nasc( const sc_t s, sz_t indent )
{
    ...
    if( !newline ) st_s_push_sc(out,"\"" );
    return  out;
    #line 5131 "xoico.xo.c"
}
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_source_s )
"aware xoico_source",
"{",
    "st_s full_path;",
    "st_s name;",
    ...
    "func xoico_host:compiler;",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_source_s )

er_t xoico_source_s_expand_setup( xoico_source_s* o, const xoico_host* host )
{
    #line 43 "xoico_source.x"
...
er_t xoico_source_s_parse( xoico_source_s* o, const xoico_host* host, x_source* source, sc_t group_name, sc_t trait_name, tp_t embed_method )
{
    ...
    BLM_RETURNV(er_t, 0)
    #line 5460 "xoico.xo.c"
}

XOILA_DEFINE_SPECT_NASC_BEGIN( xoico, xoico_source )
"{",
    "bcore_spect_header_s header;",
"}",
XOILA_DEFINE_SPECT_NASC_END( xoico, xoico_source )
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_target_s )
"aware xoico_target",
"{",
    "st_s name;",
    "st_s ext;",
    ...
    "func xoico_host:cengine;",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_target_s )

er_t xoico_target_s_finalize( xoico_target_s* o, const xoico_host* host )
{
    #line 83 "xoico_target.x"
...
er_t xoico_target_s_expand_update_time( const xoico_target_s* o, sz_t indent, x_sink* sink )
{
    ...
    x_sink_push_fa(sink,"//  Last update: " ); bcore_cday_utc_s_to_sink( time,( bcore_sink* )sink ); x_sink_push_fa(sink," (UTC)\n" );
    BLM_RETURNV(er_t, 0)
    #line 5689 "xoico.xo.c"
}

er_t xoico_target_s_expand_heading( const xoico_target_s* o, sz_t indent, x_sink* sink )
{
    #line 262 "xoico_target.x"
    BLM_INIT_LEVEL(0);
...
er_t xoico_target_s_expand_phase2( xoico_target_s* o, bl_t* p_modified )
{
    ...
    else
    {
    ...
    
        {
            ...
            {
                bcore_msg_fa( "XOICO: writing #<sc_t>\n", file_c->sc );
                BLM_TRY(xoico_target_reset_line_directives(file_c->sc, o->target_c ))
    ...
    BLM_RETURNV(er_t, 0)
    #line 6079 "xoico.xo.c"
}

XOILA_DEFINE_SPECT_NASC_BEGIN( xoico, xoico_target )
"{",
    "bcore_spect_header_s header;",
"}",
XOILA_DEFINE_SPECT_NASC_END( xoico, xoico_target )

er_t xoico_target_reset_line_directives( sc_t file, st_s* data )
{
    #line 585 "xoico_target.x"
    BLM_INIT_LEVEL(0);
    sc_t file_name = bcore_file_name(file );
    st_s* buf = ((st_s*)BLM_LEVEL_T_PUSH(0,st_s,st_s_clone(data)));
    st_s_clear(data);
        ...
        switch( c )
        {
            ...
            case '#' :
            {
                if( newline )
                {
                    ...
                    if( cmp == 0 || cmp == 1 )
                    {
                        st_s_push_fa(data,"line #<sz_t> \"#<sc_t>\"", linenum + 1, file_name );
                        while( i < buf->size && buf->data[ i + 1 ] != '\n' ) i++;
                    }
                    newline = false;
                }
            }
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_compiler_type_info_s )
"aware xoico_compiler",
"{",
    "xoico_typespec_s typespec;",
    "hidden aware xoico* item;",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_compiler_type_info_s )

BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_compiler_element_info_s )
"aware xoico_compiler",
"{",
    "xoico_compiler_type_info_s type_info;",
    "hidden xoico_func_s* func;",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_compiler_element_info_s )

BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_compiler_s )
"aware xoico_compiler",
"{",
    ...
    "func xoico:expand_setup;",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_compiler_s )

bl_t xoico_compiler_s_is_type( const xoico_compiler_s* o, tp_t name )
{
    #line 140 "xoico_compiler.x"
...
er_t xoico_compiler_s_update_target_files( xoico_compiler_s* o, bl_t* p_modified )
{
    #line 761 "xoico_compiler.x"
        ...
        return  er;
    #line 6824 "xoico.xo.c"
}

XOILA_DEFINE_SPECT_NASC_BEGIN( xoico, xoico_compiler )
"{",
    "bcore_spect_header_s header;",
"}",
XOILA_DEFINE_SPECT_NASC_END( xoico, xoico_compiler )

bl_t xoico_compiler_is_correctly_signed( const st_s* data )
{
    #line 364 "xoico_compiler.x"
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_che_s )
"aware xoico_che",
"{",
    "bl_t verbose = false;",
...
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_che_s )

tp_t xoico_che_s_get_hash( const xoico_che_s* o )
{
    #line 261 "xoico_che.x"
...
er_t xoico_che_s_trans_type( xoico_che_s* o, x_source* source, xoico_che_result* result, xoico_typespec_s* out_typespec )
{
    ...
    if( x_source_parse_bl(source,"#?([0]=='!'&&[1]!='=')" ) )
    {
        x_source_get_char(source);
    ...
    if( tp_identifier )
    {
        ...
        else if( xoico_che_s_is_func(o,tp_identifier ) )
        {
            ...
            {BLM_INIT_LEVEL(4);
                ...
                BLM_TRY(xoico_che_s_trans_whitespace(o,source,((xoico_che_result*)( result ))))
                xoico_typespec_s* typespec = ((xoico_typespec_s*)BLM_LEVEL_T_PUSH(4,xoico_typespec_s,xoico_typespec_s_create()));
                typespec->type = ((tp_t)(TYPEOF_fp_t));
                typespec->indirection = 0;
                typespec->access_class = ((tp_t)(TYPEOF_const));
                typespec->flag_addressable = false;
                BLM_TRY(xoico_che_s_trans_typespec_expression(o,source,((xoico_che_result*)( result)), typespec, out_typespec ))
            BLM_DOWN();}
        }
...
er_t xoico_che_s_translate_mutable( xoico_che_s* o, const xoico_host* host, const xoico_body_s* body, const xoico_signature_s* signature, x_sink* sink )
{
    ...
    if( o->insert_source_reference && !body->code->single_line )
    {
        ...
        {
            if( x_source_point_s_source_c_preprocessor_line_to_sink(&(body->code->source_point),true, sink ) )
            {
                x_sink_push_fa(sink,"\n" );
    ...
    if( push_line_reset ) x_sink_push_fa(sink,"\n##line reset" );
    
    BLM_RETURNV(er_t, 0)
    #line 8913 "xoico.xo.c"
}
...
{
    #line 28 "xoico_che_trans_typespec.x"
    BLM_INIT_LEVEL(0);
    if( x_source_parse_bl(source,"#?'->'" ) )
    {
    ...
    {BLM_INIT_LEVEL(1);
        ...
        if( try_member_object ) // member object
        {
            ...
            if( xoico_compiler_s_get_type_member_object_info(o->compiler,in_typespec->type, tp_identifier, info ) )
            {
                if( in_typespec->indirection <= 1 )
                {
            ...
            {BLM_INIT_LEVEL(4);
                xoico_che_result_a_clear(result);
                BLM_TRY(xoico_che_result_push_fa(result,"#<sc_t>_#<sc_t>", xoico_che_s_nameof(o,in_typespec->type ), xoico_che_s_nameof(o,tp_identifier ) ))
...
{
    #line 283 "xoico_che_trans_typespec.x"
    BLM_INIT_LEVEL(0);
    BLM_TRY(x_source_parse_fa(source,"[" ))
...
{
    #line 324 "xoico_che_trans_typespec.x"
    BLM_INIT_LEVEL(0);
    BLM_TRY(x_source_parse_fa(source,"!" ))
...
{
    #line 363 "xoico_che_trans_typespec.x"
    BLM_INIT_LEVEL(0);
    BLM_TRY(x_source_parse_fa(source,"?" ))
...
{
    #line 397 "xoico_che_trans_typespec.x"
    BLM_INIT_LEVEL(0);
    if( in_typespec->indirection != 1 )
    {
...
{
    #line 463 "xoico_che_trans_typespec.x"
    BLM_INIT_LEVEL(0);
    BLM_TRY(x_source_parse_fa(source,"=" ))
    BLM_TRY(xoico_che_result_a_push_sc(result,"=" ))
...
{
    #line 518 "xoico_che_trans_typespec.x"
    BLM_INIT_LEVEL(0);
    if( out_typespec ) out_typespec->type = 0;
    BLM_TRY(xoico_che_s_trans_whitespace(o,source, result ))
...
er_t xoico_che_s_trans_control_return( xoico_che_s* o, tp_t tp_control, x_source* source, xoico_che_result* result )
{
    ...
    BLM_RETURNV(er_t, 0)
    #line 10519 "xoico.xo.c"
}

XOILA_DEFINE_SPECT_NASC_BEGIN( xoico_cengine, xoico_che )
"{",
    "bcore_spect_header_s header;",
"}",
XOILA_DEFINE_SPECT_NASC_END( xoico_cengine, xoico_che )

//----------------------------------------------------------------------------------------------------------------------
// group: xoico_che_result; embeds: xoico_che_result.x

BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_che_result_whitespace_s )
"aware xoico_che_result",
"{",
    "st_s => st;",
    "func ^:to_sink;",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_che_result_whitespace_s )
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_che_result_plain_s )
"aware xoico_che_result",
"{",
    "st_s st;",
    "func ^:clear;",
    ...
    "func ^:create_st;",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_che_result_plain_s )
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_che_result_adl_s )
"aware x_array",
"{",
    "aware xoico_che_result -> [];",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_che_result_adl_s )

BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_che_result_arr_s )
"aware xoico_che_result",
"{",
    ...
    "func ^:get_cast;",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_che_result_arr_s )

er_t xoico_che_result_arr_s_to_sink( const xoico_che_result_arr_s* o, x_sink* sink )
{
    #line 89 "xoico_che_result.x"
...
bl_t xoico_che_result_arr_s_get_cast( xoico_che_result_arr_s* o, xoico_che_result_cast_s** pp_cast )
{
    ...
    return  false;
    #line 10616 "xoico.xo.c"
}

BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_che_result_block_s )
"aware xoico_che_result",
"{",
    "sz_t level;",
    "bl_t is_using_blm;",
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_che_result_blm_init_s )
"aware xoico_che_result",
"{",
    "sz_t level;",
    "bl_t active = true;",
    ...
    "func ^:deactivate;",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_che_result_blm_init_s )
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_che_result_blm_down_s )
"aware xoico_che_result",
"{",
    "bl_t active = true;",
    "func ^:to_sink;",
    ...
    "func ^:deactivate;",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_che_result_blm_down_s )

BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_che_result_cast_s )
"aware xoico_che_result",
"{",
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_che_result_statement_s )
"aware xoico_che_result",
"{",
    "aware xoico_che_result => expression;",
    "func ^:get_cast;",
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_che_result_break_s )
"aware xoico_che_result",
"{",
    "sz_t ledge_level;",
    "hidden xoico_che_result_block_s* parent;",
    ...
    "func ^:to_sink;",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_che_result_break_s )

er_t xoico_che_result_break_s_to_sink( const xoico_che_result_break_s* o, x_sink* sink )
{
    #line 261 "xoico_che_result.x"
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_che_result_return_s )
"aware xoico_che_result",
"{",
    "hidden xoico_che_s * che;",
    ...
    "func ^:to_sink;",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_che_result_return_s )

er_t xoico_che_result_return_s_to_sink( const xoico_che_result_return_s* o, x_sink* sink )
{
    #line 283 "xoico_che_result.x"
...
XOILA_DEFINE_SPECT_NASC_BEGIN( xoico_che, xoico_che_result )
"{",
    "bcore_spect_header_s header;",
...
er_t xoico_che_result_copy_fa( xoico_che_result* o, sc_t format, ... )
{
    ...
    va_end( args );
    return ret;
    #line 10981 "xoico.xo.c"
}

//----------------------------------------------------------------------------------------------------------------------
// group: xoico_che_stack_var

BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_che_stack_var_unit_s )
"aware bcore_inst",
"{",
    "sz_t level;",
    "tp_t name;",
    "xoico_typespec_s typespec;",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_che_stack_var_unit_s )

BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_che_stack_var_unit_adl_s )
"aware x_array",
"{",
    "xoico_che_stack_var_unit_s => [];",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_che_stack_var_unit_adl_s )

BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_che_stack_var_s )
"aware xoico_che_stack_var",
"{",
    "xoico_che_stack_var_unit_adl_s adl;",
    "bcore_hmap_tpuz_s hmap_name;",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_che_stack_var_s )
...
void xoico_che_stack_var_s_clear( xoico_che_stack_var_s* o )
{
    ...
    bcore_hmap_tpuz_s_clear(&(o->hmap_name));
    #line 11068 "xoico.xo.c"
}

XOILA_DEFINE_SPECT_NASC_BEGIN( xoico_che, xoico_che_stack_var )
"{",
    "bcore_spect_header_s header;",
"}",
XOILA_DEFINE_SPECT_NASC_END( xoico_che, xoico_che_stack_var )

//----------------------------------------------------------------------------------------------------------------------
// group: xoico_che_stack_block

BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_che_stack_block_unit_s )
"aware bcore_inst",
"{",
    "sz_t level;",
    "bl_t use_blm = false;",
...
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_che_stack_block_unit_s )

BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_che_stack_block_unit_adl_s )
"aware x_array",
"{",
    "xoico_che_stack_block_unit_s => [];",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_che_stack_block_unit_adl_s )

BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_che_stack_block_s )
"aware xoico_che_stack_block",
"{",
    "xoico_che_stack_block_unit_adl_s adl;",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_che_stack_block_s )

xoico_che_stack_block_s* xoico_che_stack_block_s_pop( xoico_che_stack_block_s* o )
{
    #line 139 "xoico_che.x"
    
    x_array_set_size(((x_array*)(&(o->adl))),sz_max( o->adl.size - 1, 0 ) );
    return  o;
    #line 11110 "xoico.xo.c"
}

XOILA_DEFINE_SPECT_NASC_BEGIN( xoico_che, xoico_che_stack_block )
"{",
    "bcore_spect_header_s header;",
"}",
XOILA_DEFINE_SPECT_NASC_END( xoico_che, xoico_che_stack_block )
...
BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_builder_arr_target_s )
"aware x_array",
"{",
    "xoico_builder_target_s => [];",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_builder_arr_target_s )

BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_builder_target_s )
"aware xoico_builder",
"{",
    "st_s => name;",
    "st_s => extension = \"xo\";",
    ...
    "sz_t beta_level = 0;",
    "bl_t create_build_timestamp_file = true;",
    "bl_t check_build_timestamp_file = true;",
...
er_t xoico_builder_target_s_set_build_timestamp( xoico_builder_target_s* o )
{
    ...
    BLM_RETURNV(er_t, 0)
    #line 11498 "xoico.xo.c"
}

bl_t xoico_builder_target_s_is_up_to_date( xoico_builder_target_s* o )
{
    #line 494 "xoico_builder.x"
    
    if( !o->check_build_timestamp_file ) return  false;
...
er_t xoico_builder_target_s_build( xoico_builder_target_s* o )
{
    ...
    xoico_builder_parse_param_arr_s* parse_param_arr = ((xoico_builder_parse_param_arr_s*)BLM_LEVEL_T_PUSH(0,xoico_builder_parse_param_arr_s,xoico_builder_parse_param_arr_s_create()));
    ...
    {BLM_INIT_LEVEL(1);
        ...
        bcore_arr_st_s_copy(&(target->embedded_sources),&(o->embedded_sources ));
    
    
        bcore_arr_st_s_clear(&(target->embedded_sources));
        {const bcore_arr_st_s* __a=&(o->embedded_sources );if(__a)for(sz_t __i=0;__i<__a->size;__i++){const st_s* e=__a->data[__i];
        {BLM_INIT_LEVEL(5);
            st_s* file_path = ((st_s*)BLM_LEVEL_T_PUSH(5,st_s,st_s_clone(e)));
            if( file_path->size == 0 ) BLM_RETURNV(er_t, bcore_error_push_fa(((tp_t)(TYPEOF_general_error)), "File name expected in embedded source declaration." ))
            if( file_path->sc[ 0 ] != '/' && o->root_folder )
            {BLM_INIT_LEVEL(6);
                const st_s* tmp = ((st_s*)BLM_LEVEL_T_PUSH(6,st_s,st_s_clone(file_path)));
                st_s_copy_fa(file_path,"#<sc_t>/#<sc_t>", o->root_folder->sc, tmp->sc );
            BLM_DOWN();}
    
            bcore_arr_st_s_push_st(&(target->embedded_sources),file_path );
        BLM_DOWN();}
    
    
        }}{const xoico_builder_parse_param_arr_s* __a=parse_param_arr ;if(__a)for(sz_t __i=0;__i<__a->size;__i++){const xoico_builder_parse_param_s* e=__a->data[__i];
        {
            BLM_TRY(xoico_target_s_parse_from_path(target,e->file_path.sc, e->group_name.sc, e->trait_name.sc, e->embed_method ))
        }
    }}BLM_DOWN();}
    
    BLM_RETURNV(er_t, 0)
    #line 11625 "xoico.xo.c"
}

er_t xoico_builder_target_s_build_from_file( xoico_builder_target_s* o, sc_t path )
{
    #line 621 "xoico_builder.x"
...
"{",
    ...
    "tp_t embed_method;",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_builder_parse_param_s )
...
xoico_builder_parse_param_s* xoico_builder_parse_param_s__( xoico_builder_parse_param_s* o, const st_s* file_path, const st_s* group_name, const st_s* trait_name, tp_t embed_method )
{
    ...
    st_s_copy(&(o->file_path),file_path );
    st_s_copy(&(o->group_name),group_name );
    st_s_copy(&(o->trait_name),trait_name );
    o->embed_method = embed_method;
    return  o;
}

BCORE_DEFINE_OBJECT_INST_P_NASC_BEGIN( xoico_builder_parse_param_arr_s )
"aware x_array",
"{",
    "xoico_builder_parse_param_s => [];",
"}",
BCORE_DEFINE_OBJECT_INST_P_NASC_END( xoico_builder_parse_param_arr_s )

XOILA_DEFINE_SPECT_NASC_BEGIN( xoico, xoico_builder )
"{",
    "bcore_spect_header_s header;",
"}",
XOILA_DEFINE_SPECT_NASC_END( xoico, xoico_builder )
...
XOILA_DEFINE_SPECT_NASC_BEGIN( x_inst, xoico_main )
"{",
    "bcore_spect_header_s header;",
"}",
XOILA_DEFINE_SPECT_NASC_END( x_inst, xoico_main )

void xoico_main_help( x_sink* sink )
{
    #line 21 "xoico_main.x"
...
s2_t xoico_main_main( const bcore_arr_st_s* args )
{
    ...
    if( args->size > 1 )
    {
        ...
        else
        {
            ...
            if( !er ) er = xoico_builder_main_s_set_build_timestamp(&(builder_main));
    
            if( !er )
            {
                BLM_TRY_EXIT(xoico_builder_main_s_set_build_timestamp(&(builder_main)))
...
vd_t xoico_xo_signal_handler( const bcore_signal_s* o )
{
    switch( bcore_signal_s_handle_type( o, typeof( "xoico_xo" ) ) )
    {
        case TYPEOF_init1:
        {
            ...
            BCORE_REGISTER_FUNC( xoico_stamp_create_structured_multiline_string_nasc );
            ...
            BCORE_REGISTER_FUNC( xoico_target_reset_line_directives );
            ...
            BCORE_REGISTER_NAME( as_string_without_comments );
            ...
            BCORE_REGISTER_OBJECT( xoico_builder_parse_param_s );
            BCORE_REGISTER_OBJECT( xoico_builder_parse_param_arr_s );
...
// XOICO_BODY_SIGNATURE 0x131F95020C12D27C
// XOICO_FILE_SIGNATURE 0xA4C18C6674583B71
