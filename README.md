...
Primary motivation for this project is overcoming these deficiencies. Secondary is implementing in this new framework functionality as might be expected from a general purpose library. Thirdly (which might also be realized in beth-dependent projects) is developing new algorithic ideas and/or experiment with unconventional approaches.
